Feature: Marshall Islands Localisation

  #MarshallIslandsLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @MarshallIslandsLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Marshall Islands with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Marshall Islands from the dropdown
    Then Select "Marshall Islands" in "Supplier Country of Registration" dropdown
    ...
    @Smoke @MarshallIslandsLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
   ...
   # When Click on Continue button on Login page
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Marshall Islands" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Marshall Islands" supplier registration
    Then Enter "TestCity" in "City/Town" field after "Marshall Islands" supplier registration
    #Then Enter "32432" in "Postal Code" field after "Marshall Islands" supplier registration
    Then Select "Arno Atoll" in "Region" dropdown
    ...
    @Smoke @MarshallIslandsLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Marshall Islands and without questionnaire
    Then Enter data in Email Address field
    #When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    Then Verify Tax Country "Marshall Islands" is Pre populated with country
    ###Labels
    ...
    Then Show "Tax Identification Number (TIN)" label under "Tax Details"
    ...
    Then Show "Tax Identification Number (TIN)" input text field under "Tax Details"
    ...
    Then Verify "Tax Identification Number (TIN)" input text field enabled under "Tax Details"
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Company Registration Number" tooltip "The Company Registration Number is a unique identification number is assigned to each registered company and is issued by the Marshall Islands Registrar of Corporations. Example: 123287. This is a mandatory field." under "Tax Details"
    Then Show "Company Registration Document" tooltip "The company registration document issued by the Marshall Islands Registrar of Corporations. This is a mandatory attachment." under "Tax Details"
    Then Show "Tax Identification Number (TIN)" tooltip "Tax Identification Number (TIN) is known as the Trust Company of the Marshall Islands (TCMI) number, is issued by the Trust Company of the Marshall Island.This is Mandatory fields with minimum 7 digits. (Example: 9478478)" under "Tax Details"
    Then Show "Tax Registration Document" tooltip "Attach your company's Certificate of Tax Registration is issued by the Trust Company of the Marshall Island. This is a mandatory attachment." under "Tax Details"
    ...
    ####Flag
    Then Verify "Marshall Islands" flag Phone Number
    And Verify "Marshall Islands" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+692 (123) 456-7890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+692 (123) 456-7890"
    ...
    Then Wait for 3 seconds
    Then Enter data Company Registration Number under "Tax Details" field for Marshall Islands country
    Then Wait for 3 seconds
    Then Enter data Tax Identification Number under "Tax Details" field for Marshall Islands country
   ...
   #Action center
    ...
    @Smoke @MarshallIslandsLocalisation @Localisation @Supplier @QuickSanity @Lilly
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Marshall Islands and with questionnaire
    Then Enter data in Email Address field
    #When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    Then Wait for 3 seconds
    Then Enter data on Company Registration Number under "Tax Details" field for Marshall Islands country
    Then Wait for 3 seconds
    Then Enter data on Tax Identification Number under "Tax Details" field for Marshall Islands country
    Then Wait for 3 seconds
    ...
    #@Smoke @MarshallIslandsLocalisation @Localisation @Supplier @QuickSanity @Lilly
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Marshall Islands and without questionnaire with Diversity
    Then Enter data in Email Address field
    #When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    @Smoke @MarshallIslandsLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Marshall Islands and without questionnaire with Additional Information
    Then Enter data in Email Address field
    #When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    @Smoke @MarshallIslandsLocalisation @Localisation @Supplier @TYSFunctionality @SanityCheck
  Scenario: Add Company Account with valid data for Country Marshall Islands for existing supplier
   Then Enter data in Email Address field
    #When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    Then Select "Marshall Islands" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Marshall Islands"
    Then Select "US Dollar (USD)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Marshall Islands"
    ...
    Then Enter value for Bank Branch Name "Bank of Marshall Islands"
    ...
    Then Select "Arno Atoll" when "Region" dropdown
    ...
    @Smoke @MarshallIslandsLocalisation @Localisation @Supplier @TYSFunctionality @SanityCheck
  Scenario: Add Factoring Company Account with valid data for Country Marshall Islands for existing supplier
   Then Enter data in Email Address field
    #When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    Then Select "Marshall Islands" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Select "Arno Atoll" in "Region" dropdown on Factoring Company Address
    And Wait for 5 seconds
    Then Click "Save" button 6
    #And Click on the save in Address verification
    Then Wait for 3 seconds
