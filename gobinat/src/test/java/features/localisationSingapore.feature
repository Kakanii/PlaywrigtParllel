Feature: Singapore Localisation

  #SingaporeLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @SingaporeLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Singapore with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Singapore" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @SingaporeLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Singapore" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Singapore" supplier registration
    Then Enter "TestCity" in "City" field after "Singapore" supplier registration
    Then Enter "654323" in "Postal Code" field after "Singapore" supplier registration
    Then Select "East Region" in "Region" dropdown
   ...
   @Smoke @SingaporeLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Singapore and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Singapore" is Pre populated with country
    ###Labels
    ...
    Then Show "GST/Tax Identification Number" label under "Tax Details"
    Then Show "GST/Tax Registration Document" label under "Tax Details"
    ...
    Then Show "GST/Tax Identification Number" input text field under "Tax Details"
    ...
    Then Verify "GST/Tax Identification Number" input text field enabled under "Tax Details"
    ...
    Then Show "GST/Tax Registration Document" button in basic information
    ...
    Then Verify Upload "GST/Tax Registration Document" button clickable in basic information
    ...
    Then Show "Certificate of Incorporation" tooltip "Attach your Company's Certificate of Incorporation in the below mentioned formats. This is an optional attachment." under "Tax Details"
    Then Show "GST/Tax Identification Number" tooltip "The GST/Tax Identification Number issued by Inland Revenue Authority of Singapore.It is usually minimum 9 to maximum 12 alphanumeric characters and is in the format M212345678 or M2-1234567-8 or 123456789A . This is an optional field." under "Tax Details"
    #Then Show "GST/Tax Registration Document" tooltip "Attach your Company's GST/ Tax Registration Document issued by Inland Revenue Authority of Singapore in the below mentioned formats. This is an optional attachment." under "Tax Details"
    ...
    ###Required Fields
    Then Enter number "6745654663654" in "Phone Number" in corporation details
    ...
    Then Verify "Limited Partnership (LP)" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Sole Proprietorship/ Sole Trader" is listed in "Business Type" dropdown under "Tax Details"
    ...
    ####Flag
    Then Verify "Singapore" flag Phone Number
    And Verify "Singapore" flag Fax Number
    #Then Verify "Albania" flag in "Phone Number" field "us"
    #Then Verify "Albania" flag in "Fax Number" field "us"
    ###Phone number format
    Then Enter phone number "6745654663654" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+65 6745654663654"
    Then Enter phone number "6745654663654" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+65 6745654663654"
    ...
    #Then Enter "436346363" in "D-U-N-S Number" field under "Tax Details"
    #Then Verify no error message is displayed under "D-U-N-S Number" field under "Tax Details"
    ...
    Then Wait for 3 seconds
    Then Enter "4545754643" in "Company Registration Number" field under "Tax Details"
    ...
    Then Verify "Singapore" is listed in "Country/Region" dropdown
    Then Select "Singapore" in "Country/Region" dropdown
    ...
    Then Enter phone number "6745654663654" in "Primary Phone" field
    Then Verify phone number "Primary Phone" is entered in accepted format "+65 6745654663654"
    Then Enter phone number "6745654663000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+65 6745654663000"
    ###Required Error
    ...
    @Smoke @SingaporeLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Singapore and with questionnaire
    Then Enter data in Email Address field
  ...
  @Smoke @SingaporeLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Singapore and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @SingaporeLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Singapore and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @SingaporeLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Singapore for existing supplier
    When Enter Singapore Supplier Email in Email Address field
    ...
    Then Select "Singapore" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Singapore"
    Then Select "Singapore Dollar (SGD)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Singapore"
    ...
    Then Enter value for Bank Branch Name "Bank of Singapore"
    ...
    Then Enter value for Postal Code "275630"
  ...
  @Smoke @SingaporeLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Add Factoring Company Account with valid data for Country Singapore for existing supplier
    When Enter Singapore Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Singapore" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Enter "436325" in "Postal Code" field under "Factoring Company Address" section
