Feature: Japan Localisation
  ...
  @Smoke @JapanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Japan with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Japan" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @JapanLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Japan from the dropdown
    Then Select "Japan" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Click on Join Now Link in the "Japan" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Japan" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Japan" supplier registration
    Then Enter "TestCity" in "District" field after "Japan" supplier registration
    Then Enter "12345678" in "Postal Code" field after "Japan" supplier registration
    Then Select "Gifu" in "Prefecture" dropdown
  ...
  @Smoke @JapanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Japan and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Japan from teh dropdown
    Then Select "Japan" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Japan" is Pre populated with country
    ###Labels
    ...
    Then Show "Corporate Number" label under "Tax Details"
    ...
    Then Show "Corporate Number" input text field under "Tax Details"
    ...
    Then Verify "Corporate Number" input text field enabled under "Tax Details"
    ...
    Then Show "Corporate Number" tooltip " Corporate Number issued by the National Tax Agency in Japan. This is a mandatory field. " under "Tax Details"
    Then Show "Company Registration Document" tooltip " Attach your Company’s Registration Document issued by the Legal Affairs in the recommended formats. This is mandatory attachment. " under "Tax Details"
    Then Show "VAT Registration Number" tooltip " VAT Registration Number issued by the National Tax Agency in Japan. This is an optional field. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your company's Certificate of Tax Registration issued by the National Tax Agency in the recommended formats.This is optional attachment. " under "Tax Details"
    ...
    Then Show error message "Required" under "Corporate Number" field under "Tax Details"
    ...
    ###Business types
    Then Verify "Stock company (Kabushiki Kaisha)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify " Limited liability company (Godo Kaisha)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "General partnership company (Gomei Kaisha)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify " Limited partnership company (Goshi Kaisha)" is listed in "Business Type" dropdown under "Tax Details"
    ...
    #Then Verify "Japan" flag in Phone Number field
    #And Verify "Japan" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+81 (323) 213-123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+81 (323) 213-123555"
    ...
    #Then Verify no error message is displayed under "D-U-N-S Number" field under "Tax Details"
     #####Corporate Number - Input type
    Then Enter "@#$%&" in "Corporate Number" field under "Tax Details"
    Then Verify no data is entered in "Corporate Number" field under "Tax Details"
    Then Enter "      " in "Corporate Number" field under "Tax Details"
    Then Verify no data is entered in "Corporate Number" field under "Tax Details"
    ...
    Then Enter random number in "Corporate Number" field under "Tax Details"
    ...
    Then Verify "Japan" is listed in "Country/Region" dropdown
    Then Select "Japan" in "Country/Region" dropdown
    ...
    Then Verify "Prefecture" dropdown enabled
    ...
    # Flag
    #Then Verify "Japan" flag in Primary Phone field
    #And Verify "Japan" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+81 (323) 213-123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+81 (323) 213-123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    #### Postal Code
    Then Enter "123-4567" in "Postal Code" field
    Then Verify data entered in "Postal Code" field is "123-4567"
    ...
    ###PO Box Postal Code
    Then Enter "123-4567" in "PO Box Postal Code" field
    Then Verify data entered in "PO Box Postal Code" field is "123-4567"
    ...
    Then Show error message "Required" for "Prefecture" field
    ...
    Then Enter "123-4567" in "PO Box Postal Code" field
    Then Enter "123-4567" in "Postal Code" field
    Then Enter "Gifu" in "District" field
    Then Select "Gifu" in "Prefecture" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @JapanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Japan and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Verify "Uruguay" flag in Phone Number field
    #And Verify "Uruguay" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+81 (323) 213-123555"
    Then Enter phone number "323213123555" in "Fax Number" field
  ...
  @Smoke @JapanLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Japan with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @JapanLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Japan with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Verify "Ukraine" flag in Phone Number field
    #And Verify "Ukraine" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+81 (323) 213-123555"
    Then Enter phone number "323213123555" in "Fax Number" field
  ...
  @Smoke @JapanLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Japan for existing supplier
    ...
    Then Select "Japan" in "Country/Region" dropdown
    Then Enter "Japan Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Japan"
    Then Select "Japanese Yen (JPY)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Japan"
    And Wait for 2 seconds
    Then Enter input data in "Account Number" field
    Then Enter input data in "Zengin Bank Code" field
    ...
    Then Enter value for Bank Branch Name "Bank of El Uruguay"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City "Rocha"
    Then Select "Gifu" in "Prefecture" dropdown
    Then Enter value for Postal Code "275657765"
    Then Enter "1232" in "PO Box" field
    Then Enter "1232178" in "PO Box Postal Code" field
  ...
  @Smoke @JapanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Japan for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Enter "1234" in "PO Box" field
    Then Enter "123456678" in "PO Box Postal Code" field
    Then Enter value for Bank Contact Name "bankingcontact"
    Then Enter value for Bank Contact Number "9886543210"
    # Then Wait for 3 seconds
    Then Wait for 3 seconds
    Then Enter "IT People Corp" in "Factoring Company Name" field under "Factoring Company Info" section
    Then Select "Japan" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Gifu" in "District" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Gifu" in "Prefecture" dropdown section
    Then Enter "123456678" in "Postal Code" field under "Factoring Company Address" section
    Then Enter "3457" in "PO Box" field under "Factoring Company Address" section
    Then Enter "123456678" in "PO Box Postal Code" field under "Factoring Company Address" section
    Then Wait for 3 seconds
    Then Click "Save" button 6
    Then Wait for 3 seconds
    Then Click on Not now button
  ...
  @Regression @JapanLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually 4 to 18 digits. This is a mandatory field." in add bank account page
    And Verify "Zengin Bank Code" tooltip of "Bank and branch Identification Number associated with the bank which is usually 7 digits. This is a mandatory field." in add bank account page
    ...
    #And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 29 alphanumeric characters.Example:UA213223130000026007233566001.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    ...
    And Verify "District" tooltip of "Name of the district/municipality/section at which it is located. This is an optional field." in add bank account page
    And Verify "Prefecture" tooltip of "Please select your prefecture name from the dropdown. This is a mandatory field." in add bank account page
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually of 7 digits. This is a mandatory field." in add bank account page
    And Verify "PO Box" tooltip of "The Post Office Box of your company which is usually 0 to 12 digits. This is an optional field." in add bank account page
    Then Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is exactly 7 digits. This is an optional field." in add bank account page
  ...
  @Regression @UruguayLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "District" tooltip of "Name of the district/municipality/section at which it is located. This is an optional field." in add bank account Factoring Company Address section
    And Verify "Prefecture" tooltip of "Please select your prefecture name from the dropdown. This is a mandatory field." in add bank account Factoring Company Address section
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually of 7 digits. This is a mandatory field." in add bank account Factoring Company Address section
    And Verify "PO Box" tooltip of "The Post Office Box of your company which is usually 0 to 12 digits. This is an optional field." in add bank account Factoring Company Address section
    And Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is exactly 7 digits. This is an optional field." in add bank account Factoring Company Address section
