Feature: Azerbaijan Localisation

  #AzerbaijanLocalisation
    Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @AzerbaijanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Azerbaijan with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Azerbaijan" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @AzerbaijanLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Azerbaijan" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Azerbaijan" supplier registration
    Then Enter "TestCity" in "City" field after "Azerbaijan" supplier registration
    Then Enter "AZ1234" in "Postal Code" field after "Azerbaijan" supplier registration
    Then Select "Absheron" in "Division" dropdown
  ...
  @Smoke @AzerbaijanLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Azerbaijan and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Sri Lanka from teh dropdown
    Then Select "Azerbaijan" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Azerbaijan" is Pre populated with country
    ###Labels
    ...
    #Then Show "Taxpayer Number (IFU)" label under "Tax Details"
    ...
    #Then Show "Taxpayer Number (IFU)" input text field under "Tax Details"
    ...
    #Then Verify "Taxpayer Number (IFU)" input text field enabled under "Tax Details"
    ...
    Then Show "Tax Identification Number" tooltip " Tax/VAT Identification Number issued by The Ministry of Taxes of the Republic of Azerbaijan. Eg: 1525855852. This is a mandatory field. " under "Tax Details"
    Then Show "Tax Registration Document" tooltip " Attach your company's Certificate of Tax Registration issued by The Ministry of Taxes of the Republic of Azerbaijan. This is a mandatory attachment. " under "Tax Details"
    #Then Show "Taxpayer Number (IFU)" tooltip " Taxpayer Number (IFU) as issued by the General Directorate for Taxes, under the Ministry of Economy and is usually in the format 12345678A. This is a mandatory field. " under "Tax Details"
    #Then Show "Tax Document" tooltip " Attach your Tax Document issued by General Directorate for Taxes, under the Ministry of Economy in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    ...
    Then Verify "Individual Entrepreneurship" is listed in "Business Type" dropdown under "Tax Details"
    Then Select "Joint-Stock Company" value from Business type dropdown
    ...
    #Then Verify "Azerbaijan" flag in Phone Number field
    #And Verify "Azerbaijan" flag in Fax Number field
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+994 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+994 323213123555"
    ...
    Then Enter "      " in "Tax Identification Number" field under "Tax Details"
    Then Verify no data is entered in "Tax Identification Number" field under "Tax Details"
    #####NPWP Number/Tax Identification Number - Input type
     #Then Enter "@#$%&" in "Taxpayer Number (IFU)" field under "Tax Details"
    #Then Verify no data is entered in "Taxpayer Number (IFU)" field under "Tax Details"
    #Then Enter "      " in "Taxpayer Number (IFU)" field under "Tax Details"
    #Then Verify no data is entered in "Taxpayer Number (IFU)" field under "Tax Details"
    #Then Wait for 3 seconds
    ############When Enter Company Registration Number for Burkina Faso  under Tax Details
    #Then Enter 8 numbers followed by "S" in "Taxpayer Number (IFU)" field under "Tax Details"
    ...
    Then Verify "Azerbaijan" is listed in "Country/Region" dropdown
    Then Select "Azerbaijan" in "Country/Region" dropdown
    ...
    Then Show "Division" Label
    Then Show "Division" Dropdown
    ...
    Then Verify "Division" dropdown enabled
    ...
    # Flag
    #Then Verify "Azerbaijan" flag in Primary Phone field
    #And Verify "Azerbaijan" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+994 323213123555"
    Then Enter phone number "323213123555" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+994 323213123555"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    #### Zip code
    Then Enter "AZ1234" in "Postal Code" field
    Then Verify data entered in "Postal Code" field is "AZ1234"
    ...
    ###PO Box Zip Code
    Then Enter "AZ1234" in "PO Box Postal Code" field
    Then Verify data entered in "PO Box Postal Code" field is "AZ1234"
    ...
    Then Enter "AZ1234" in "PO Box Postal Code" field
    Then Enter "AZ1234" in "Postal Code" field
    Then Enter "Azerbaijan" in "City" field
    Then Select "Baku" in "Division" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @AzerbaijanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Azerbaijan and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Enter "      " in "Tax Identification Number" field under "Tax Details"
    Then Verify no data is entered in "Tax Identification Number" field under "Tax Details"
    #####Taxpayer Number (IFU) - Input type
     #Then Enter "@#$%&" in "Taxpayer Number (IFU)" field under "Tax Details"
    #Then Verify no data is entered in "Taxpayer Number (IFU)" field under "Tax Details"
    #Then Enter "      " in "Taxpayer Number (IFU)" field under "Tax Details"
    #Then Verify no data is entered in "Taxpayer Number (IFU)" field under "Tax Details"
    ...
    Then Verify phone number "Secondary Phone" is entered in accepted format "+994 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    Then Enter 150 digit alpha numeric data in "Address Line 1" field
  ...
  @Smoke @AzerbaijanLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Azerbaijan with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    #Then Verify no data is entered in "Taxpayer Number (IFU)" field under "Tax Details"
    Then Wait for 3 seconds
    ############When Enter Taxpayer Number (IFU) for Burkina Faso under Tax Details
   #Then Enter 8 numbers followed by "S" in "Taxpayer Number (IFU)" field under "Tax Details"
    #Then Enter random number in "Company Registration Number" field under "Tax Details"
    Then Enter random Tax Identification Number in "Tax Identification Number" field under "Tax Details"
    #Then Enter random EU VAT number "PL" in "EU VAT Registration Number"
  ...
  @Smoke @AzerbaijanLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Azerbaijan with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    #Then Verify no data is entered in "Taxpayer Number (IFU)" field under "Tax Details"
    Then Wait for 3 seconds
   ############When Enter Tax Identification Number for Azerbaijan  under Tax Details
    #Then Enter 8 numbers followed by "S" in "Taxpayer Number (IFU)" field under "Tax Details"
    #Then Enter random number in "Company Registration Number" field under "Tax Details"
    Then Enter random Tax Identification Number in "Tax Identification Number" field under "Tax Details"
    #Then Enter random EU VAT number "PL" in "EU VAT Registration Number"
  ...
  @Smoke @AzerbaijanLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Azerbaijan for existing supplier
    ...
    Then Select "Azerbaijan" in "Country/Region" dropdown
    Then Enter "Azerbaijan Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Azerbaijan"
    Then Select "Azerbaijani manat (AZN)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Azerbaijan"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Azerbaijan"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City " Tirana"
    Then Select "Absheron" in "Division" dropdown
    Then Enter value for Postal Code "AZ2756"
    Then Enter "12345" in "PO Box" field
    Then Enter "AZ1234" in "PO Box Postal Code" field
  ...
  @Smoke @AzerbaijanLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Azerbaijan for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    And Wait for 2 seconds
   Then Enter input data in "Account Number" field
    Then Enter "12332" data in "AZIPS Code" field
    Then Enter input data in "Bank Key" field
    And Wait for 2 seconds
    Then Enter input data in "SWIFT Code" field
    Then Enter input data in "IBAN" field
    ...
    Then Select "Azerbaijan" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Wait for 5 seconds
    Then Select "Absheron" in "Division" dropdown section
    Then Enter "AZ4567" in "Postal Code" field under "Factoring Company Address" section
    Then Enter "4567" in "PO Box" field under "Factoring Company Address" section
    Then Enter "AZ4567" in "PO Box Postal Code" field under "Factoring Company Address" section
    Then Wait for 3 seconds
    Then Click "Save" button 6
    Then Wait for 3 seconds
    Then Click on Not now button
  ...
  @Regression @AzerbaijanLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    #And Verify "Bank Code/Number" tooltip of "Bank Code/Number associated with the bank and is usually 7 digits. This field is mandatory." in add bank account page
    And Verify "Account Number" tooltip of "Account number of the Bank account which is minimum 4 to maximum 20 alphanumeric characters. If IBAN is available then it is the last 20 digits of IBAN. This is a mandatory field." in add bank account page
    And Verify "Bank Key" tooltip of "Bank Identification Number associated with the bank and is usually 4 digits which is 5th,6th,7th,8th digits in IBAN. This is an optional field." in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 28 alphanumeric characters.Example:AZ21NABZ00000000137010001944.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    ...
    And Verify "Division" tooltip of "Name of the Administrative Division at which it is located. This is an optional field." in add bank account page
    And Verify "Postal Code" tooltip of "The Postal Code of your company which usually starts with AZ and is of 6 alphanumeric characters e.g. AZ1010. This is a mandatory field." in add bank account page
    ...
    Then Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which starts with AZ and is of 6 alphanumeric characters e.g. AZ1010. This is an optional field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Division" tooltip of "Name of the Administrative Division at which it is located. This is an optional field." in add bank account Factoring Company Address section
    And Verify "Postal Code" tooltip of "The Postal Code of your company which usually starts with AZ and is of 6 alphanumeric characters e.g. AZ1010. This is a mandatory field." in add bank account Factoring Company Address section
    ...
    And Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which starts with AZ and is of 6 alphanumeric characters e.g. AZ1010. This is an optional field." in add bank account Factoring Company Address section
