Feature: Switzerland Localisation

  #SwitzerlandLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window
  
  @Smoke @SwitzerlandLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Switzerland with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Switzerland" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @SwitzerlandLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Select "Jura" in "Canton" dropdown
   ...
   @Smoke @SwitzerlandLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Switzerland and with questionnaire
    Then Enter data in Email Address field
    ...
    Then Wait for 3 seconds
    When Enter Tax Registration Number for Albania under Tax Details
    Then Enter phone number "413213123" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+41 41 321 3123"
    Then Enter phone number "413213123" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+41 41 321 3123"
  ...
  @Smoke @SwitzerlandLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Switzerland and with out questionnaire
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    Then Verify Tax Country "Switzerland" is Pre populated with country
    ###Labels
    ...
    Then Show "Unique Enterprise Identification Number" label under "Tax Details"
    ...
    Then Show "Unique Enterprise Identification Number" input text field under "Tax Details"
    ...
    Then Verify "Unique Enterprise Identification Number" input text field enabled under "Tax Details"
    ...
    Then Show "Tax Registration number" button in basic information
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Unique Enterprise Identification Number" tooltip " Company Registration Number as issued by the Federal Statistical Office in the format CHE-999.999.99P or CHE-999.999.999. This is an optional field. " under "Tax Details"
    Then Show "Certificate of Incorporation" tooltip "Attach your company's Certificate of Incorporation issued by Federal Statistical Office in the below mentioned formats. This is an optional field." under "Tax Details"
    Then Show "Tax Registration number" tooltip " Tax identification number issued by the Federal Tax Administration in Switzerland which is in the format CHE-123.456.789 MWST/TVA/IVA " under "Tax Details"
    Then Show "Tax Registration Document" tooltip " Attach your company's Certificate of Tax Registration issued by the Federal Tax Administration in the below mentioned formats " under "Tax Details"
    ...
    ###Business types
    Then Verify "Branch of Foreign Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Public limited company Ltd" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Simple Partnership" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Sole Proprietor/Enterprise" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Stock Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Other" is listed in "Business Type" dropdown under "Tax Details"
    Then Select "General partnership" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    Then Verify "Switzerland" flag in Phone Number
    And Verify "Switzerland" flag in Fax Number
    ...
    Then Verify "Switzerland" is listed in "Country/Region" dropdown
    Then Select "Switzerland" in "Country/Region" dropdown
    ...
    # Flag
    Then Verify "Switzerland" flag in Primary Phone
    And Verify "Switzerland" flag in Secondary Phone
    #Phone Number
    ...
    Then Enter phone number "413213123" in "Primary Phone" field
    Then Verify phone number "Primary Phone" is entered in accepted format "+41 41 321 3123"
    Then Enter phone number "413213000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+41 41 321 3000"
    ###Required Error
  ...
  @Smoke @SwitzerlandLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Switzerland and with out questionnaire with Diversity
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
  ...
  @Smoke @SwitzerlandLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Switzerland and with out questionnaire with Additional Information
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
  ...
  @Regression @SwitzerlandLocalisation @Localisation @Supplier 
  Scenario: Verify Bank Account page for Switzerland supplier
    ...
    Then Enter "Switzerland BOA" in "Bank Account Label" field
    Then Enter "Switzerland CA" in "Account Holder Name" field
    Then Enter "Bank of Switzerland" in "Bank Name" field
    ...
    Then Select "Switzerland" in "Canton" dropdown
    Then Enter "1234" in "Postal Code" field
    Then Enter "P098765" in "PO Box" field
    Then Enter "0987" in "PO Box Postal Code" field
    Then Enter "lukthi" in "Bank Contact Name" field
    Then Enter "lukthi@G.com" in "Bank Contact Email Address" field
    Then Enter phone number "4976543210" in "Bank Contact Number" field
    Then Enter "56756" in "Bank Key" field under "Bank Account Information" for Bank Details
    Then Enter "12345678901" in "SWIFT Code" field under "Bank Account Information" for Bank Details
    Then Enter "CH89370400440532013000" in "IBAN" field under "Bank Account Information" for Bank Details
    Then Enter "Testing" in Bank Desciption
    Then Select "Swiss Franc (CHF)" in "Currency" css dropdown
    Then Wait for 5 seconds
  ...
  @Regression @SwitzerlandLocalisation @Localisation @Supplier
  Scenario: Verify Factory Company Account page for Switzerland supplier
    Then Enter Switzerland supplier email in Email Address
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Select "Switzerland" in "Canton" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Enter "1234" in "Postal Code" field under "Factoring Company Address" section
