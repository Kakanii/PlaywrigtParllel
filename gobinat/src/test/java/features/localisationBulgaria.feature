Feature: Bulgaria Localisation

  #BulgariaLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @BulgariaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Bulgaria with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Bulgaria from the dropdown
    Then Select "Bulgaria" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @BulgariaLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Bulgaria" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Bulgaria" supplier registration
    Then Enter "TestCity" in "City" field after "Bulgaria" supplier registration
    Then Enter "1234" in "Postal Code" field after "Bulgaria" supplier registration
 ...
 @Smoke @BulgariaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Bulgaria and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Bulgaria" is Pre populated with country
    ###Labels
   ...
   # Then Show "D-U-N-S Number" label under "Tax Details"
    ...
    #Then Show "EU VAT Registration Number" tooltip "EU VAT Registration Number as issued by the Bulgaria Tax office and in the following formats 1)  BG123456789 or BG1234567890. This is a mandatory field." under "Tax Details"
    Then Show "EU VAT Registration Document" tooltip "Attach your EU VAT Registration Document issued by the Bulgaria Tax office in the below mentioned formats. This is a mandatory attachment." under "Tax Details"
    #Then Show "VAT Registration Number" tooltip "VAT Registration Number as issued by the Bulgaria Tax office and in the following formats 1)  123456789 or 1234567890. This is an optional field." under "Tax Details"
    Then Show "VAT Registration Document" tooltip "Attach your VAT Registration Document issued by the Bulgaria Tax office in the below mentioned formats. This is an optional attachment." under "Tax Details"
    ...
    Then Verify "Partnerships" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "Partnerships" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    Then Verify "Bulgaria" flag Phone Number
    And Verify "Bulgaria" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+359 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+359 1234567890"
    ...
    Then Verify "Bulgaria" is listed in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+359 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+359 1234567000"
    ###Required Error
    ...
    #### Zip code
    Then Enter "3535" in "Postal Code" field
    Then Verify data entered in "Postal Code" field is "3535"
    ...
    Then Select "Blagoevgrad" in "Province" dropdown
    ###PO Box Zip Code
    ...
    Then Enter "5465" in "Postal Code" field
...
@Smoke @BulgariaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Bulgaria and with questionnaire
    Then Enter data in Email Address field
    ...
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    And Select "Partnerships" value from Business type dropdown
   ...
   @Smoke @BulgariaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Bulgaria and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
 ...
 @Smoke @BulgariaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Bulgaria and with out questionnaire with Addtional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @BulgariaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Bulgaria for existing supplier
    When Enter Bulgaria Supplier Email in Email Address field
    ...
    Then Select "Bulgaria" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Bulgaria"
    Then Select "Euro (EUR)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Bulgaria"
    ...
    And Wait for 2 seconds
    And Enter value for Bank Key "12345567"
    ...
    Then Enter value for Bank Branch Name "Bank of Bulgaria"
  ...
  @Smoke @BulgariaLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Add Factoring Company Account with valid data for Country Bulgaria for existing supplier
    When Enter Bulgaria Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
