Feature: Hong Kong S.A.R Localisation

  #HongKongS.A.RLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @HongKongS.A.RLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Hong Kong S.A.R with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Hong Kong S.A.R from the dropdown
    Then Select "Hong Kong S.A.R" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @HongKongS.A.RLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Hong Kong S.A.R" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Hong Kong S.A.R" supplier registration
    Then Enter "TestCity" in "Town" field after "Hong Kong S.A.R" supplier registration
    #Then Enter "4634-44" in "Postal Code" field after "Hong Kong S.A.R" supplier registration
    Then Select "Eastern" in "District" dropdown
  ...
  @Smoke @HongKongS.A.RLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Hong Kong S.A.R and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Hong Kong" is Pre populated with country
    ###Labels
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Company Registration Number" tooltip "Company Registration Number issued by the Hong Kong Companies Registry in Hong Kong which is usually minimum 4- maximum 20 Alphanumeric. This is a mandatory field." under "Tax Details"
    Then Show "Company Registration Document" tooltip "Attach your Company’s Registration Document issued by the Hong Kong Companies Registry in the below mentioned formats. This is a mandatory attachment." under "Tax Details"
    ...
    ####Flag
    Then Verify "Hong Kong" flag Phone Number
    And Verify "Hong Kong" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+852 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+852 1234567890"
    ...
    Then Verify "Hong Kong S.A.R" is listed in "Country/Region" dropdown
    Then Select "Hong Kong S.A.R" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+852 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+852 1234567000"
    ###Required Error
    ...
    @Smoke @HongKongS.A.RLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Hong Kong S.A.R and with questionnaire
    Then Enter data in Email Address field
  ...
  @Smoke @HongKongS.A.RLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Hong Kong S.A.R and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @HongKongS.A.RLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Hong Kong S.A.R and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @HongKongS.A.RLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Hong Kong S.A.R for existing supplier
    ...
    Then Select "Hong Kong S.A.R" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Hong Kong S.A.R"
    Then Select "Costa Rican Colon (CRC)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Hong Kong S.A.R"
    ...
    Then Enter value for Bank Branch Name "Bank of Hong Kong S.A.R"
    ...
    #Then Enter value for Postal Code "1237-09"
  ...
  @Smoke @HongKongS.A.RLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Factoring Company Account with valid data for Country Hong Kong S.A.R for existing supplier
    When Enter Hong Kong S.A.R Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Hong Kong S.A.R" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    #Then Enter "1238-65" in "Postal Code" field under "Factoring Company Address" section
