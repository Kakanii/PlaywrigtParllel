Feature: Kenya Localisation
  ...
  @Smoke @KenyaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Kenya with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Kenya" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @KenyaLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Click on Join Now Link in the "Kenya" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Kenya" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Kenya" supplier registration
    Then Enter "TestCity" in "City" field after "Kenya" supplier registration
    Then Enter "12345678" in "Postal Code" field after "Kenya" supplier registration
    Then Select "Meru" in "Province" dropdown
  ...
  @Smoke @KenyaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Kenya and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Kenya from teh dropdown
    Then Select "Kenya" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Kenya" is Pre populated with country
    ###Labels
    ...
    Then Show "Company Registration Number" tooltip " Company registration number issued by the Companies Registry which is minimum 4 to maximum 20 alphanumeric characters. This is an optional field. " under "Tax Details"
    Then Show "Company Registration Document" tooltip " Attach your Company’s registration Document issued by the Companies Registry in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    Then Show "VAT Registration Number" tooltip " VAT Registration Number issued by the Kenya Revenue Authority which is usually minimum 8 to maximum 12 alphanumeric characters e.g. P000111111A . This is an optional field. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your company's Certificate of Vat Registration issued by the Kenya Revenue Authority in the below mentioned formats. This is an optional attachment. <" under "Tax Details"
    ...
    Then Verify "Societies" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "Limited Liability Partnership" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Scroll to view "Phone Number" field
    #Then Verify "Kenya" flag in Phone Number field
    #And Verify "Kenya" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+254 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+254 323213123555"
    ...
    Then Verify "Kenya" is listed in "Country/Region" dropdown
    Then Select "Kenya" in "Country/Region" dropdown
    ...
    # Flag
    #Then Verify "Kenya" flag in Primary Phone field
    #And Verify "Kenya" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+254 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+254 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
  ...
  @Smoke @KenyaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Kenya and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @KenyaLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Kenya with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @KenyaLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Kenya with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @KenyaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Kenya for existing supplier
    ...
    Then Select "Kenya" in "Country/Region" dropdown
    Then Enter "Kenya Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Kenya"
    Then Select "Kenyan shilling (KES)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Kenya"
    And Wait for 2 seconds
    ...
    Then Enter value for City "Busia"
    Then Select "Busia" in "Province" dropdown
  ...
  @Smoke @KenyaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Kenya for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Kenya" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Busia" in "City" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Busia" in "Province" dropdown section
  ...
  @Regression @KenyaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is minimum 4 to maximum 18 digits. This is a mandatory field." in add bank account page
    And Verify "Bank Key (Identifier)" tooltip of "Bank Account Code (Identifier) associated with the bank and it is 5 digits which is also known as sort code. This is a mandatory field." in add bank account page
    ...
    And Verify "Province" tooltip of "Name the Province at which it is located. This is an optional field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Province" tooltip of "Name the Province at which it is located. This is an optional field." in add bank account Factoring Company Address section
