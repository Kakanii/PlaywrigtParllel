Feature: Ireland Localisation
  ...
  @Smoke @IrelandLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Ireland with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Ireland" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @IrelandLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Ireland" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Ireland" supplier registration
    Then Enter "TestCity" in "City" field after "Ireland" supplier registration
    Then Enter "7673756" in "Eircode" field after "Ireland" supplier registration
    Then Select "Down" in "County" dropdown
  ...
  @Smoke @IrelandLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Ireland and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Ireland" is Pre populated with country
    ###Labels
    ...
    Then Show "TAX Reference Number" label under "Tax Details"
    ...
    Then Show "TAX Reference Number" input text field under "Tax Details"
    ...
    Then Verify "TAX Reference Number" input text field enabled under "Tax Details"
    ...
    Then Show "Company Registration Number" tooltip " Company Registration Number as issued by the Companies Registration Office. This is an optional field. " under "Tax Details"
    Then Show "Certificate of Incorporation" tooltip " Attach your company's Certificate of Incorporation issued by Companies Registration Office in the below mentioned formats. This is an optional field. " under "Tax Details"
    Then Show "TAX Reference Number" tooltip " Tax identification number issued by the Revenue Commissioners in the format 1234567T or 1234567TT for Companies and CHY9 to CHY99999 for Charitable tax exemption bodies " under "Tax Details"
    ...
    Then Show "VAT Registration Number" tooltip " VAT registration Number issued by the Revenue Commissioners in the format 1234567 or 1234567WH. This is an optional field. " under "Tax Details"
    ...
    Then Show error message "Required" under "TAX Reference Number" field under "Tax Details"
    ...
    ###Business types
    Then Verify "Beneficial Ownership" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Company limited by guarantee (CLG)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Cross Broder Merger" is listed in "Business Type" dropdown under "Tax Details"
    Then Select "Designated activity company (DAC) limited by guarantee" value from Business type dropdown
    Then Verify "Designated activity company (DAC) limited by shares" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "European Economic Interest Groupings (EEIG)" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Private company limited by shares (LTD)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Public limited company (PLC)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Single Member Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Societas Europaea (SE)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Undertakings for Collective Investment in Transferable ..." is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "Beneficial Ownership" value from Business type dropdown
    #Date calandar
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+353 0323213123"
    Then Enter phone number "3232131235" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+353 0323213123"
    ...
    Then Enter "@#$%&" in "TAX Reference Number" field under "Tax Details"
    Then Verify no data is entered in "TAX Reference Number" field under "Tax Details"
    Then Enter "      " in "TAX Reference Number" field under "Tax Details"
    Then Verify no data is entered in "TAX Reference Number" field under "Tax Details"
    #####Employer Identification Number (EIN) - Input range
    Then Wait for 3 seconds
    ############When Enter Tax Identification Number for Belgium  under Tax Details
    #Then Enter "ATU77777782" in "Tax Identification Number" field under "Tax Details"
    #Then Verify data entered in "Tax Identification Number" field is "ATU77777782" under "Tax Details"
    ...
    Then Verify "Ireland" is listed in "Country/Region" dropdown
    Then Select "Ireland" in "Country/Region" dropdown
    ...
    Then Show "Eircode" Label
    Then Show "Eircode" input text field
    Then Show "PO Box" Label
    Then Show "PO Box" input text field
    Then Show "PO Box Eircode" Label
    Then Show "PO Box Eircode" input text field
    ...
    # Flag
    #Then Verify "Belgium" flag in Primary Phone field
    #And Verify "Belgium" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+353 0423424242"
    Then Enter phone number "423424242342" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+353 0423424242"
    ...
    #### Zip code
    Then Enter "123 4567" in "Eircode" field
    Then Verify data entered in "Eircode" field is "123 4567"
    Then Enter "1" in "Eircode" field
    Then Click on "Save Contact" button
    Then Show error message like "Must be a valid Eircode" under "Eircode" field
    Then Enter "@@@@" in "Eircode" field
    Then Verify no data is entered in "Eircode" field
    Then Enter "    " in "Eircode" field
    Then Verify no data is entered in "Eircode" field
    ###PO Box
    Then Enter "123456789012" in "PO Box" field
    ###PO Box Zip Code
    Then Enter "1234" in "PO Box Eircode" field
    Then Verify data entered in "PO Box Eircode" field is "123 4"
    Then Enter "1" in "PO Box Eircode" field
    Then Click on "Save Contact" button
    Then Show error message like "Must be a valid PO Box Eircode" under "PO Box Eircode" field
    #Then Enter "abcd" in "PO Box Eircode" field
    #Then Verify no data is entered in "PO Box Eircode" field
    Then Enter "@@@@" in "PO Box Eircode" field
    Then Verify no data is entered in "PO Box Eircode" field
    Then Enter "    " in "PO Box Eircode" field
    Then Verify no data is entered in "PO Box Eircode" field
    ...
    Then Show error message "Required" for "Eircode" field
    #Then Show error message "Required" for "Municipality" field
    Then Enter "123456789012" in "PO Box" field
    Then Enter 79 digit alpha numeric data in "Address Line 1" field
    #Then Enter "abcd" in "Eircode" field
    #Then Verify no data is entered in "Eircode" field
    Then Enter "1234567" in "Eircode" field
    #Then Enter "abcd" in "PO Box Eircode" field
    #Then Verify no data is entered in "PO Box Eircode" field
    Then Enter "@#$%" in "Eircode" field
    Then Verify no data is entered in "Eircode" field
    Then Enter "@#$%" in "PO Box Eircode" field
    Then Verify no data is entered in "PO Box Eircode" field
    Then Enter "1234567" in "PO Box Eircode" field
    Then Enter "1234567" in "Eircode" field
    Then Enter "Ireland" in "City" field
    Then Select "Down" in "County" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @IrelandLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Ireland and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Verify "Ireland" flag in Phone Number field
    #And Verify "Ireland" flag in Fax Number field
    #Then Verify "Albania" flag in "Phone Number" field "us"
    #Then Verify "Albania" flag in "Fax Number" field "us"
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+353 0323213123"
    Then Enter phone number "3232131666" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+353 0323213166"
    #click on the calandar icon
    Then Scroll to the top of the page
    Then click on the calandar icon
    Then select date "1" from the date
    ...
    #Then Enter "999999935" in "Austrian Company Number" field under "Tax Details"
    #Then Verify data entered in "Austrian Company Number" field is "999999935" under "Tax Details"
    ...
    Then Enter "QA" in "Job Title" field
    Then Enter timestamp in "Email ID" field "supplier@mailinator.com"
    Then Enter phone number "423424242111" in "Primary Phone" field
    Then Verify phone number "Primary Phone" is entered in accepted format "+353 0423424242"
    Then Enter phone number "457234242987" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+353 0457234242"
    Then Verify "Branch" is listed in "Address Type" dropdown
    Then Select "Branch" in "Address Type" dropdown
    Then Verify "Ireland" is listed in "Country/Region" dropdown
    Then Select "Ireland" in "Country/Region" dropdown
  ...
  @Smoke @IrelandLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Ireland with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    #####Employer Identification Number (EIN) - Input range
    Then Wait for 3 seconds
    #Then Enter "999999953" in "Austrian Company Number" field under "Tax Details"
    #Then Verify data entered in "Austrian Company Number" field is "999999953" under "Tax Details"
     Then Enter "AT" followed by "U" and 6 numbers in "TAX Reference Number" field under "Tax Details"
    ###Document uploads
    Then Scroll to view "Tax Registration Document" field
    Then Click "Upload Tax Registration Document" button
  ...
  @Smoke @IrelandLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Ireland with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    #####Employer Identification Number (EIN) - Input range
    Then Wait for 3 seconds
    #Then Enter "999999964" in "Austrian Company Number" field under "Tax Details"
    #Then Verify data entered in "Austrian Company Number" field is "999999964" under "Tax Details"
    Then Enter "AT" followed by "U" and 6 numbers in "TAX Reference Number" field under "Tax Details"
    ###Document uploads
    Then Scroll to view "Tax Registration Document" field
    Then Click "Upload Tax Registration Document" button
    ...
    Then Click on Add Other button in Management page
    Then Select "Add a New Location" in "Select Location" dropdown
    #Then Verify "Belgium" is listed in "Country/Region" dropdown
  ...
  @Smoke @IrelandLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Ireland for existing supplier
    ...
    Then Select "Ireland" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Ireland"
    Then Select "Australian Dollar (AUD)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Ireland"
    ...
    Then Select "Cavan" in "County" dropdown
    #Then Select "Finiq" in "Municipality" dropdown
  ...
  @Smoke @IrelandLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Ireland for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Ireland" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    #Then Select "Victoria" in "State or Territory" under "Factoring Company Address" section
     Then Select "Cavan" in "County" dropdown
    #Then Select "Limburg" in "State" dropdown section
    Then Enter "4567891" in "Eircode" field under "Factoring Company Address" section
    #Then Select "Finiq" in "Municipality" dropdown
    Then Wait for 3 seconds
    Then Click "Save" button 6
    #And Click on the save in Address verification
