Feature: India Localisation
  ...
  @Smoke @IndiaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is India with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
  ...
  @Smoke @IndiaLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "India" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "India" supplier registration
    Then Enter "TestCity" in "City" field after "India" supplier registration
    Then Enter "767356" in "PIN Code" field after "India" supplier registration
    Then Select "Telangana" in "State" dropdown
   ...
   @Smoke @IndiaLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is India and with out questionnaire
    Then Enter data in Email Address field
    ...
    Then Verify Tax Country "India" is Pre populated with country
    ###Labels
    ...
    Then Show "Corporate Identification Number (CIN)" label under "Tax Details"
    Then Show "Certification of Incorporation" label under "Tax Details"
    Then Show "Goods and Services Taxpayer Identification Number (GSTIN)" label under "Tax Details"
    Then Show "GST Registration Certificate" label under "Tax Details"
    Then Show "Permanent Account Number (PAN)" label under "Tax Details"
    Then Show "PAN card" label under "Tax Details"
    ...
    Then Show "Corporate Identification Number (CIN)" input text field under "Tax Details"
    Then Show "Goods and Services Taxpayer Identification Number (GSTIN)" input text field under "Tax Details"
    Then Show "Permanent Account Number (PAN)" input text field under "Tax Details"
    ...
    Then Verify "Permanent Account Number (PAN)" input text field enabled under "Tax Details"
    Then Verify "Goods and Services Taxpayer Identification Number (GSTIN)" input text field enabled under "Tax Details"
    Then Verify "Corporate Identification Number (CIN)" input text field enabled under "Tax Details"
    ...
    Then Show "Certification of Incorporation" button in basic information
    Then Show "GST Registration Certificate" button in basic information
    Then Show "PAN card" button in basic information
    ...
    Then Verify Upload "GST Registration Certificate" button clickable in basic information
    Then Verify Upload "PAN card" button clickable in basic information
    Then Verify Upload "Certification of Incorporation" button clickable in basic information
    ##Website checkbox
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Corporate Identification Number (CIN)" tooltip " CIN is a 21 character alpha-numeric unique identifier assigned by Registrar of Companies (ROC) e.g. U66188DL2015PTC015264. This is an optional field. " under "Tax Details"
    Then Show "Certification of Incorporation" tooltip " Attach your company's Certificate of Incorporation in the below mentioned formats. This is an optional field. " under "Tax Details"
    Then Show "Goods and Services Taxpayer Identification Number (GSTIN)" tooltip " GSTIN is a 15 character alpha-numeric unique identifier issued by the Central Board of Indirect Taxes and Customs (CBIC) e.g. 22AAAAA0000A1Z5. This is an optional field. " under "Tax Details"
    Then Show "GST Registration Certificate" tooltip " Attach your GST registration certificate issued in the form GST REG-06 in the below mentioned formats. This is an optional field. " under "Tax Details"
    Then Show "Permanent Account Number (PAN)" tooltip "The PAN is a ten-character alpha-numeric unique identifier. The format is as follows: AAAPL1234C: The first five characters are letters (in uppercase by default), followed by four numerals, and the last (tenth) character is a letter." under "Tax Details"
    Then Show "PAN card" tooltip "Attach a copy of your organization's PAN Card in the below mentioned formats." under "Tax Details"
    ...
    ###Required Fields
    Then Enter number "1546457457547" in "Phone Number" in corporation details
    ...
    Then Show error message "Required" under "Permanent Account Number (PAN)" field under "Tax Details"
    Then Show error message "Required" under "PAN card" field under "Tax Details"
    ...
    And Verify India flag in Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+91 - 12345 67890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+91 - 12345 67890"
    ...
    #Then Verify no error message is displayed under "D-U-N-S Number" field under "Tax Details"
    ###Business types
    Then Verify "Sole Proprietorship" listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Branch Office" listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Co-operative Societies" listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Company Limited by Guarantee" listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Hindu Undivided Family (HUF) Business" listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Insurance Company or Unlimited Company" listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Limited Liability Partnership (LLP)" listed in "Business Type" dropdown under "Tax Details"
    Then Verify "One Person Company (OPC)" listed in "Business Type" dropdown under "Tax Details"
    #Then Verify "Partnership" listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Private Limited Company" listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Public Limited Company" listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Statutory Company" listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Subsidiary Company" listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Other" listed in "Business Type" dropdown under "Tax Details"
    Then Select "Private Limited Company" value from Business type dropdown
    #####VAT Registration Number - Input type
    Then Enter "@#$%&" in "Permanent Account Number (PAN)" field under "Tax Details"
    Then Verify no data is entered in "Permanent Account Number (PAN)" field under "Tax Details"
    Then Enter "      " in "Permanent Account Number (PAN)" field under "Tax Details"
    Then Verify no data is entered in "Permanent Account Number (PAN)" field under "Tax Details"
    ...
    ###Document uploads
    #Then Scroll to view "PAN card" field
    Then Click "Upload PAN Card" button
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    #Then Show attached document under "PAN Card" "samplePDF.pdf"
    #Then Click "Upload PAN Card" button
    #Then Upload "PNG" under "Replace Document"
    #Then Click on the Confirm button.
    #Then Show attached document under "PAN Card" "samplePNG.png"
    #Then Click "Upload PAN Card" button
    #Then Upload "JPG" under "Replace Document"
    #Then Click on the Confirm button.
    #Then Show attached document under "PAN Card" "sampleJPG.jpg"
    #Then Click "Upload PAN Card" button
    #Then Upload "JPEG" under "Replace Document"
    #Then Click on the Confirm button.
    #Then Show attached document under "PAN Card" "sampleJPEG.jpeg"
    #Then Click "Upload PAN Card" button
    ...
    Then Verify "India" is listed in "Country/Region" dropdown
    Then Select "India" in "Country/Region" dropdown
    ...
    Then Show "PIN Code" Label
    Then Show "PIN Code" input text field
    Then Show "PO Box" Label
    Then Show "PO Box" input text field
    Then Show "PO Box PIN Code" Label
    Then Show "PO Box PIN Code" input text field
    #Tooltip
    ...
    Then Verify "PIN Code" input text field enabled
    Then Verify "PO Box" input text field enabled
    Then Verify "PO Box PIN Code" input text field enabled
    # Flag
    Then Verify "India" flag in Primary Phone
    And Verify "India" flag in Secondary Phone
    #Phone Number
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+91 - 12345 67890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+91 - 12345 67000"
    ###Required Error
    ...
    Then Show error message "Required" for "PIN Code" field
    ...
    #### Zip code
    Then Enter "1234" in "PIN Code" field
    Then Verify data entered in "PIN Code" field is "1234"
    Then Enter "1" in "PIN Code" field
    Then Show error message like "Must be a valid PIN Code." under "PIN Code" field
    Then Enter "@@@@" in "PIN Code" field
    Then Verify no data is entered in "PIN Code" field
    Then Enter "    " in "PIN Code" field
    Then Verify no data is entered in "PIN Code" field
    ###PO Box
    Then Enter "123456789012" in "PO Box" field
    ###PO Box Zip Code
    Then Enter "1234" in "PO Box PIN Code" field
    Then Verify data entered in "PO Box PIN Code" field is "1234"
    Then Enter "1" in "PO Box PIN Code" field
    Then Show error message like "Must be a valid PO Box PIN Code." under "PO Box PIN Code" field
    Then Enter "abcd" in "PO Box PIN Code" field
    Then Verify no data is entered in "PO Box PIN Code" field
    Then Enter "@@@@" in "PO Box PIN Code" field
    Then Verify no data is entered in "PO Box PIN Code" field
    Then Enter "    " in "PO Box PIN Code" field
    Then Verify no data is entered in "PO Box PIN Code" field
    Then Enter "252523" in "PIN Code" field
    Then Select "Telangana" in "State" dropdown
    ...
    Then Enter "abcd" in "PIN Code" field
    Then Verify no data is entered in "PIN Code" field
    Then Enter "1234" in "PIN Code" field
    Then Enter "abcd" in "PO Box PIN Code" field
    Then Verify no data is entered in "PO Box PIN Code" field
...
@Smoke @IndiaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is India and with questionnaire
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    Then Select "Statutory Company" value from Business type dropdown
    Then Wait for 3 seconds
    When Enter Permanent Account Number (PAN) for India under Tax Details
    Then Wait for 3 seconds
    When Enter Permanent Account Number (PAN) for India under Tax Details
  ...
  @Smoke @IndiaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country India for existing supplier
    When Enter India Supplier Email in Email Address field
    ...
    Then Enter value for Account Holder Name "Indian"
    #Then Enter value for Bank Routing Number "23634795651"
    And Wait for 2 seconds
    #Then Enter value for Bank Account Number "123456789123456743"
    Then Enter "98" in "Bank Control Key" field
    Then Enter input data in "Account Number" field
    And Enter value for Bank Key "123456789384"
    And Wait for 2 seconds
    Then Enter value for Bank Account Number "146574564645634344"
    Then Enter input data in "Account Number" field
    And Enter value for Bank Key "12345678934"
    #When Enter the IBAN evidence for India
    ...
    Then Select "Telangana" in "State" dropdown
    Then Enter "546634" in "PIN Code" field
    ...
    #Then Wait 5 seconds
    #Then Click on the Remove in Preferred
    #Then Wait 5 seconds
  ...
  @Smoke @IndiaLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country India for existing supplier
    When Enter India Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Telangana" in "State" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Enter "456634" in "PIN Code" field under "Factoring Company Address" section
    Then Click "Save" button 6
    #And Click on the save in Address verification
    Then Wait for 3 seconds
    Then Click on Not now button
  ...
  @Smoke @IndiaLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is India and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @IndiaLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is India and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
