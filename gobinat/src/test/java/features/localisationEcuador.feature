Feature: Ecuador Localisation
  ...
  @Smoke @EcuadorLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Ecuador with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Ecuador from the dropdown
    Then Select "Ecuador" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @EcuadorLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Ecuador" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Ecuador" supplier registration
    Then Enter "TestCity" in "City" field after "Ecuador" supplier registration
    Then Enter "12345" in "Postal Code" field after "Ecuador" supplier registration
    Then Select "Azuay" in "Province" dropdown
  ...
  @Smoke @EcuadorLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Ecuador and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Ecuador" is Pre populated with country
    ###Labels
    ...
    Then Show "VAT Registration Number" tooltip "VAT Registration Number as issued by the Ecuador Tax Office and is usually 13 digits. This field is mandatory." under "Tax Details"
    Then Show "VAT Registration Document" tooltip "Attach your VAT Registration Document as issued by the Ecuador Tax Office in the below mentioned formats. This is a mandatory attachment." under "Tax Details"
    ...
    ###Business types
    Then Verify "Collective Name Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Mixed Capital Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    ####Flag
    Then Verify "Ecuador" flag Phone Number
    And Verify "Ecuador" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+593 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+593 1234567890"
    ...
    Then Verify "Ecuador" is listed in "Country/Region" dropdown
    Then Select "Ecuador" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+593 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+593 1234567000"
    ###Required Error
    ...
    @Smoke @EcuadorLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Ecuador and with questionnaire
    Then Enter data in Email Address field
  ...
  @Smoke @EcuadorLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Ecuador and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @EcuadorLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Ecuador and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @EcuadorLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Ecuador for existing supplier
    When Enter Ecuador Supplier Email in Email Address field
    ...
    Then Select "Ecuador" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Ecuador"
    Then Select "US Dollar (USD)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Ecuador"
    ...
    Then Enter value for Bank Branch Name "Bank of Ecuador"
  ...
  @Smoke @EcuadorLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Factoring Company Account with valid data for Country Ecuador for existing supplier
    When Enter Ecuador Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Enter value for City " Tirana"
    #Then Select "Finiq" in "Municipality" dropdown
    Then Enter value for Postal Code "43256"
    Then Enter value for Bank Contact Name "bankingcontact"
    Then Enter value for Bank Contact Number "9886543210"
    # Then Wait for 3 seconds
    Then Wait for 3 seconds
    Then Enter "IT People Corp" in "Factoring Company Name" field under "Factoring Company Info" section
    Then Select "Ecuador" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Select "Azuay" in "Province" dropdown on Factoring Company Address
