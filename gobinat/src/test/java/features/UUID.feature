Feature: UUID feature
  ...
  #Validation of UUID feature validation
  Background: Login as IBM supplier
  ...
  @Smoke @UUID @Buyer
  Scenario: Verify if Buyer is able to invite a supplier with Supplier entity B (Company Name) where the supplier email address is already registered Supplier entity A (Company Name) within buyer organization.
    ...
    #Then Enter existing Supplier Contact email address on Invite Supplier modal "uuidibmusrauto@maildrop.cc"
    #Then Enter existing Supplier Confirm Contact email address on Invite Supplier modal "uuidibmusrauto@maildrop.cc"
    ...
    Then Wait for 3 seconds
    Then Logout from the system
    ##Then Verify Email received in supplier "uuidibmusaautomation@mailinator.com" Inbox with subject "SUPPLIER INVITATION: Follow-up from IBM’s introduction to Trust Your Supplier"
    #Then Verify Email received in supplier "uuidibmusrauto@maildrop.cc" Inbox with subject "IBM is inviting you to join Trust Your Supplier" in maildrop
    Then Verify received an email in supplier maildrop Inbox with subject "IBM is inviting you to join Trust Your Supplier"

  @Smoke @UUID @Buyer
  Scenario: Verify if Buyer is able invite a supplier with Supplier entity B (Company Name) where the supplier email address is already registered Supplier entity A (Company Name) with different buyer organization.
    Then Enter data in Email Address field
    #Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Wait for 3 seconds
    Then Logout from the system
    #Entity B(Nokia) (Different companay)
    ...
    When Click on the IgnoreAndProceed button
    Then Select "United States of America" in "Supplier Country of Registration" dropdown
    #Entering same Email address from IBM buyer
    Then Enter Contact same Email Address on Invite Supplier window from maildrop
    And Enter Confirm same Contact Email Address on Invite Supplier window from maildrop
    #Then Enter existing Supplier Contact email address on Invite Supplier modal "uuidibmusrauto@maildrop.cc"
    #Then Enter existing Supplier Confirm Contact email address on Invite Supplier modal "uuidibmusrauto@maildrop.cc"
  ...
  @Regression @UUID @Buyer
  Scenario: Verify if Buyer is able to invite a supplier liaison with Supplier Entity A in pending status where Supplier email address is already registered with Supplier Entity B with in Buyer Org A.
    Then Enter data in Email Address field
    ...
    And Click "Invite Relationship Contact" button
    And Wait for 3 seconds
    And Enter "First Name" in "firstName" field for supplier liason
    And Enter "Last Name" in "lastName" field for supplier liason
    And Enter supplier laison Email in "email" field
    And Enter supplier laison Confirm Email in "confirmEmail" field
    And Click "Send Invite" button
    And Verify toast message "Liaison successfully invite" successfully is shown
    ...
    And Wait for 5 seconds
  @Regression @UUID @Buyer
  Scenario: Verify if Buyer is able to invite a supplier liaison with Supplier Entity A in pending status where Supplier email address is already registered with Supplier Entity B with in Buyer Org B.
    Then Enter data in Email Address field for nokia buyer
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    And Logout from the system
    #Then Verify received an email in supplier Inbox with subject "IBM is inviting you to join Trust Your Supplier"
    And Verify received an email in supplier maildrop Inbox with subject "Nokia is inviting you to join Trust Your Supplier"
    And Wait for 5 seconds
  ####Following test cases are covered in below scenario:
  ###1. Verify if Supplier is able to publish profile with for newly registered Supplier entity B whereas existing Supplier entity A is in Accepted Status with Buyer org A.
  @Regression @UUID @Buyer @Supplier
  Scenario: Verify if Buyer is able to invite a supplier entity B where supplier email used is already registered with Supplier Entity A which is in Accepted status within Buyer org A.
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    And Show Email with subject "Trust Your Supplier Verification Code" from maildrop
    ...
    Then Wait for 5 seconds
    And Click accept IBM registration checkbox
  ...
  ###Following test cases are covered in below scenario:
  ##1.Verify if Supplier is able to publish profile with for newly registered Supplier entity B whereas existing Supplier entity A is in Accepted Status with Buyer org B.
  ##
  @Regression @UUID @Buyer @Supplier
  Scenario: Verify if Buyer is able to invite a supplier entity B where supplier email used is already registered with Supplier Entity A which is in Accepted status with Buyer org B.
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
  ...
  @Regression @UUID @Buyer @TYSFunctionality
  ...
  @Regression @UUID @Buyer
  Scenario: Verify if Buyer is able to invite a supplier entity B where supplier email used is already registered with Supplier Entity A which is in Profile Complete status with Buyer org B.
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
  ...
  @Regression @UUID @Buyer
  Scenario: Verify if Buyer is able to invite a supplier entity B where supplier email used is already registered with Supplier Entity A which is in RFR status within Buyer org A.
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    Then Wait for 20 seconds
    #When Click on Not a suitable match
    And Click on at "Next Step" button
    Then Wait for 10 seconds
    When Click on Assign "1" button
    Then Select the option "First Name Last Name - Director" on the Assign a Contact to Management Team modal
  ...
  @Regression @UUID @Buyer
  Scenario: Verify if Buyer is able to invite a supplier entity B where supplier email used is already registered with Supplier Entity A which is in RFR status with Buyer org B.
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
  ...
  @Regression @UUID @Buyer
  Scenario: Verify if Buyer is able to invite a supplier entity B where supplier email used is already registered with Supplier Entity A which is in On-boarded status within Buyer org A.
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
  ...
  @Regression @UUID @Buyer
  Scenario: Verify if Buyer is able to invite a supplier entity B where supplier email used is already registered with Supplier Entity A which is in On-boarded status with Buyer org B.
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
  ...
  @Regression @UUID @Buyer
  Scenario: Verify if Buyer is able to invite a supplier entity B where supplier email used is already registered with Supplier Entity A which is in Return of Supplier status within Buyer org A.
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
  ...
  @Regression @UUID @Buyer
  Scenario: Verify if Buyer is able to invite a supplier entity B where supplier email used is already registered with Supplier Entity A which is in Return of Supplier status with Buyer org B.
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
  ...
  @Regression @UUID @Buyer
  Scenario: Verify if Buyer is able to invite a supplier with Supplier Entity with email B where Supplier email declined invitation with Supplier Entity A with same email address within Buyer Org A.
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    Then Wait for 3 seconds
    When Click "Decline Invitation" button
    Then Enter the Notes under the accepth buyer Notes Box
    And Enter the Reason for Decline
    When Click on decline button
    Then Verify toast message "Successfully rejected relationship request" successfully is shown
    Then Logout from the system
    #Verify Email invite from decline email
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    And Wait for 5 seconds
  @Regression @UUID @Buyer
  Scenario: Verify if Buyer is able to invite a supplier with Supplier Entity B where Supplier email used in invitation has already declined invitation with Supplier Entity A with Buyer Org B and Accepted invite from Buyer Org C.
    ###Verifying status in Buyer Org C
    #Issue with Verification code
    ...
    Then Logout from the system
		#Then Verify received an email in supplier Inbox with subject "IBM is inviting you to join Trust Your Supplier"
    #Then Verify received an email in supplier maildrop Inbox with subject "Vodafone Group Plc is inviting you to join Trust Your Supplier"
    ...
    Then Wait for 5 seconds
		...
		#maildrop
    #When Click on the email with subject "Vodafone Group Plc is inviting you to join Trust Your Supplier" from maildrop
    When Click on the email with subject "Vodafone is inviting you to join Trust Your Supplier" from maildrop
    When Click on link JOIN NOW from maildrop
    Then Wait for 3 seconds
    Then Switch to "new TYS" tab
    ...
    And Logout from the system
    #Then Verify received an email in supplier Inbox with subject "IBM is inviting you to join Trust Your Supplier"
    #And Verify received an email in supplier maildrop Inbox with subject "Nokia Corporation wants to connect with you on Trust Your Supplier"
    And Verify received an email in supplier maildrop Inbox with subject "Nokia is inviting you to join Trust Your Supplier"
    And Wait for 5 seconds
    ...
    ###Sending invite from Buyer Org A
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
  ...
  @Regression @UUID @Buyer
  Scenario: Verify if Buyer is able to invite a supplier entity B where supplier email used is already registered with Supplier Entity A which is in Profile Complete status with Buyer org B and pending/accepted/RFR/Return Supplier/On-boarded status with Buyer org C.
    ###Verifying status in Buyer Org C
    Then Enter data in Email Address field for vodafone buyer
    When Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Logout from the system
    #Then Verify received an email in supplier Inbox with subject "IBM is inviting you to join Trust Your Supplier"
    And Verify received an email in supplier maildrop Inbox with subject "Vodafone is inviting you to join Trust Your Supplier"
    And Wait for 5 seconds
    #maildrop
    When Click on the email with subject "Trust Your Supplier" from maildrop
    And Click on link JOIN NOW from maildrop
    And Wait for 3 seconds
    And Switch to "new TYS" tab
    #Enter data
    And Enter timestamp in "Legal Business Name" field "Legal Business"
    ...
    And Wait for 3 seconds
    And Logout from the system
    ###Verifying status in Buyer Org B
    Then Enter data in Email Address field for nokia buyer
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    And Wait for 5 seconds
  @Regression @UUID @Buyer
  Scenario: Verify if Buyer is able to invite a supplier entity B where supplier email used is already registered with Supplier Entity A which is in RFR status within Buyer org A and pending/accepted/RFR/Return Supplier/On-boarded status with Buyer org B.
    ###Verifying status in Buyer Org C
    Then Enter data in Email Address field for vodafone buyer
    When Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Regression @UUID @Buyer
  Scenario: Verify if Buyer is able to invite a supplier entity B where supplier email used is already registered with Supplier Entity A which is in Return of Supplier status with Buyer org B and pending/accepted/RFR/Return Supplier/On-boarded status with Buyer org C.
    ###Verifying status in Buyer Org C
    Then Enter data in Email Address field
    When Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Wait for 3 seconds
    And Logout from the system
    #Pending invite from Buyer Org B
     Then Enter data in Email Address field for nokia buyer
    When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
