Feature: Qatar Localisation
  ...
  @Smoke @QatarLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Qatar with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Qatar" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @QatarLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Qatar" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Qatar" supplier registration
    Then Enter "TestCity" in "City" field after "Qatar" supplier registration
    Then Enter "767374" in "PO Box" field after "Qatar" supplier registration
    Then Select "Al Khor" in "Municipality" dropdown
  ...
  @Smoke @QatarLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Qatar and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Enter "TestAddress2" in "Address Line 2" field after "Qatar" supplier registration
    Then Enter "TestCity" in "City" field after "Qatar" supplier registration
    Then Enter "14567" in "PO Box" field after "Qatar" supplier registration
    Then Select "Al Khor" in "Municipality" dropdown
    Then Click "Next" button
    Then Wait for 3 seconds
    Then Select the UNSPSC codes on the Basic information page
    ...
    Then Verify Tax Country "Qatar" is Pre populated with country
    ###Labels
    ...
    Then Show "Company Registration Number" tooltip " Qatar Financial Centre (QFC) Number issued by the Qatar Financial Centre which is usually of 5 digits.  This is an optional field. " under "Tax Details"
    Then Show "Company Registration Document" tooltip " Attach your Company Registration Document issued by the Ministry of Economy and Commerce in the below mentioned formats.This is an optional attachment. " under "Tax Details"
    Then Show "Tax Identification Number" tooltip " Tax Identification Number issued by General Tax Authority in Qatar which is usually minimum 4 and maximum 20 alphanumeric characters. This is a mandatory field. " under "Tax Details"
    Then Show "Tax Registration Document" tooltip " Attach your company's Certificate of Tax Registration issued by the General Tax Authority in Qatar in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    ...
    Then Select "Limited Liability Company (LLC)" value from Business type dropdown
    Then Verify "Private Shareholding Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Representative Trade Office (RTO)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Simple Partnership Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Sole Proprietorship Company (SPC)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Other" is listed in "Business Type" dropdown under "Tax Details"
    Then Select "Foreign Company" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Scroll to view "Phone Number" field
    #Then Verify "Qatar" flag in Phone Number field
    #And Verify "Qatar" flag in Fax Number field
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+974 323213123555"
    Then Enter phone number "3232131235" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+974 3232131235"
    ...
    Then Verify "Qatar" is listed in "Country/Region" dropdown
    Then Select "Qatar" in "Country/Region" dropdown
    ...
    # Flag
    #Then Verify "Qatar" flag in Primary Phone field
    #And Verify "Qatar" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+974 42324242342"
    Then Enter phone number "42324242342" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+974 42324242342"
    Then Click on "Save Contact" button
    ...
    Then Enter "Qatar" in "City" field
    Then Select "Al Khor" in "Municipality" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @QatarLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Qatar  and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @QatarLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Qatar with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @QatarLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Qatar with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @QatarLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Add Company Account with valid data for Country Qatar for existing supplier
    ...
    Then Select "Qatar" in "Country/Region" dropdown
    Then Enter "Qatar Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Qatar"
    Then Select "Qatari Riyal (QAR)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Qatar"
    And Wait for 2 seconds
  ...
  @Smoke @QatarLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Qatar for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Qatar" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Select "Al Khor" in "Municipality" dropdown section
    ...
    Then Logout from the system
     ...
     @Regression @QatarLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually of 21 alphanumeric characters, but can be variable. Please indicate the leading zero if applicable. This is a mandatory field." in add bank account page
    And Verify "Bank Key" tooltip of "Bank Identification Number associated with the bank which is usually of 4 alphanumeric characters and is 5th,6th,7th,8th digits in IBAN. This is an optional field." in add bank account page
    ...
    And Verify "Municipality" tooltip of "Select the appropriate municipality from the dropdown. This is an optional field." in add bank account page
    ...
    And Verify "PO Box" tooltip of "The Post Office Box of your company which is usually 3 to 5 digits. This is an optional field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Municipality" tooltip of "Select the appropriate municipality from the dropdown. This is an optional field." in add bank account Factoring Company Address section
    ...
    And Verify "PO Box" tooltip of "The Post Office Box of your company which is usually 3 to 5 digits. This is an optional field." in add bank account Factoring Company Address section
