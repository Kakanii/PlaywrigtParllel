Feature: Brazil Localisation
  ...
  Scenario: Verify invite a Supplier whose tax country is Brazil with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
  ...
  @Smoke @BrazilLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Brazil and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Brazil and with questionnaire
    ...
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    And Select "Consortium" value from Business type dropdown
  ...
  @Smoke @BrazilLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Brazil with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    #Then Verify phone number "Primary Phone" is entered in accepted format "+55 (423) 424-2423423"
    Then Enter phone number "4234242423424" in "Secondary Phone" field
    #Then Verify phone number "Secondary Phone" is entered in accepted format "+55 (423) 424-2423424"
    ###Required Error
    Then Click on "Save Contact" button
    Then Show error message "Required" for "Address Type" field
    Then Show error message "Required" for "Address Line 1" field
  ...
  @Smoke @BrazilLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Brazil with out questionnaire and with Additional Information
   Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @BrazilLocalisation @Supplier @BankAccount @QuickSanity @QuickCheck
  Scenario: Add Company Account with valid data for Country Brazil for existing supplier
  ...
  Scenario: Add Factory Company Account with valid data for Country Brazil for existing supplier
    ...
    Then Upload "PDF" document under Upload Document
    Then Click "Confirm" button
    Then Enter value for Bank Branch Name "Bank of Brazilian"
    Then Enter value for Address "Hilton Garden Inn"
    Then Enter value for City " Tirana"
    Then Select "Bahia" in "State" dropdown
    Then Enter value for Postal Code "12312-313"
    ...
    Then Select "Brazil" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
  ...
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "The account number of your account at the bank. It is minimum 3 to maximum 18 alpha numeric characters." in add bank account page
    And Verify "Bank Key" tooltip of "Bank Key is bank identifier code or ‘Codigo compe’ or ‘ISPB bank code’ as well. It consists of 7 or 8 alpha numeric characters (usually 8 alpha numeric characters ). If IBAN is available, It is 5th-12th characters of the IBAN." in add bank account page
    ...
    And Verify "City" tooltip of "The name of the City in which your Company address is located" in add bank account page
    ...
    And Verify "Postal Code" tooltip of "The Postal Code at which your Company's address is located which is usually 8 digits with hyphen. This field is mandatory." in add bank account page
    ...
    Then Verify "PO Box Postal Code" tooltip of "The PoBox Postal Code at which your Company's address is located which is usually 8 digits with hyphen" in add bank account page
