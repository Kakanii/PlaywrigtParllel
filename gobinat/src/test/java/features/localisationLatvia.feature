...
@LatviaLocalisation
  Scenario: I am able to search Exhibits Supplier on Connected Supplier page
    When Enter EmailAdress in Email Address field "latviasupinc@maildrop.cc"
    ...
    And Click on the radio button "YES" under "Are you a Diversity Supplier?" in Latvia Diversity
    #Diversity category
  ...
  @Smoke @LatviaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Latvia with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
  ...
  @Smoke @LatviaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Latvia and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @LatviaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Latvia with out questionnaire and with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  Scenario: Add Factory Company Account with valid data for Country Egypt for existing supplier
    ...
    Then Select "Latvia" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Enter "Salas" in "City" field under "Factoring Company Address" section
    Then Enter "Rana" in "District" field under "Factoring Company Address" section
    Then Wait for 9 seconds
    Then Select "Riga" in "Region (Rajons)" dropdown under "Factoring Company Address" section
    Then Enter value for Factory Company Postal Code "6312"
    Then Wait for 3 seconds
    When Enter Factoring Company Contact Name for Latvia
    And Enter Factoring Company Contact Number for Latvia
    And Enter Factoring Company Email Address for Latvia
    Then Wait for 3 seconds
    Then Click "Save" button 6
    #And Click on the save in Address verification
    Then Wait for 3 seconds
  ...
  @Regression @LatviaLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually 13 digits. This is a mandatory field" in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 21 alphanumeric characters.Example:LV80BANK0000435195001.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    ...
    And Verify "Region (Rajons)" tooltip of "Select the appropriate region (rajon) from the dropdown. This is a mandatory field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Bank Contact Email Address" tooltip of "The email address of the contact from the bank in which this account is held." in add bank account page
    And Verify "Bank Contact Number" tooltip of "The phone number of the contact from the bank in which this account is held." in add bank account page
    And Scroll Down until "1600" dimension on the page
    ...
    And Verify "Region (Rajons)" tooltip of "Select the appropriate region (rajon) from the dropdown. This is a mandatory field." in add bank account Factoring Company Address section
