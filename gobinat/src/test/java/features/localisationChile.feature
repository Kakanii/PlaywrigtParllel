Feature: Chile Localisation
  ...
  @Smoke @ChileLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Chile with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Chile from the dropdown
    Then Select "Chile" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @ChileLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Chile" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Chile" supplier registration
    Then Enter "TestCity" in "City" field after "Chile" supplier registration
    Then Enter "2343253" in "Postal Code" field after "Chile" supplier registration
    Then Select "Araucania" in "Region" dropdown
  ...
  @Smoke @ChileLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Chile and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Chile" is Pre populated with country
    ###Labels
    ...
    Then Show "VAT Registration Number" tooltip "VAT Registration Number as issued by the Chile Tax office and is usually 10 digits including hyphen.Example:7608642-5 ,76086428-K or 7608647-2. This is an optional field." under "Tax Details"
    Then Show "VAT Registration Document" tooltip "Attach your VAT Registration Document issued by the Chile Tax office in the below mentioned formats. This is an optional attachment." under "Tax Details"
    ...
    ###Business types
    Then Verify "Branch Office of a Foreign Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Simplified Corporation" is listed in "Business Type" dropdown under "Tax Details"
    ...
    ####Flag
    Then Verify "Chile" flag Phone Number
    And Verify "Chile" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+56 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+56 1234567890"
    ...
    Then Wait for 3 seconds
    Then Enter Company Registration Number under "Tax Details" field for chile
    Then Enter data VAT Registration Number "Tax Details" field for chile
    ...
    Then Verify "Chile" is listed in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+56 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+56 1234567000"
    ###Required Error
    ...
    Then Select "Araucania" in "Region" dropdown
    ###PO Box Zip Code
    Then Enter "3243252" in "PO Box Postal Code" field
    Then Verify data entered in "PO Box Postal Code" field is "3243252"
    ...
    Then Verify no data is entered in "PO Box Postal Code" field
    Then Enter "3243252" in "PO Box Postal Code" field
    Then Enter "3243252" in "Postal Code" field
  ...
  @Smoke @ChileLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Chile and with questionnaire
    Then Enter data in Email Address field
  ...
  @Smoke @ChileLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Chile and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
   ...
   @Smoke @ChileLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Chile and with out questionnaire with Additional information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @ChileLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Chile for existing supplier
    When Enter Chile Supplier Email in Email Address field
    ...
    Then Select "Chile" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Chile"
    Then Select "Chilean Peso (CLP)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Chile"
    ...
    And Wait for 2 seconds
    And Enter value for Bank Key "435"
    ...
    Then Enter value for Bank Branch Name "Bank of Chile"
    ...
    Then Enter value for Postal Code "4363463"
  ...
  @Smoke @ChileLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Add Factoring Company Account with valid data for Country Chile for existing supplier
    When Enter Chile Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Chile" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Enter "4363463" in "Postal Code" field under "Factoring Company Address" section
    Then Select "Araucania" in "Region" dropdown under Factoring Company Address
