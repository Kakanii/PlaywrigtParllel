Feature: Romania Localisation
  ...
  @Smoke @RomaniaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Romania with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Romania from the dropdown
    Then Select "Romania" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @RomaniaLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Romania" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Romania" supplier registration
    Then Enter "TestCity" in "City" field after "Romania" supplier registration
    Then Enter "123456" in "Postal Code" field after "Romania" supplier registration
    Then Select "Alba" in "County/Region" dropdown
  ...
  @Smoke @RomaniaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Romania and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Romania" is Pre populated with country
    ###Labels
    ...
    Then Show "EU VAT Registration Document" tooltip "Attach your EU VAT Registration Document issued by the Romania Tax office in the below mentioned formats. This is a mandatory attachment." under "Tax Details"
    Then Show "VAT Registration Number" tooltip "VAT Registration Number, also known as Codul de identificare fiscală (CIF) as issued by the Romania Tax office and in the following format 12345678. This is an optional field." under "Tax Details"
    Then Show "VAT Registration Document" tooltip "Attach your VAT Registration Document issued by the Romania Tax office in the below mentioned formats. This is an optional attachment." under "Tax Details"
    ...
    ####Flag
    Then Verify "Romania" flag Phone Number
    And Verify "Romania" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+40 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+40 1234567890"
    ...
    Then Verify "Romania" is listed in "Country/Region" dropdown
    Then Select "Romania" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+40 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+40 1234567000"
    ###Required Error
    ...
    #### Zip code
    Then Enter "353566" in "Postal Code" field
    Then Verify data entered in "Postal Code" field is "353566"
    ...
    Then Select "Alba" in "County/Region" dropdown
    ###PO Box Zip Code
    Then Enter "345466" in "PO Box Postal Code" field
    Then Verify data entered in "PO Box Postal Code" field is "345466"
    ...
    Then Logout from the system
     ...
     @Smoke @RomaniaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Romania and with questionnaire
    Then Enter data in Email Address field
  ...
  @Smoke @RomaniaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Romania and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @RomaniaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Romania and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @RomaniaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Romania for existing supplier
    ...
    Then Select "Romania" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Romania"
    Then Select "Romanian leu (RON)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Romania"
    ...
    Then Enter value for Bank Branch Name "Bank of Romania"
    ...
    Then Enter value for Postal Code "432766"
  ...
  @Smoke @RomaniaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Factoring Company Account with valid data for Country Romania for existing supplier
    When Enter Romania Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Romania" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Enter "434356" in "Postal Code" field under "Factoring Company Address" section
    Then Select "Alba" in "County/Region" dropdown on Factoring Company Address
