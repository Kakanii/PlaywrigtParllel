Feature: Georgia Localisation
  ...
  @Smoke @GeorgiaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Georgia with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Georgia" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @GeorgiaLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Georgia" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Georgia" supplier registration
    Then Enter "TestCity" in "City" field after "Georgia" supplier registration
    Then Enter "1234" in "Postal Code" field after "Georgia" supplier registration
    Then Select "Ajaria" in "District" dropdown
  ...
  @Smoke @GeorgiaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Georgia and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
   ...
   #invite without questionare
    ...
    Then Verify Tax Country "Georgia" is Pre populated with country
    ###Labels
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Company Registration Number" tooltip "National Identifier Number which is  issued by National Public Register of Companies. This is an optional field." under "Tax Details"
    Then Show "Company Registration Document" tooltip "Attach your Business Registration Document  which is issued by National Public Register of Companies. This is an optional attachment." under "Tax Details"
    Then Show "Tax Identification Number" tooltip "TIN which is usually same as EIN(Employer Identification Number) and is of 9 alphanumeric characters  issued by IRS,e.g.1234567AA.  This number is also used for paying VAT upon successful registration.This is a mandatory field." under "Tax Details"
    Then Show "Tax Registration Document" tooltip "Attach your company's Tax or VAT Registation Certificate issued by IRS. This is a mandatory attachment." under "Tax Details"
    ...
    Then Verify "Individual Enterprise" is listed in "Business Type" dropdown under "Tax Details"
    ...
    ####Flag
    Then Verify "Georgia" flag Phone Number
    And Verify "Georgia" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+995 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+995 1234567890"
    ...
    Then Verify "Georgia" is listed in "Country/Region" dropdown
    Then Select "Georgia" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+995 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+995 1234567000"
    ###Required Error
    ...
    Then Select "Abkhazia" in "District" dropdown
    ###PO Box Zip Code
...
@Smoke @GeorgiaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Georgia and with questionnaire
    Then Enter data in Email Address field
    ...
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    And Select "Limited Partnership" value from Business type dropdown
  ...
  @Smoke @GeorgiaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Georgia and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
 ...
 @Smoke @GeorgiaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Georgia and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @GeorgiaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Georgia for existing supplier
    When Enter Georgia Supplier Email in Email Address field
    ...
    Then Select "Georgia" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Georgia"
    Then Select "Georgian lari (GEL)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Georgia"
    ...
    And Wait for 2 seconds
    And Enter value for Bank Key "12"
    ...
    Then Enter value for Bank Branch Name "Bank of Georgia"
  ...
  @Smoke @GeorgiaLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Add Factoring Company Account with valid data for Country Georgia for existing supplier
    When Enter Georgia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Georgia" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Enter "4345" in "Postal Code" field under "Factoring Company Address" section
    Then Select "Abkhazia" in "District" dropdown on Factoring Company Address
