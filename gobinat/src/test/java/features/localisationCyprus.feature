Feature: Cyprus Localisation
  ...
  @Smoke @CyprusLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Cyprus with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Cyprus" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @CyprusLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Cyprus from the dropdown
    Then Select "Cyprus" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Cyprus" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Cyprus" supplier registration
    Then Enter "TestCity" in "City" field after "Cyprus" supplier registration
    Then Enter "12345" in "Postal Code" field after "Cyprus" supplier registration
    Then Select "Paphos" in "District" dropdown
  ...
  @Smoke @CyprusLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Cyprus and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Cyprus from teh dropdown
    Then Select "Cyprus" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Cyprus" is Pre populated with country
    ###Labels
    ...
    Then Show "VAT Registration Number" tooltip " VAT Registration Number as issued by the Cyprus Tax Office and is usually 9 alphanumeric characters. This is a mandatory field. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your VAT Registration Document as issued by the Cyprus Tax Office in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
     Then Show "EU VAT Registration Number" tooltip " EU VAT Registration Number as issued by the Cyprus Tax Office and is usually 11 alphanumeric characters and in the format CY99999999L. This is a mandatory field. " under "Tax Details"
    Then Show "EU VAT Registration Document" tooltip " Attach your EU VAT Registration Document as issued by the Cyprus Tax Office in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    ...
    ###Business types
    Then Verify "Exempt Private Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "Limited Partnerhip" value from Business type dropdown
    Then Verify "Limited Private Compay" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Non Profit Organization" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Sole Properietor" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+357 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+357 323213123555"
    ...
    Then Verify no data is entered in "EU VAT Registration Number" field under "Tax Details"
    #Then Wait for 3 seconds
    ############When Enter VAT Registration Number for Cyprus  under Tax Details
    ...
    #Then Enter "CY" followed by "" and 8 alphanumeric characters in "EU VAT Registration Number" field under "Tax Details"
    #Then Enter data EU VAT Registration Number under Tax Details
    ...
    Then Verify "Cyprus" is listed in "Country/Region" dropdown
    Then Select "Cyprus" in "Country/Region" dropdown
    ...
    # Flag
    #Then Verify "Cyprus" flag in Primary Phone field
    #And Verify "Cyprus" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+357 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+357 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Enter "1234" in "PO Box Postal Code" field
    Then Enter "1234" in "Postal Code" field
    Then Enter "Nicosia" in "City" field
    Then Select "Nicosia" in "District" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @CyprusLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Cyprus and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Enter "TestAddress2" in "Address Line 2" field after "Cyprus" supplier registration
    Then Enter "TestCity" in "City" field after "Cyprus" supplier registration
    Then Enter "1234" in "Postal Code" field after "Cyprus" supplier registration
    Then Select "Paphos" in "District" dropdown
    Then Click "Next" button
    Then Wait for 3 seconds
    Then Select the UNSPSC codes on the Basic information page
    ...
    Then Enter phone number "323213123555" in "Primary Phone" field
    Then Verify phone number "Primary Phone" is entered in accepted format "+357 323213123555"
    Then Enter phone number "323213123557" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+357 323213123557"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    Then Enter 150 digit alpha numeric data in "Address Line 1" field
  ...
  @Smoke @CyprusLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Cyprus with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @CyprusLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Cyprus with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @CyprusLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Cyprus for existing supplier
    ...
    Then Select "Cyprus" in "Country/Region" dropdown
    Then Enter "Cyprus Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Cyprus"
    Then Select "Euro (EUR)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Cyprus"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Cyprus"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City " Tirana"
    Then Select "Paphos" in "District" dropdown
    Then Enter value for Postal Code "2756"
    Then Enter "1234" in "PO Box" field
    Then Enter "1234" in "PO Box Postal Code" field
  ...
  @Smoke @CyprusLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Cyprus for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Cyprus" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Wait for 5 seconds
    Then Select "Paphos" in "District" dropdown section
    Then Enter "4567" in "Postal Code" field under "Factoring Company Address" section
    Then Enter "3456" in "PO Box" field under "Factoring Company Address" section
  ...
  @Regression @CyprusLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually in the range 16 digits. This is the last 16 digits of IBAN. This is a mandatory field" in add bank account page
    And Verify "Bank Key" tooltip of "Bank Account Code (Identifier) associated with the bank which is usually 8 digits (bank code + sort code). This is the 5th to 12th digits of IBAN number and the field is mandatory." in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 28 alphanumeric characters.Example:CY17002001280000001200527600.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    ...
    And Verify "District" tooltip of "Select the appropriate district from the dropdown. This is a mandatory field." in add bank account page
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 4 digits. This is a mandatory field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "District" tooltip of "Select the appropriate district from the dropdown. This is a mandatory field." in add bank account Factoring Company Address section
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 4 digits. This is a mandatory field." in add bank account Factoring Company Address section
