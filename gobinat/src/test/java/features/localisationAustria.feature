Feature: Austria Localisation
  ...
  @Smoke @AustriaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Austria with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Austria from teh dropdown
    Then Select "Austria" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @AustriaLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Austria" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Austria" supplier registration
    Then Enter "TestCity" in "City" field after "Austria" supplier registration
    Then Enter "7673" in "Postal Code" field after "Austria" supplier registration
    Then Select "Vienna" in "State" dropdown
  ...
  @Smoke @AustriaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Austria and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Austria" is Pre populated with country
    ###Labels
    ...
    Then Show "Tax Identification Number" tooltip "Please enter Tax identification number or VAT identification number (VATIN) in the format 'AT'+U+8 digits, – e.g. ATU99999999." under "Tax Details"
    ...
    #Then Show "EU VAT Identification Number" tooltip " EU VAT numbers have 11 characters (ATU + 8 digits). The first position following the prefix is always "U". The last 2 digits constitute a control number. This is an optional field. " under "Tax Details"
    ...
    ####Flag
    Then Verify "Austria" flag in Phone Number field
    And Verify "Austria" flag in Fax Number field
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+43 (323) 213-123555"
    Then Enter phone number "3232131235" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+43 (323) 213-1235"
    ...
    Then Wait for 3 seconds
    ############When Enter Austrian Company Number for Austria under Tax Details
    ...
    ###Document uploads
    Then Scroll to view "Tax Registration Certificate" field
    ...
    # Flag
    Then Verify "Austria" flag in Primary Phone field
    And Verify "Austria" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+43 (423) 424-242342"
    Then Enter phone number "423424242342" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+43 (423) 424-242342"
    ...
    Then Enter "1234" in "PO Box Postal Code" field
    Then Enter "1234" in "Postal Code" field
    Then Enter "Austria" in "City" field
    Then Select "Vienna" in "State" dropdown
    Then Click on "Save Contact" button
    ...
    Then Select text "Austria" under "IBM Country & ISO Code" for Custom Fields
    Then Wait for 3 seconds
  ...
  @Smoke @AustriaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Austria and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
   ...
   Then Verify "General Partnership" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify phone number "Secondary Phone" is entered in accepted format "+43 (423) 424-242343"
    Then Verify "Branch" is listed in "Address Type" dropdown
    Then Select "Branch" in "Address Type" dropdown
    Then Verify "Austria" is listed in "Country/Region" dropdown
    Then Select "Austria" in "Country/Region" dropdown
  ...
  @Smoke @AustriaLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Austria with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @AustriaLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Austria with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @AustriaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Austria for existing supplier
    ...
    Then Enter value for Bank Name "Bank of Austria"
    Then Select "Australian Dollar (AUD)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Austria"
    ...
    Then Enter value for Bank Branch Name "Bank of Austria"
  ...
  @Smoke @AustriaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Austria for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Austria" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Select "Vienna" in "State" dropdown section
