Feature: Philippines Localisation

  #PhilippinesLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @PhilippinesLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Philippines with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Philippines" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @PhilippinesLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Philippines" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Philippines" supplier registration
    Then Enter "TestCity" in "City" field after "Philippines" supplier registration
    Then Enter "4634" in "Postal Code" field after "Philippines" supplier registration
    Then Select "Aklan" in "Province/Region" dropdown
   ...
   @Smoke @PhilippinesLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Philippines and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Philippines" is Pre populated with country
    ###Labels
    ...
    Then Show "Notice of Registration" label under "Tax Details"
    Then Show "Taxpayer ID Number (TIN)" label under "Tax Details"
    ...
    Then Show "Taxpayer ID Number (TIN)" input text field under "Tax Details"
    ...
    Then Verify "Taxpayer ID Number (TIN)" input text field enabled under "Tax Details"
    ...
    Then Show "Notice of Registration" button in basic information
    ...
    Then Verify Upload "Notice of Registration" button clickable in basic information
    ...
    Then Show "Notice of Registration" tooltip "Attach your Notice of Registration in the below mentioned formats. This is an optional attachment." under "Tax Details"
    Then Show "Taxpayer ID Number (TIN)" tooltip "Taxpayer ID Number (TIN) as issued by Bureau of Internal Revenue and is usually 12 numeric characters with 3 hyphens.Eg 999-999-999-999. This is an optional field." under "Tax Details"
    Then Show "Tax Registration Document" tooltip "Attach your Tax Registration Document issued by Bureau of Internal Revenue in the below mentioned formats. This is an optional attachment." under "Tax Details"
    ...
    Then Verify "Stock Corporation" is listed in "Business Type" dropdown under "Tax Details"
    ...
    ####Flag
    Then Verify "Philippines" flag Phone Number
    And Verify "Philippines" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+63 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+63 1234567890"
    ...
    ###Document uploads
    Then Scroll to view "Notice of Registration" field
    Then Click "Upload Notice of Registration" button
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    Then Show attached document under "Notice of Registration" "samplePDF.pdf"
    Then Click "Upload Notice of Registration" button
    Then Upload "PNG" under "Replace Document"
    Then Click on the Confirm button.
    Then Show attached document under "Notice of Registration" "samplePNG.png"
    Then Click "Upload Notice of Registration" button
    Then Upload "JPG" under "Replace Document"
    Then Click on the Confirm button.
    Then Show attached document under "Notice of Registration" "sampleJPG.jpg"
    Then Click "Upload Notice of Registration" button
    Then Upload "JPEG" under "Replace Document"
    Then Click on the Confirm button.
    Then Show attached document under "Notice of Registration" "sampleJPEG.jpeg"
    Then Click "Upload Notice of Registration" button
    ...
    Then Verify "Philippines" is listed in "Country/Region" dropdown
    Then Select "Philippines" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+63 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+63 1234567000"
    ###Required Error
    ...
    @Smoke @PhilippinesLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Philippines and with questionnaire
    Then Enter data in Email Address field
    ...
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    And Select "Corporation" value from Business type dropdown
    And Enter number "1546457547455" in "Phone Number" in corporation details
    #Then Scroll to the top of the page
    And Enter number "1435345645645" in "Fax Number" in corporation details
 ...
 @Smoke @PhilippinesLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Philippines and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @PhilippinesLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Philippines and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @PhilippinesLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Philippines for existing supplier
    When Enter Philippines Supplier Email in Email Address field
    ...
    Then Select "Philippines" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Philippines"
    Then Select "Philippine Peso (PHP)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Philippines"
    ...
    Then Enter value for Bank Branch Name "Bank of Philippines"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Select "Abra" in "Province/Region" dropdown
  ...
  @Smoke @PhilippinesLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Factoring Company Account with valid data for Country Philippines for existing supplier
    When Enter Philippines Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Philippines" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Select "Abra" in "Province/Region" dropdown under Factoring Company Address
