Feature: El Salvador Localisation

   #El SalvadorLocalisation
    Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @ElSalvadorLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is El Salvador with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "El Salvador" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @ElSalvadorLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select El Salvador from the dropdown
    Then Select "El Salvador" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "El Salvador" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "El Salvador" supplier registration
    Then Enter "TestCity" in "Locality" field after "El Salvador" supplier registration
    Then Enter "123456" in "Postal Code" field after "El Salvador" supplier registration
    Then Select "La Paz" in "Department" dropdown
  ...
  @Smoke @ElSalvadorLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is El Salvador and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select El Salvador from teh dropdown
    Then Select "El Salvador" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "El Salvador" is Pre populated with country
    ###Labels
    ...
    Then Show "Company Registration Number" tooltip " Company Registration Number which is  issued by the Registry of Commerce Office in the National Registry Center and it is minimum 4 to maximum 20 alphanumeric characters. This is an optional field. " under "Tax Details"
    Then Show "Company Registration Document" tooltip " Attach your Business Registration Document issued by the Registry of Commerce Office in the National Registry Center in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    Then Show "Tax Identification Number" tooltip " Tax/VAT Registry Number usually called as NIT issued by Ministry of Finance and is of 7 digits. This is a mandatory field. " under "Tax Details"
    ...
    ###Business types
    Then Verify "Foreign Branch Office" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "Public Limited Company" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Scroll to view "Phone Number" field
    #Then Verify "El Salvador" flag in Phone Number field
    #And Verify "El Salvador" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+503 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+503 323213123555"
    ...
    Then Verify "El Salvador" is listed in "Country/Region" dropdown
    Then Select "El Salvador" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+503 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+503 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Show error message "Required" for "Department" field
    Then Enter "1234" in "PO Box" field
    Then Enter 79 digit alpha numeric data in "Address Line 1" field
    ...
    Then Enter "La Paz" in "Locality" field
    Then Select "La Paz" in "Department" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @ElSalvadorLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is ElSalvador and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @ElSalvadorLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is El Salvador with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @ElSalvadorLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is El Salvador with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @ElSalvadorLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country El Salvador for existing supplier
    ...
    Then Select "El Salvador" in "Country/Region" dropdown
    Then Enter "El Salvador Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of El Salvador"
    Then Select "US Dollar (USD)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "El Salvador"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of El Salvador"
  ...
  @Smoke @ElSalvadorLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country El Salvador for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "El Salvador" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "La Paz" in "Locality" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "La Paz" in "Department" dropdown section
  ...
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is of 20 digits. This is a mandatory field." in add bank account page
    And Verify "Bank Key" tooltip of "Bank Identification Number associated with the bank which is usually 4 digits. This is a mandatory field." in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 28 alphanumeric characters.Example:SV62CENR00000000000000700025.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    ...
    And Verify "Department" tooltip of "Name of the Department at which it is located. This is a mandatory field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Department" tooltip of "Name of the Department at which it is located. This is a mandatory field." in add bank account Factoring Company Address section
