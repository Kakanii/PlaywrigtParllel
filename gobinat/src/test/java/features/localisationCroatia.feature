Feature: Croatia Localisation
  ...
  @Smoke @CroatiaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Croatia with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Croatia from the dropdown
    Then Select "Croatia" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @CroatiaLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Croatia" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Croatia" supplier registration
    Then Enter "TestCity" in "City" field after "Croatia" supplier registration
    Then Enter "12345" in "Postal Code" field after "Croatia" supplier registration
  ...
  @Smoke @CroatiaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Croatia and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Croatia" is Pre populated with country
    ###Labels
    ...
    Then Show "EU VAT Registration Number" tooltip "EU VAT Registration Number as issued by the Croatia Tax office and in the following format HR12345678901. This is a  mandatory field." under "Tax Details"
    Then Show "EU VAT Registration Document" tooltip "Attach your EU VAT Registration Document issued by the Croatia Tax office in the below mentioned formats. This is a mandatory attachment." under "Tax Details"
    Then Show "VAT Registration Number" tooltip "VAT Registration Number as issued by the Estonia Tax office and is usually 11 digits. This is an optional field." under "Tax Details"
    Then Show "VAT Registration Document" tooltip "Attach your VAT Registration Document issued by the Croatia Tax office in the below mentioned formats. This is an optional attachment." under "Tax Details"
    ...
    Then Verify "Economic Interest Association" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Simple Limited company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    ####Flag
    Then Verify "Croatia" flag Phone Number
    And Verify "Croatia" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+385 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+385 1234567890"
    ...
    Then Verify "Croatia" is listed in "Country/Region" dropdown
    ...
    Then Show "County/Region" Label
    Then Show "County/Region" Dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+385 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+385 1234567000"
    ###Required Error
    ...
    @Smoke @CroatiaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Croatia and with questionnaire
    Then Enter data in Email Address field
  ...
  @Smoke @CroatiaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Croatia and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @CroatiaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Croatia and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @CroatiaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Croatia for existing supplier
    ...
    Then Select "Croatia" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Croatia"
    Then Select "Croatian kuna (HRK)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Croatia"
    ...
    And Wait for 2 seconds
    And Enter value for Bank Key "1342567"
    ...
    Then Enter value for Bank Branch Name "Bank of Croatia"
  ...
  @Smoke @CroatiaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Factoring Company Account with valid data for Country Croatia for existing supplier
    When Enter Croatia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Croatia" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Select "Istria" in "County/Region" dropdown on Factoring Company Address
    ...
    @Smoke @CroatiaLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier with Crotia tax country registration process from maildrop
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
