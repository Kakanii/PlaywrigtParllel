Feature: Dominican Republic Localisation

  #DominicanRepublicLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @DominicanRepublicLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Dominican Republic with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select DominicanRepublic from the dropdown
    Then Select "Dominican Republic" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @DominicanRepublicLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Dominican Republic" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Dominican Republic" supplier registration
    Then Enter "TestCity" in "City" field after "Dominican Republic" supplier registration
    Then Enter "12345" in "Postal Code" field after "Dominican Republic" supplier registration
    Then Select "Azua" in "Province" dropdown
  ...
  @Smoke @DominicanRepublicLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Dominican Republic and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Dominican Republic" is Pre populated with country
    ###Labels
    ...
    Then Show "VAT Registration Number" tooltip "VAT Registration Number, also known as Registro Nacional del Contribuyente as issued by the Dominican Republic Tax Office and is usually in the range of 9 or 11 digits. This field is mandatory." under "Tax Details"
    Then Show "VAT Registration Document" tooltip "Attach your VAT Registration Document as issued by the Dominican Republic Tax Office in the below mentioned formats. This attachment is mandatory." under "Tax Details"
    ...
    Then Verify "Individual Enterprise of Limited Liability Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "Simplified Joint Stock Company" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    Then Verify "Dominican Republic" flag Phone Number
    And Verify "Dominican Republic" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+1 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+1 1234567890"
    ...
    Then Verify "Dominican Republic" is listed in "Country/Region" dropdown
    Then Select "Dominican Republic" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+1 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+1 1234567000"
    ###Required Error
    ...
    #### Zip code
    Then Enter "35356" in "Postal Code" field
    Then Verify data entered in "Postal Code" field is "35356"
    ...
    Then Select "Azua" in "Province" dropdown
    ###PO Box Zip Code
    Then Enter "34546" in "PO Box Postal Code" field
    Then Verify data entered in "PO Box Postal Code" field is "34546"
    ...
    Then Enter "54656" in "Postal Code" field
...
@Smoke @DominicanRepublicLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Dominican Republic and with questionnaire
    Then Enter data in Email Address field
    ...
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    And Select "Simplified Joint Stock Company" value from Business type dropdown
  ...
  @Smoke @DominicanRepublicLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Dominican Republic and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @DominicanRepublicLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Dominican Republic and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @DominicanRepublicLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Dominican Republic for existing supplier
    When Enter Dominican Republic Supplier Email in Email Address field
    ...
    Then Select "Dominican Republic" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Dominican Republic"
    Then Select "Dominican peso (DOP)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Dominican Republic"
    ...
    And Wait for 2 seconds
    And Enter value for Bank Key "1342"
    ...
    Then Enter value for Bank Branch Name "Bank of Dominican Republic"
  ...
  @Smoke @DominicanRepublicLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Factoring Company Account with valid data for Country Dominican Republic for existing supplier
    When Enter Dominican Republic Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Dominican Republic" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Select "Azua" in "Province" dropdown on Factoring Company Address
