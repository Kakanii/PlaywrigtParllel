Feature: Democratic Republic of the Congo Localisation

   #Democratic Republic of the Congo Localisation
    Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @DemocraticRepublicoftheCongoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is South Korea with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Democratic Republic of the Congo" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @DemocraticRepublicoftheCongoLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Democratic Republic of the Congo from the dropdown
    Then Select "Democratic Republic of the Congo" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Click on Join Now Link in the "Democratic Republic of the Congo" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Democratic Republic of the Congo" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Democratic Republic of the Congo" supplier registration
    Then Enter "TestCity" in "City" field after "Democratic Republic of the Congo" supplier registration
    #Then Enter "12345678" in "Postal Code" field after "Democratic Republic of the Congo" supplier registration
    Then Select "Kasai" in "Province" dropdown
  ...
  @Smoke @DemocraticRepublicoftheCongoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Democratic Republic of the Congo and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Democratic Republic of the Congo from teh dropdown
    Then Select "Democratic Republic of the Congo" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Democratic Republic of the Congo" is Pre populated with country
    ###Labels
    ...
    Then Show "Company Registration Number" tooltip " Central Business Registration Number (CVR number) or Company Number issued by the commercial registrar at the Clerk’s Office of the Court which is minimum 3 to maximum 20 alphanumeric characters. This is Optional field " under "Tax Details"
    Then Show "Company Registration Document" tooltip " Attach your Business Registration Document post registration with commercial registrar at the Clerk’s Office of the Court. This is Optional attachment. " under "Tax Details"
    Then Show "Tax Registration Number" tooltip " CIT Number which is also used as Tax or VAT Registration Number. It is usually 11 alphanumeric characters.It has to be registered with Tax Authority,( Eg: Z123456789A). This is Mandatory field " under "Tax Details"
    Then Show "Tax Registration Document" tooltip " Attach your company's Certificate of Tax Registration issued by the Tax authority in DR-Congo in the below mentioned formats.This is Mandatory attachment. " under "Tax Details"
    ...
    Then Verify "Free Zone Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Simplified Joint Stock Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    #Then Verify "Democratic Republic of the Congo" flag in Phone Number field
    #And Verify "Democratic Republic of the Congo" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+243 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+243 323213123555"
    ...
    Then Verify "Democratic Republic of the Congo" is listed in "Country/Region" dropdown
    Then Select "Democratic Republic of the Congo" in "Country/Region" dropdown
    ...
    # Flag
    #Then Verify "Democratic Republic of the Congo" flag in Primary Phone field
    #And Verify "Democratic Republic of the Congo" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+243 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+243 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Show error message "Required" for "Province" field
    Then Enter "1234" in "PO Box" field
    Then Enter 79 digit alpha numeric data in "Address Line 1" field
    ...
    #Then Enter "12345" in "PO Box Postal Code" field
    #Then Enter "12345" in "Postal Code" field
    Then Enter "Kasai" in "City" field
    Then Select "Kasai" in "Province" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @DemocraticRepublicoftheCongoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Democratic Republic of the Congo and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Verify "South Korea" flag in Phone Number field
    #And Verify "South Korea" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+243 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
  ...
  @Smoke @DemocraticRepublicoftheCongoLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is South Korea with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @DemocraticRepublicoftheCongoLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Democratic Republic of the Congo with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @DemocraticRepublicoftheCongoLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Democratic Republic of the Congo for existing supplier
    ...
    Then Select "Democratic Republic of the Congo" in "Country/Region" dropdown
    Then Enter "Democratic Republic of the Congo Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Democratic Republic of the Congo"
    Then Select "Congolese Franc (CDF)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Democratic Republic of the Congo"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Democratic Republic of the Congo"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City "Jeju"
    Then Select "Kasai" in "Province" dropdown
  ...
  @Smoke @DemocraticRepublicoftheCongoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Democratic Republic of the Congo for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Democratic Republic of the Congo" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Kasai" in "City" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Kasai" in "Province" dropdown section
  ...
  @Regression @DemocraticRepublicoftheCongoLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually minimum 4 to maximum 23 digits. This field is mandatory." in add bank account page
    And Verify "Bank Key" tooltip of "Bank Account Code (Identifier) associated with the bank .It is usually called as Routing code or Bank/Branch Code. This field is mandatory." in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 27 alphanumeric characters.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    ...
    And Verify "Province" tooltip of "Name the Province at which it is located.This is mandatory field" in add bank account page
    #And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 5 digits or 6 digits. This is a mandatory field." in add bank account page
    And Verify "PO Box" tooltip of "The Post Office Box of your company known as Boite Postale (B.P) which is usually 0 to 12 alphanumeric characters.This field is optional" in add bank account page
    #Then Verify "PO Box Postal Code" tooltip of "The Post Office Box of your company which is usually 0 to 12 digits. This is an optional field." in add bank account page
  ...
  @Regression @SouthKoreaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Province" tooltip of "Name the Province at which it is located.This is mandatory field" in add bank account Factoring Company Address section
    #And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 5 digits or 6 digits. This is a mandatory field." in add bank account Factoring Company Address section
    And Verify "PO Box" tooltip of "The Post Office Box of your company known as Boite Postale (B.P) which is usually 0 to 12 alphanumeric characters.This field is optional" in add bank account Factoring Company Address section
    #And Verify "PO Box Postal Code" tooltip of "The Post Office Box of your company which is usually 0 to 12 digits. This is an optional field." in add bank account Factoring Company Address section
