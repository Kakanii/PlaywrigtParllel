Feature: South Korea Localisation
  ...
  @Smoke @SouthKoreaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is South Korea with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    ...
    Then Select "South Korea" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @SouthKoreaLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select South Korea from the dropdown
    Then Select "South Korea" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Click on Join Now Link in the "South Korea" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "South Korea" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "South Korea" supplier registration
    Then Enter "TestCity" in "City" field after "South Korea" supplier registration
    Then Enter "12345678" in "Postal Code" field after "South Korea" supplier registration
    Then Select "Jeju" in "Region" dropdown
  ...
  @Smoke @SouthKoreaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is South Korea and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select South Korea from teh dropdown
    Then Select "South Korea" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "South Korea" is Pre populated with country
    ###Labels
    ...
    Then Show "Company Registration Number" tooltip " Company Registration Number issued by head of a District Tax Office respective jurisdiction and is usually of 10 digits. This is an optional field. " under "Tax Details"
    Then Show "Company Registration Document" tooltip " Attach your Company's Registration Document issued by District Tax Office in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    Then Show "Tax Registration Number" tooltip " Tax/VAT Registration Number as issued by National Tax Service/Ministry of Interior and is usually 10 or 13 digits. This is a mandatory field. " under "Tax Details"
    Then Show "Tax Registration Document" tooltip " Attach your Vat/Tax Registration Document as issued by National Tax Service/Ministry of Interior in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+82 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+82 323213123555"
    ...
    Then Verify "South Korea" is listed in "Country/Region" dropdown
    Then Select "South Korea" in "Country/Region" dropdown
    ...
    # Flag
    #Then Verify "South Korea" flag in Primary Phone field
    #And Verify "South Korea" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+82 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+82 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
  ...
  @Smoke @SouthKoreaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is South Korea and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @SouthKoreaLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is South Korea with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @SouthKoreaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country South Korea for existing supplier
    ...
    Then Select "South Korea" in "Country/Region" dropdown
    Then Enter "South Korea Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of South Korea"
    Then Select "South Korean Won (KRW)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "South Korea"
    And Wait for 2 seconds
    Then Enter input data in "Account Number" field
    Then Enter input data in "Bank Number" field
    ...
    Then Enter value for Bank Branch Name "Bank of South Korea"
  ...
  @Smoke @SouthKoreaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country South Korea for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "South Korea" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Jeju" in "City" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Jeju" in "Region" dropdown section
  ...
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually in the range of 11 to 16 alphanumeric characters. This is an optional field." in add bank account page
    And Verify "Bank Number" tooltip of "Bank Number associated with the bank and is usually 2 digits or 7 digits. This is an optional field." in add bank account page
    ...
    And Verify "Region" tooltip of "Name of the region at which it is located. This is a mandatory field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Region" tooltip of "Name of the region at which it is located. This is a mandatory field." in add bank account Factoring Company Address section
