Feature: Vietnam Localisation
  ...
  @Smoke @VietnamLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Vietnam with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Vietnam" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @VietnamLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Vietnam" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Vietnam" supplier registration
    Then Enter "TestCity" in "City" field after "Vietnam" supplier registration
    Then Enter "12345" in "Postal Code" field after "Vietnam" supplier registration
    Then Select "An Giang" in "Province/Region" dropdown
  ...
  @Smoke @VietnamLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Vietnam and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Vietnam" is Pre populated with country
    ###Labels
    ...
    Then Show "VAT Registration Number" tooltip " VAT Registration Number as issued by the Vitetnam Tax Office and is usually 10 or 13 digits. This field is mandatory. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your VAT Registration Document as issued by the Vitetnam Tax Office in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    ...
    Then Verify "Incorporated Partnership" is listed in "Business Type" dropdown under "Tax Details"
    ...
    #Then Verify "Vietnam" flag in Phone Number field
    #And Verify "Vietnam" flag in Fax Number field
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+84 323213123555"
    Then Enter phone number "3232131235" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+84 3232131235"
    ...
    Then Verify "Vietnam" is listed in "Country/Region" dropdown
    Then Select "Vietnam" in "Country/Region" dropdown
    ...
    # Flag
    #Then Verify "Vietnam" flag in Primary Phone field
    #And Verify "Vietnam" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+84 42324242342"
    Then Enter phone number "42324242342" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+84 42324242342"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Enter "12345" in "PO Box Postal Code" field
    Then Enter "12345" in "Postal Code" field
    Then Enter "Vietnam" in "City" field
    Then Select "An Giang" in "Province/Region" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @VietnamLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Vietnam  and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Verify phone number "Secondary Phone" is entered in accepted format "+84 42324242344"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    Then Enter 150 digit alpha numeric data in "Address Line 1" field
  ...
  @Smoke @VietnamLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Vietnam with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Enter random number in "Company Registration Number" field under "Tax Details"
    Then Enter random number in "VAT Registration Number" field under "Tax Details"
    Then Enter random Tax Identification Number in "VAT Registration Number" field under "Tax Details"
    #Then Enter random Tax Identification Number in "Tax Identification Number" field under "Tax Details"
    #Then Enter random Number in "VAT Registration Number" field under "Tax Details"
    #Then Enter random EU VAT number "PL" in "EU VAT Registration Number"
    ###Document uploads
  ...
  @Smoke @VietnamLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Vietnam with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @VietnamLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Vietnam for existing supplier
    ...
    Then Select "Vietnam" in "Country/Region" dropdown
    Then Enter "Vietnam Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Vietnam"
    Then Select "Vietnamese dong (VND)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Vietnam"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Vietnam"
  ...
  @Smoke @VietnamLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Vietnam for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Vietnam" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Wait for 5 seconds
    Then Select "An Giang" in "Province/Region" dropdown section
  ...
  @Regression @VietnamLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually in the range of 4 to 18 alphanumeric characters. This is a mandatory field" in add bank account page
    And Verify "Bank Key" tooltip of "Bank Account Code (Identifier), also known as CITAD number associated with the bank which is usually 8 digits. This is a mandatory field" in add bank account page
