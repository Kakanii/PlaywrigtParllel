Feature: Israel Localisation
  ...
  @Smoke @IsraelLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Israel with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Israel" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @IsraelLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Click on Join Now Link in the "Israel" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Israel" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Israel" supplier registration
    Then Enter "TestCity" in "City" field after "Israel" supplier registration
    Then Enter "1234567" in "Postal Code" field after "Israel" supplier registration
    Then Select "Central District" in "District" dropdown
  ...
  @Smoke @IsraelLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Israel and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Israel from teh dropdown
    Then Select "Israel" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Israel" is Pre populated with country
    ###Labels
    ...
    Then Show "YES" radio button "1" is displyed under "Does your company have a withholding exemption?"
    Then Show "NO" radio button "2" is displyed under "Does your company have a withholding exemption?"
    And Select No for withholding exemption
    Then Show "YES" radio button "3" is displyed under "Diversity"
    Then Show "NO" radio button "4" is displyed under "Diversity"
    ...
    Then Show "YES" radio button "5" is displyed under "Additional Information"
    Then Show "NO" radio button "6" is displyed under "Additional Information"
    ###input field status
    ...
    Then Show "Company Registration Number" tooltip " Company Number which is  issued by the The Registrar of Companies which is usually of 9 digits. This is an Optional field " under "Tax Details"
    Then Show "Company Registration Document" tooltip " Attach your Certificate of Incorporation issued by the The Registrar of Companies in the below mentioned formats. This is an Optional attachment. " under "Tax Details"
     Then Show "Tax Registration Number" tooltip " Tax Identification Number (TIN) is a unique identifier issued by Israel Tax Authority which is usually 9 to 11 numeric digit characters. For example, 123-456-789. This is a mandatory field.  " under "Tax Details"
    Then Show "Tax Registration Document" tooltip " Attach your company's Certificate of Tax Registration issued by the Israel Tax Authority. This is mandatory attachment. " under "Tax Details"
    Then Show "VAT Registration Number" tooltip " VAT registration Number is a unique identifier issued by Israeli Tax Authority which is usually 9 to 11 numeric digit characters. For example, 123-456-789. This is an optional field. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your company's Certificate of VAT Registration issued by the Israeli Tax Authority. This is an optional attachment. " under "Tax Details"
    ...
    Then Verify "Public Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Self Employed" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Other" is listed in "Business Type" dropdown under "Tax Details"
    Then Select "Cooperative" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Scroll to view "Phone Number" field
    #Then Verify "Israel" flag in Phone Number field
    #And Verify "Israel" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+972 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+972 323213123555"
    ...
    Then Enter "      " in "Tax Registration Number" field under "Tax Details"
    Then Verify no data is entered in "Tax Registration Number" field under "Tax Details"
    ############When Enter VAT Registration Number for Lithuania  under Tax Details
    ...
    #Then Enter random number in "Tax Registration Number" field under "Tax Details"
    #Then Enter data VAT Registration Number under Tax Details
    Then Enter 9 numbers followed by "" in "Tax Registration Number" field under "Tax Details"
    ...
    Then Verify "Israel" is listed in "Country/Region" dropdown
    Then Select "Israel" in "Country/Region" dropdown
    ...
    # Flag
    #Then Verify "Honduras" flag in Primary Phone field
    #And Verify "Honduras" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+972 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+972 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Verify data entered in "Postal Code" field is "1234567"
    ...
    Then Verify no data is entered in "Postal Code" field
    ###PO Box
    Then Enter "1234567" in "PO Box" field
    ###PO Box Postal Code
    Then Enter "1234567" in "PO Box Postal Code" field
    Then Verify data entered in "PO Box Postal Code" field is "1234567"
    ...
    Then Enter "1234567" in "PO Box Postal Code" field
    Then Enter "1234567" in "Postal Code" field
    Then Enter "Central District" in "City" field
    Then Select "Central District" in "District" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @IsraelLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Israel and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    #Then click on the radio button "8" in additional information
    Then Click "No" radio under "Are you publicly traded on a stock exchange?"
    #Then Click "No" radio under "Does your company have a withholding exemption?"
    #And Select No for withholding exemption
    Then Enter the value "5" at Number of Full Time Employees on the Basic information page
    Then Enter the value "5" at Number of Temporary and Contracted Employees on the Basic information page
    Then Select "11111 - Soybean Farming T" from the "NAICS" dropdown
  ...
  @Smoke @IsraelLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Israel with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @IsraelLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Israel with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Verify "Serbia" flag in Phone Number field
    #And Verify "Serbia" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+972 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    ...
    #Then Enter data EU VAT Registration Number under Tax Details
    Then Enter random number in "Company Registration Number" field under "Tax Details"
    Then Enter 9 numbers followed by "" in "VAT Registration Number" field under "Tax Details"
    #Then Enter random number in "Tax Registration Number" field under "Tax Details"
    #Then Enter data VAT Registration Number under Tax Details
    Then Enter 9 numbers followed by "" in "Tax Registration Number" field under "Tax Details"
    #Then Enter "V" followed by "T" and 7 numbers in "VAT Registration Number" field under "Tax Details"
  ...
  @Smoke @IsraelLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Israel for existing supplier
    ...
    Then Select "Israel" in "Country/Region" dropdown
    Then Enter "Israel Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Israel"
    Then Select "Israeli new shekel (ILS)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Israel"
    And Wait for 2 seconds
    Then Enter input data in "Account Number" field
    Then Enter input data in "Bank Code" field
    Then Enter input data in "Branch Code" field
    #Then Enter value for Bank Account Number "229963086212321"
    Then Enter input data in "SWIFT Code" field
    #And Enter value for Bank Key "SN12467432"
    #Then Enter input data in "Control key" field
    #Then Enter "12332" data in "Control key" field
    #Then Enter "123321" data in "AZIPS Code" field
    And Wait for 2 seconds
    #And Enter value for Bank Swift Code "FDGFDHQK"
    And Enter value for IBAN "KZ4636353745865838373712345678"
    ...
    Then Enter value for Bank Branch Name "Bank of Israel"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City " Bor"
    Then Select "Central District" in "District" dropdown
    Then Enter value for Postal Code "2756576"
    Then Enter "1234567" in "PO Box" field
    Then Enter "1234567" in "PO Box Postal Code" field
  ...
  @Smoke @IsraelLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Israel for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    And Enter value for Bank Swift Code "FDGFDHQK"
    And Enter value for IBAN "KZ4636353745865838373712345678"
    #Then Enter value for Bank Account Number "2299630862123215"
    Then Enter "Testing" in Bank Desciption
    Then Select "Bank statement" in "Account Evidence" dropdown
    Then Click "Upload" button
    Then Upload "PDF" document under Upload Document
    ...
    Then Enter value for Bank Branch Name "Bank of Israel"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City "Central District"
    Then Select "Central District" in "District" dropdown
    Then Enter "1234564" in "Postal Code" field
    Then Enter "1234565" in "PO Box" field
    Then Enter "1234566" in "PO Box Postal Code" field
    Then Enter value for Bank Contact Name "bankingcontact"
    Then Enter value for Bank Contact Number "9886543210"
    # Then Wait for 3 seconds
    Then Wait for 3 seconds
    Then Enter "IT People Corp" in "Factoring Company Name" field under "Factoring Company Info" section
    Then Select "Israel" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Central District" in "City" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Central District" in "District" dropdown section
    Then Enter "4567891" in "Postal Code" field under "Factoring Company Address" section
    Then Enter "3456482" in "PO Box" field under "Factoring Company Address" section
    Then Enter "1456244" in "PO Box Postal Code" field under "Factoring Company Address" section
    Then Wait for 3 seconds
    Then Click "Save" button 6
    Then Wait for 3 seconds
    Then Click on Not now button
  ...
  @Regression @IsraelLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Branch Code" tooltip of "Branch Code associated with the branch of the bank and is usually 3 digits which is 8th, 9th, 10th digits in IBAN. This field is mandatory." in add bank account page
    And Verify "Account Number" tooltip of "Account number of the Bank account which is minimum 4 to maximum 13 digits.This is a mandatory field." in add bank account page
    And Verify "Bank Code" tooltip of "Bank Account Code associated with the bank and is usually 3 digits which is 5th,6th,7th digits in IBAN. This field is mandatory." in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 23 alphanumeric characters.Example:IL170108000000012612345.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    ...
    And Verify "District" tooltip of "Select the appropriate district from the dropdown. This is an optional field" in add bank account page
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 7 digits. This is a mandatory field." in add bank account page
    ...
    Then Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually 7 digits. This is an optional field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    #And Verify "Bank Key" tooltip of "Bank Account Code (Identifier) associated with the bank which is usually 5 digits. This is the 5th to 9th digits of IBAN number and the field is mandatory." in add bank account page
    #And Verify "AZIPS Code" tooltip of "AZIPS code or clearing code which is usually 6 alphanumeric characters. This is a mandatory field." in add bank account page
    And Verify "SWIFT Code" tooltip of "Swift code of the Bank which is usually 8 or 11 alphanumeric characters.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 23 alphanumeric characters.Example:IL170108000000012612345.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    And Verify "Account Evidence" tooltip of "Please select a type of evidence you wish to attach" in add bank account page
    ...
    And Verify "District" tooltip of "Select the appropriate district from the dropdown. This is an optional field" in add bank account Factoring Company Address section
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 7 digits. This is a mandatory field." in add bank account Factoring Company Address section
    And Verify "PO Box" tooltip of "The Post Office Box of your company which is usually 0 to 12 alphanumeric characters. This is an optional field." in add bank account Factoring Company Address section
    And Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually 7 digits. This is an optional field." in add bank account Factoring Company Address section
