Feature: Oman Localisation
  ...
  @Smoke @OmanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Oman with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Oman from the dropdown
    Then Select "Oman" in "Supplier Country of Registration" dropdown
    ...
    @Smoke @OmanLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
   ...
   # When Click on Continue button on Login page
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Oman" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Oman" supplier registration
    Then Enter "TestCity" in "City/Town" field after "Oman" supplier registration
    Then Enter "32432" in "Postal Code" field after "Oman" supplier registration
    ...
    @Smoke @OmanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Oman and without questionnaire
    Then Enter data in Email Address field
    #When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    Then Verify Tax Country "Oman" is Pre populated with country
    ###Labels
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Company Registration Number" tooltip "The Company registration number is a unique identifier assigned to a business when it is registered with the Ministry of Commerce and Industry. This is a mandatory field with 7 digits." under "Tax Details"
    Then Show "Company Registration Document" tooltip "Upload your Company Registration document issued by the Ministry of Commerce and Industry. This attachment is Mandatory." under "Tax Details"
    Then Show "Tax Identification Number (TIN)" tooltip "TIN is issued by the Ministry of Commerce and Industry. This is a mandatory field with 7 to 12 digits." under "Tax Details"
    Then Show "Tax Registration Document" tooltip "Attach your company's Certificate of Tax Registration issued by the DIRECTORATE GENERAL OF TAXES (DGI). This is a mandatory attachment." under "Tax Details"
    ...
    ###Business types
    Then Verify "Join Stock Company (SAOC)" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Professional Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    ####Flag
    Then Verify "Oman" flag Phone Number
    And Verify "Oman" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+968 (123) 456-7890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+968 (123) 456-7890"
    ...
    Then Wait for 3 seconds
    Then Enter data Company Registration Number under "Tax Details" field for Oman country
    Then Wait for 3 seconds
    ...
    Then Navigate back to supplier
    #Rule Without criteria
    Then Click on "Rule without criteria" in Approval Source "2"
    Then Wait for 5 seconds
    Then Click on the Approve button
    Then Enter the Notes
    Then Enter the Notes under the Notes Box
    ...
    @Smoke @OmanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Oman and with questionnaire
    Then Enter data in Email Address field
    #When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    Then Wait for 3 seconds
    Then Enter data Company Registration Number under "Tax Details" field Oman country
    Then Wait for 3 seconds
    Then Enter data Tax Identification Number under "Tax Details" field for Oman country
   ...
   #Rule Without criteria
    ...
    #@Smoke @OmanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Oman and without questionnaire with Diversity
    Then Enter data in Email Address field
    #When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    @Smoke @OmanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Oman and without questionnaire with Additional Information
    Then Enter data in Email Address field
    #When Click on Continue button on Login page
    Then Enter data in Password field
    When Click on Sign In button on Login
    ...
    @Smoke @OmanLocalisation @Localisation @Supplier @TYSFunctionality
  Scenario: Add Company Account with valid data for Country Zambia for existing supplier
   Then Enter data in Email Address field
    ...
    Then Select "Oman" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Oman"
    Then Select "Omani Rial (OMR)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Oman"
    ...
    Then Enter value for Bank Branch Name "Bank of Oman"
  ...
  Scenario: Add Factoring Company Account with valid data for Country Zambia for existing supplier
   Then Enter data in Email Address field
    ...
    Then Select "Oman" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
