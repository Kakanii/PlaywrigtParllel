Feature: Turkey Localisation
  ...
  @Smoke @TurkeyLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Turkey with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Turkey" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @TurkeyLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Click on Join Now Link in the "Turkey" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Turkey" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Turkey" supplier registration
    Then Enter "TestCity" in "City" field after "Turkey" supplier registration
    Then Enter "12345" in "Postal Code" field after "Turkey" supplier registration
    Then Select "Bolu" in "Province/Region" dropdown
  ...
  @Smoke @TurkeyLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Turkey and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Turkey from teh dropdown
    Then Select "Turkey" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Turkey" is Pre populated with country
    ###Labels
    ...
    Then Show "Tax Number (VD)" label under "Tax Details"
    ...
    Then Show "Tax Number (VD)" input text field under "Tax Details"
    ...
    Then Verify "Tax Number (VD)" input text field enabled under "Tax Details"
    ...
    Then Show "Tax Number (VD)" tooltip " Tax Number (VD) as issued the Turkey Tax office and is usually 10 or 11 digits. This is a mandatory field. " under "Tax Details"
    Then Show "Tax Document" tooltip " Attach your Tax Document issued by Turkey Tax office in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    ...
    Then Show error message "Required" under "Tax Number (VD)" field under "Tax Details"
    ...
    ###Business types
    Then Verify " Collective Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify " Cooperative Association" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "Collective Company" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Scroll to view "Phone Number" field
    #Then Verify "Turkey" flag in Phone Number field
    #And Verify "Turkey" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+90 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+90 323213123555"
    ...
    Then Enter "      " in "Company Registration Number" field under "Tax Details"
    Then Verify no data is entered in "Company Registration Number" field under "Tax Details"
    #####Tax Number (VD)- Input type
    Then Enter "@#$%&" in "Tax Number (VD)" field under "Tax Details"
    Then Verify no data is entered in "Tax Number (VD)" field under "Tax Details"
    Then Enter "      " in "Tax Number (VD)" field under "Tax Details"
    Then Verify no data is entered in "Tax Number (VD)" field under "Tax Details"
    ############When Enter Tax Number (VD)  under Tax Details
    ...
    Then Enter random number in "Tax Number (VD)" field under "Tax Details"
    ...
    Then Verify "Turkey" is listed in "Country/Region" dropdown
    Then Select "Turkey" in "Country/Region" dropdown
    ...
    # Flag
    #Then Verify "Turkey" flag in Primary Phone field
    #And Verify "Turkey" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+90 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+90 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Enter "Van" in "City" field
    Then Select "Van" in "Province/Region" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @TurkeyLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Turkey and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @TurkeyLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Turkey with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @TurkeyLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Turkey with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @TurkeyLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Turkey for existing supplier
    ...
    Then Select "Turkey" in "Country/Region" dropdown
    Then Enter "Turkey Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Turkey"
    Then Select "Turkish lira (TRY)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Turkey"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Slovakia"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City "Van"
    Then Select "Van" in "Province/Region" dropdown
  ...
  @Smoke @TurkeyLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Turkey for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Turkey" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Van" in "City" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Van" in "Province/Region" dropdown section
  ...
  @Regression @TurkeyLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account Number of the Bank account which is the last 16 digits of the IBAN number. If, in case, the account number is less than 16 digits, fill it with preceding 0’s. This field is mandatory." in add bank account page
    And Verify "Bank Key" tooltip of "Bank Key associated with the bank and is usually 4 digits. This is the 6th to 9th digits of IBAN and the field is mandatory." in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 26 alphanumeric characters.Example:TR330006100519786457841326.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    ...
    And Verify "Province/Region" tooltip of "Select the appropriate province/region from the dropdown. This is a mandatory field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Province/Region" tooltip of "Select the appropriate province/region from the dropdown. This is a mandatory field." in add bank account Factoring Company Address section
