Feature: Slovakia Localisation

  #SlovakiaLocalisation
    Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @SlovakiaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Slovakia with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Slovakia" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @SlovakiaLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Slovakia from the dropdown
    Then Select "Slovakia" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Click on Join Now Link in the "Slovakia" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Slovakia" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Slovakia" supplier registration
    Then Enter "TestCity" in "City" field after "Slovakia" supplier registration
    Then Enter "12345" in "Postal Code" field after "Slovakia" supplier registration
    Then Select "Nitra" in "Region" dropdown
  ...
  @Smoke @SlovakiaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Slovakia and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Slovakia from teh dropdown
    Then Select "Slovakia" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    #maildrop
    Then Click on the email with subject "Trust Your Supplier" from maildrop
    Then Click on Join Now Link in the "Puerto Rico" supplier Email from maildrop
    Then Wait for 3 seconds
    Then Switch to "new TYS" tab
    #Verify Company page on registration
    #Vrify lables are displayed as expected
    ...
    Then Verify Tax Country "Slovakia" is Pre populated with country
    ###Labels
    ...
    Then Show "EU VAT Registration Number" tooltip " EU VAT registration Number as issued by the Slovakia Tax office and is usually 12 alphanumeric characters in the format SK1234567890.  This is mandatory field. " under "Tax Details"
    Then Show "EU VAT Registration Document" tooltip "Attach your EU VAT Registration Document issued by the Slovakia Tax office in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    Then Show "VAT Registration Number" tooltip " VAT Registration Number as issued by the Slovakia Tax office and is usually in the range of 8 or 10 digits. This is an optional field. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your VAT Registration Document issued by the Slovakia Tax office in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    ...
    ###Business types
    Then Verify "A General Partnership" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "A General Partnership" value from Business type dropdown
    #Date calandar
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+421 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+421 323213123555"
    ...
    Then Enter "S" followed by "K" and 10 numbers in "EU VAT Registration Number" field under "Tax Details"
    ...
    Then Verify "Slovakia" is listed in "Country/Region" dropdown
    Then Select "Slovakia" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+421 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+421 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Enter "Nitra" in "City" field
    Then Select "Nitra" in "Region" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @SlovakiaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Slovakia and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @SlovakiaLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Slovakia with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @SlovakiaLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Slovakia with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @SlovakiaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Slovakia for existing supplier
    ...
    Then Select "Slovakia" in "Country/Region" dropdown
    Then Enter "Slovakia Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Slovakia"
    Then Select "Slovak Koruna (SKK)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Slovakia"
    And Wait for 2 seconds
    ...
    Then Enter value for City "Nitra"
    Then Select "Nitra" in "Region" dropdown
  ...
  @Smoke @SlovakiaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Slovakia for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Slovakia" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Nitra" in "City" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Nitra" in "Region" dropdown section
  ...
  @Regression @SlovakiaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the bank account which is usually 10 digits. This field is mandatory, please use preceding zeroes in case account number is less than 10 digits." in add bank account page
    And Verify "Bank Key" tooltip of "Bank Key associated with the bank and is usually 4 digits. This is the 5th to 8th digits of IBAN and the field is mandatory." in add bank account page
