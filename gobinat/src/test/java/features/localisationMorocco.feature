Feature: Morocco Localisation
  ...
  @Smoke @MoroccoLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Morocco with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Morocco" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @MoroccoLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Morocco" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Morocco" supplier registration
    Then Enter "TestCity" in "City" field after "Morocco" supplier registration
    Then Enter "12345" in "Postal Code" field after "Morocco" supplier registration
    Then Select "Berkane" in "Regions/Division (provinces/prefectures)" dropdown
  ...
  @Smoke @MoroccoLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Morocco and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Morocco" is Pre populated with country
    ###Labels
    ...
    Then Show "IF(Identification Fiscal) Number" label under "Tax Details"
    ...
    Then Show "IF(Identification Fiscal) Number" input text field under "Tax Details"
    ...
    Then Verify "IF(Identification Fiscal) Number" input text field enabled under "Tax Details"
    ...
    Then Show "IF(Identification Fiscal) Number" tooltip " IF(Identification Fiscal) Number as issued by the Morocco Tax office and is usually 7 or 8 digits. This is an optional field  " under "Tax Details"
    Then Show "Tax Document" tooltip " Attach your Tax Document issued by the Morocco Tax office in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    ...
    Then Verify "Joint-Ventures" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Limited Partnerships with Shares" is listed in "Business Type" dropdown under "Tax Details"
    ...
    #Then Verify "Morocco" flag in Phone Number field
    #And Verify "Morocco" flag in Fax Number field
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+212 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+212 323213123555"
    ...
    #####VAT Registration Number - Input type
     Then Enter "@#$%&" in "IF(Identification Fiscal) Number" field under "Tax Details"
    Then Verify no data is entered in "IF(Identification Fiscal) Number" field under "Tax Details"
    Then Enter "      " in "IF(Identification Fiscal) Number" field under "Tax Details"
    Then Verify no data is entered in "IF(Identification Fiscal) Number" field under "Tax Details"
    Then Wait for 3 seconds
    ...
    Then Enter random number in "IF(Identification Fiscal) Number" field under "Tax Details"
    ...
    Then Verify "Morocco" is listed in "Country/Region" dropdown
    ...
    Then Show "Regions/Division (provinces/prefectures)" Label
    Then Show "Regions/Division (provinces/prefectures)" Dropdown
    ...
    Then Verify "Regions/Division (provinces/prefectures)" dropdown enabled
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+212 42324242342"
    Then Enter phone number "42324242342" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+212 42324242342"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Show error message "Required" for "Regions/Division (provinces/prefectures)" field
    Then Enter "12345" in "PO Box" field
    Then Enter 79 digit alpha numeric data in "Address Line 1" field
  ...
  @Smoke @MoroccoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Morocco and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Verify phone number "Secondary Phone" is entered in accepted format "+212 42324242344"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    Then Enter 150 digit alpha numeric data in "Address Line 1" field
  ...
  @Smoke @MoroccoLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Morocco with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @MoroccoLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Morocco with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @MoroccoLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Morocco for existing supplier
    ...
    Then Select "Morocco" in "Country/Region" dropdown
    Then Enter "Morocco Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Morocco"
    Then Select "Moroccan dirham (MAD)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Morocco"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Morocco"
  ...
  @Smoke @MoroccoLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Morocco for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
   ...
   Then Enter input data in "Bank Key" field
    ...
    Then Select "Morocco" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Wait for 5 seconds
    Then Select "Berkane" in "Regions/Division (provinces/prefectures)" dropdown section
  ...
  @Regression @MoroccoLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually 16 alphanumeric characters. This is a mandatory field" in add bank account page
    ...
    And Verify "City" tooltip of "Name of the city at which it is located. This is an optional field." in add bank account page
    And Verify "Regions/Division (provinces/prefectures)" tooltip of "Select the appropriate region/division (province/prefecture) from the dropdown. This is a mandatory field." in add bank account page
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 5 digits. Either provide your postal code or leave it empty if postal code is not available." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "City" tooltip of "Name of the city at which it is located. This is an optional field." in add bank account Factoring Company Address section
    And Verify "Regions/Division (provinces/prefectures)" tooltip of "Select the appropriate region/division (province/prefecture) from the dropdown. This is a mandatory field." in add bank account Factoring Company Address section
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 5 digits. Either provide your postal code or leave it empty if postal code is not available." in add bank account Factoring Company Address section
    ...
    And Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually 5 digits. This field is optional." in add bank account Factoring Company Address section
