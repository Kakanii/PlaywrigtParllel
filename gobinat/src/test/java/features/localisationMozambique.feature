Feature: Mozambique Localisation

  #MozambiqueLocalisation
    Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @MozambiqueLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Mozambique with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Mozambique" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @MozambiqueLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Mozambique from the dropdown
    Then Select "Mozambique" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Click on Join Now Link in the "Mozambique" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Mozambique" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Mozambique" supplier registration
    Then Enter "TestCity" in "City" field after "Mozambique" supplier registration
    Then Enter "1234" in "Postal Code" field after "Mozambique" supplier registration
    Then Select "Gaza" in "Province" dropdown
  ...
  @Smoke @MozambiqueLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Mozambique and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Mozambique from teh dropdown
    Then Select "Mozambique" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Enter "TestAddress2" in "Address Line 2" field after "Mozambique" supplier registration
    Then Enter "TestCity" in "City" field after "Mozambique" supplier registration
    Then Enter "123456" in "Postal Code" field after "Mozambique" supplier registration
    Then Select "Gaza" in "Province" dropdown
    Then Click "Next" button
    Then Wait for 3 seconds
    Then Select the UNSPSC codes on the Basic information page
    ...
    Then Verify Tax Country "Mozambique" is Pre populated with country
    ###Labels
    ...
    Then Show "Company Registration Number" tooltip " Company registration number which is minimum 4 to maximum 20 alphanumeric characters and is issued by the Commerical Registry.This is optional field. " under "Tax Details"
    Then Show "Company Registration Document" tooltip " Attach your Company’s Certificate of Commercial registration Document issued by the Commerical Registry in the below mentioned formats.This is optional attachment. " under "Tax Details"
    Then Show "Tax Registration Number" tooltip " Numero Unico de Identificacao Tributaria (NUIT) also referred as VAT Registration Number which is usually 9 alphanumeric characters and is issued by the Mozambique Revenue Authority. This is Mandatory field.  " under "Tax Details"
    Then Show "Tax Registration Document" tooltip " Attach your company's Certificate of Tax Registration issued by the Mozambique Revenue Authority in the below mentioned formats.This is mandatory attachment. " under "Tax Details"
    ...
    ###Business types
    Then Verify "Capital And Industry Companies" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+258 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+258 323213123555"
    ...
    Then Verify "Mozambique" is listed in "Country/Region" dropdown
    Then Select "Mozambique" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+258 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+258 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
  ...
  @Smoke @MozambiqueLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Mozambique and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @MozambiqueLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Mozambique with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @MozambiqueLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Mozambique with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @MozambiqueLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Mozambique for existing supplier
    ...
    Then Select "Mozambique" in "Country/Region" dropdown
    Then Enter "Mozambique Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Mozambique"
    Then Select "Mozambican Metical (MZN)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Mozambique"
    And Wait for 2 seconds
    ...
    Then Select "Tete" in "Province" dropdown
  ...
  @Smoke @MozambiqueLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Mozambique for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City "Tete"
    Then Select "Tete" in "Province" dropdown
    ...
    Then Select "Mozambique" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Wait for 5 seconds
    Then Select "Tete" in "Province" dropdown section
  ...
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is 21 digits. This field is mandatory." in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 25 alphanumeric characters.Example:MZ97123412341234123412341.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
