Feature: Auto Opt Out Marketing communications 

  #Marketing Communications Auto Optout
  #@BuyerMarketingCommunications @SupplierMarketingCommunications
  Background: Login as a Buyer
    Given Start the application
    When Click on Sign In button
    Then Close the hotjar window

  @Smoke @MarketingCommunicationsOptout @Supplier @CDCI @QuickSanity
  Scenario: Verify Marketing Communications Subscribe Optout by default in Supplier My Account Page
    #Open buyer page
    ...
    Then Show Subscribe in my account page "true"
  ...
  @Smoke @MarketingCommunicationsOptout @Supplier @CDCI @QuickSanity
  Scenario: Verify Marketing Communications Subscribe Opted-in in Supplier My Account Page
     #Open buyer page
    Then Enter data in Email Address field
    #Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @MarketingCommunicationsOptout @Buyer @CDCI 
  Scenario: Verify Marketing Communications Subscribe Optout by default in Buyer My Account Page
     #Open buyer page
    Then Enter data in Email Address field
    #Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @MarketingCommunicationsOptout @Buyer @CDCI
  Scenario: Verify Marketing Communications Subscribe Opted-in in Buyer My Account Page
     #Open buyer page
    Then Enter data in Email Address field
    #Then Click on Continue button on Login page
    Then Enter data in Password field
