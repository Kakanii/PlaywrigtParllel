Feature: Thailand Localisation

  #ThailandLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @ThailandLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Thailand with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Thailand from the dropdown
    Then Select "Thailand" in "Supplier Country of Registration" dropdown
    ...
    @Smoke @ThailandLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Thailand" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Thailand" supplier registration
    Then Enter "TestCity" in "City" field after "Thailand" supplier registration
    Then Enter "46347" in "Postal Code" field after "Thailand" supplier registration
    Then Select "Amnat Charoen" in "Province/Region" dropdown
    ...
    @Smoke @ThailandLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Thailand and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Thailand" is Pre populated with country
    ###Labels
    ...
    #Then Show "Thai Tax Identification Number (TIN)" label under "Tax Details"
    ...
    #Then Show "Thai Tax Identification Number (TIN)" input text field under "Tax Details"
    ...
    #Then Verify "Thai Tax Identification Number (TIN)" input text field enabled under "Tax Details"
    ...
    #Then Show "Thai Tax Identification Number (TIN)" tooltip "Thai Tax Identification Number (TIN) as issued by Revenue Department and is usually 13 digits. This is an optional field." under "Tax Details"
    #Then Show "TAX Registration Document" tooltip "Attach your TAX Registration Document issued by Revenue Department in the below mentioned formats. This is an optional attachment." under "Tax Details"
    ...
    Then Verify "Limited Companies" is listed in "Business Type" dropdown under "Tax Details"
    ...
    ####Flag
    Then Verify "Thailand" flag Phone Number
    And Verify "Thailand" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+66 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+66 1234567890"
  ...
  #Then Enter "12345678901" in "D-U-N-S Number" field under "Tax Details"
    ...
    Then Wait for 3 seconds
    Then Enter Company Registration Number under "Tax Details" field for Thailand
    ...
    Then Verify "Thailand" is listed in "Country/Region" dropdown
    Then Select "Thailand" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+66 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+66 1234567000"
    ###Required Error
    ...
    Then Select "Ang Thong" in "Province/Region" dropdown
    ###PO Box Zip Code
    ...
    Then Enter "@#$%" in "PO Box Postal Code" field
    Then Verify no data is entered in "PO Box Postal Code" field
    Then Enter "12347" in "PO Box Postal Code" field
    Then Enter "12348" in "Postal Code" field
    ...
    @Smoke @ThailandLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Thailand and with questionnaire
    Then Enter data in Email Address field
    ...
    @Smoke @ThailandLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Thailand and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  #Then Enter "12345678901" in "D-U-N-S Number" field under "Tax Details"
    ...
    @Smoke @ThailandLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Thailand and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  #Then Enter "12345678901" in "D-U-N-S Number" field under "Tax Details"
    ...
    @Smoke @ThailandLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Thailand for existing supplier
    ...
    Then Select "Thailand" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Thailand"
    Then Select "Thai Baht (THB)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Thailand"
    ...
    Then Enter value for Bank Branch Name "Bank of Thailand"
    ...
    Then Enter value for Postal Code "12378"
    ...
    @Smoke @ThailandLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Factorial Company Account with valid data for Country Thailand for existing supplier
    When Enter Thailand Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Thailand" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Enter "12388" in "Postal Code" field under "Factoring Company Address" section
    Then Select "Ang Thong" in "Province/Region" dropdown on Factoring Company Address
