Feature: Moldova Localisation
  ...
  Scenario: Verify invite a Supplier whose tax country is Moldova with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Moldova from the dropdown
    Then Select "Moldova" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @MoldovaLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Moldova" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Moldova" supplier registration
    Then Enter "TestCity" in "City" field after "Moldova" supplier registration
    Then Enter "MD-6546" in "Postal Code" field after "Moldova" supplier registration
    Then Select "Cahul" in "State" dropdown
  ...
  @Smoke @MoldovaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Moldova and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Moldova" is Pre populated with country
    ###Labels
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Company Registration Number" tooltip "Declare your Company Registration Number (The IDNO number - State Identification Number of Organization) issued by the State Registration Authority in Moldova which is usually minimum 7- maximum 13 numeric digit.  This is a mandatory field." under "Tax Details"
    ...
    Then Show "VAT Registration Number" tooltip "Declare your VAT Registration Number issued by the  Republic of Moldova which is usually 13 numeric digits. This is an optional field." under "Tax Details"
    Then Show "VAT Registration Document" tooltip "Attach your VAT Registration Document.This is an optional attachment." under "Tax Details"
    ...
    ####Flag
    Then Verify "Moldova" flag Phone Number
    And Verify "Moldova" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+373 12345678"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+373 12345678"
    ...
    Then Verify "Moldova" is listed in "Country/Region" dropdown
    Then Select "Moldova" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+373 12345678"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+373 12345670"
    ###Required Error
    ...
    #### Zip code
    Then Enter "MD-4654" in "Postal Code" field
    Then Verify data entered in "Postal Code" field is "MD-4654"
    ...
    Then Select "Cahul" in "State" dropdown
    ###PO Box Zip Code
    Then Enter "MD-4650" in "PO Box Postal Code" field
    #Then Verify data entered in "PO Box Postal Code" field is "MD-4650"
    ...
    Then Enter "@#$%" in "PO Box Postal Code" field
    Then Verify no data is entered in "PO Box Postal Code" field
    Then Enter "MD-4654" in "PO Box Postal Code" field
    Then Enter "MD-4650" in "Postal Code" field
    ...
    @Smoke @MoldovaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Moldova and with questionnaire
    Then Enter data in Email Address field
  ...
  #@Smoke @MoldovaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Moldova and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @MoldovaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Moldova and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @MoldovaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Moldova for existing supplier
    When Enter Moldova Supplier Email in Email Address field
    ...
    Then Select "Moldova" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Moldova"
    Then Select "Moldovan Leu (MDL)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Moldova"
    ...
    Then Enter value for Bank Branch Name "Bank of Moldova"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Select "Balti" in "State" dropdown
    Then Enter value for City " Tirana"
    #Then Select "Finiq" in "Municipality" dropdown
    Then Enter value for Postal Code "MD-5646"
  ...
  @Smoke @MoldovaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Factoring Company Account with valid data for Country Moldova for existing supplier
    When Enter Moldova Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Moldova" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Enter "MD-5646" in "Postal Code" field under "Factoring Company Address" section
    Then Select "Balti" in "State" dropdown on Factoring Company Address
