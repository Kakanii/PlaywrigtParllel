Feature: Mexico Localisation
  ...
  @Smoke @MexicoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Mexico with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Mexico from the dropdown
    Then Select "Mexico" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @MexicoLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Mexico" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Mexico" supplier registration
    Then Enter "TestCity" in "City" field after "Mexico" supplier registration
    Then Enter "65433" in "Postal Code" field after "Mexico" supplier registration
    Then Select "Chiapas" in "State" dropdown
  ...
  @Smoke @MexicoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Mexico and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Mexico" is Pre populated with country
    ###Labels
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Tax Identification Number" tooltip "TIN as provided by The Mexican Tax Administration Service. It is usually 12 alphanumeric characters. e.g. ARCA110860A1" under "Tax Details"
    Then Show "Tax Registration Document" tooltip "Attach your company's Certificate of Tax Registration/Copy of the RFC Cedula in the below mentioned formats." under "Tax Details"
    Then Show "Commercial Registration Number" tooltip "Please enter your Company Registration Number as issued by the Public Registry of Commerce e.g. ABC123456A12 or ABCD123456AB1. This is an optional field" under "Tax Details"
    ...
    ###Business types
    #Then Verify "Civil Enterprise" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Multi Purpose Financial Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Non-Profit Association" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Partnership" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Simplified Shares Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Stock Corporation for Investment Promotion" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Subsidiary" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "The Mexico Export Processing Zone Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    ####Flag
    Then Verify "Mexico" flag Phone Number
    And Verify "Mexico" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+52 (123) 456-7890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+52 (123) 456-7890"
    ...
    ###Document uploads
    Then Scroll to view "Tax Identification Number" field
    Then Click "Upload Tax Registration Document" button
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    #Then Show attached document under "Tax Identification Number" "samplePDF.pdf"
    #Then Click "Upload Tax Registration Document" button
    #Then Upload "PNG" under "Replace Document"
    #Then Click on the Confirm button.
    #Then Show attached document under "Tax Identification Number" "samplePNG.png"
    #Then Click "Upload Tax Registration Document" button
    #Then Upload "JPG" under "Replace Document"
    #Then Click on the Confirm button.
    #Then Show attached document under "Tax Identification Number" "sampleJPG.jpg"
    #Then Click "Upload Tax Registration Document" button
    #Then Upload "JPEG" under "Replace Document"
    #Then Click on the Confirm button.
    #Then Show attached document under "Tax Identification Number" "sampleJPEG.jpeg"
    #Then Click "Upload Tax Registration Document" button
    ...
    Then Verify "Mexico" is listed in "Country/Region" dropdown
    Then Select "Mexico" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+52 (123) 456-7890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+52 (123) 456-7000"
    ###Required Error
    ...
    @Smoke @MexicoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Mexico and with questionnaire
    Then Enter data in Email Address field
   ...
   @Smoke @MexicoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Mexico and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
   ...
   @Smoke @MexicoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Mexico and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @MexicoLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Mexico for existing supplier
    ...
    Then Select "Mexico" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Mexico"
    Then Select "Mexican Peso (MXN)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Mexico"
    ...
    And Wait for 2 seconds
    And Enter value for Bank Key "134256"
    ...
    Then Enter value for Bank Branch Name "Bank of Mexico"
    ...
    Then Enter value for Postal Code "43276"
  ...
  @Smoke @MexicoLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Factoring Company Account with valid data for Country Mexico for existing supplier
    Then Enter Mexico Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Mexico" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Enter "43435" in "Postal Code" field under "Factoring Company Address" section
    Then Select "Chiapas" in "State" dropdown on Factoring Company Address
