Feature: NewZealand Localisation

  #NewZealandLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @NewZealandLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is New Zealand with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "New Zealand" in "Supplier Country of Registration" dropdown
  ...
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "New Zealand" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "New Zealand" supplier registration
    #Then Enter "TestAddress3" in "Address Line 3" field after "NewZealand" supplier registration
    Then Enter "TestDistrict" in "District" field after "New Zealand" supplier registration
    Then Select "Auckland" in "Region" dropdown
    Then Enter "TestCity" in "City" field after "New Zealand" supplier registration
    Then Enter "23232-321" in "Postal Code" field after "New Zealand" supplier registration
    Then Enter "74546443" in "PO Box" field after "New Zealand" supplier registration
    Then Enter "4000" in "PO Box Postal Code" field after "New Zealand" supplier registration
  ...
  @Smoke @NewZealandLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Newzealand and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    #maildrop
    Then Click on the email with subject "Trust Your Supplier" from maildrop
    Then Click on Join Now Link in the "New Zealand" supplier Email from maildrop
    Then Wait for 3 seconds
    Then Switch to "new TYS" tab
    Then Verify Company tab is displyed on registration page
    Then Verify User Account tab is displyed on registration page
    ...
    Then Verify Tax Country "New Zealand" is Pre populated with country
    ###Labels
    ...
    Then Show "Goods & Services Tax (GST)" label under "Tax Details"
    Then Show "Goods & Services Tax (GST) Document/Tax Document" label under "Tax Details"
    ...
    Then Show "Goods & Services Tax (GST)" input text field under "Tax Details"
    ...
    Then Verify "Goods & Services Tax (GST)" input text field enabled under "Tax Details"
    ...
    Then Show "Goods & Services Tax (GST) Document/Tax Document" button in basic information
    ...
    Then Verify Upload "Goods & Services Tax (GST) Document/Tax Document" button clickable in basic information
    ...
    Then Show "Goods & Services Tax (GST)" tooltip "Goods & Services Tax (GST) as issued by Inland Revenue and is usually in the range of 8 to 9 digits. This is a mandatory field." under "Tax Details"
    Then Show "Goods & Services Tax (GST) Document/Tax Document" tooltip "Attach your Goods & Services Tax (GST) Document/Tax Document issued by Inland Revenue in the below mentioned formats. This is a mandatory attachment." under "Tax Details"
    ...
    Then Show error message "Required" under "Goods & Services Tax (GST)" field under "Tax Details"
    Then Show error message "Required" under "Goods & Services Tax (GST) Document/Tax Document" field under "Tax Details"
    ...
    Then Verify "Limited Liability" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Trading Trust" is listed in "Business Type" dropdown under "Tax Details"
    ...
    ####Flag
    #Then Verify "New Zealand" flag in "Phone Number" field "nz"
    #Then Verify "New Zealand" flag in "Fax Number" field "nz"
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+64 323213123555"
    Then Enter phone number "3232131235" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+64 3232131235"
    ...
    Then Verify no error message is displayed under "D-U-N-S Number" field under "Tax Details"
    #####GST Number - Input type
    Then Enter "@#$%&" in "Goods & Services Tax (GST)" field under "Tax Details"
    Then Verify no data is entered in "Goods & Services Tax (GST)" field under "Tax Details"
    Then Enter "      " in "Goods & Services Tax (GST)" field under "Tax Details"
    Then Verify no data is entered in "Goods & Services Tax (GST)" field under "Tax Details"
    Then Wait for 3 seconds
    Then Enter random company registration number in "Goods & Services Tax (GST)" field under "Tax Details"
    #Then Enter "993121208" in "Goods & Services Tax (GST)" field under "Tax Details"
    Then Wait for 5 seconds
    ###Document uploads
    Then Scroll to view "Certificate of Incorporation" field
    Then Click "Upload Goods & Services Tax (GST) Document / Tax Document" button
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    Then Scroll to view "Certificate of Incorporation" field
    Then Show attached document under "Goods & Services Tax (GST) Document/Tax Document" "samplePDF.pdf"
    Then Click "Upload Goods & Services Tax (GST) Document / Tax Document" button
    Then Upload "PNG" under "Replace Document"
    Then Click on the Confirm button.
    Then Show attached document under "Goods & Services Tax (GST) Document/Tax Document" "samplePNG.png"
    Then Click "Upload Goods & Services Tax (GST) Document / Tax Document" button
    Then Upload "JPG" under "Replace Document"
    Then Click on the Confirm button.
    Then Show attached document under "Goods & Services Tax (GST) Document/Tax Document" "sampleJPG.jpg"
    Then Click "Upload Goods & Services Tax (GST) Document / Tax Document" button
    Then Upload "JPEG" under "Replace Document"
    Then Click on the Confirm button.
    Then Show attached document under "Goods & Services Tax (GST) Document/Tax Document" "sampleJPEG.jpeg"
    Then Click "Upload Goods & Services Tax (GST) Document / Tax Document" button
    ...
    Then Verify "New Zealand" is listed in "Country/Region" dropdown
    Then Select "New Zealand" in "Country/Region" dropdown
    ...
    Then Enter "New Zealand" in "City" field
    ...
    Then Select text "New Zealand" under "IBM Country & ISO Code" for Custom Fields
    Then Wait for 3 seconds
  ...
  @Smoke @NewZealandLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is New Zealand and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @NewZealandLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is New Zealand with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is New Zealand with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    #Then Upload "PDF" file "Upload file" for Diversity category
    ###Required Fields
    Then Enter number "15464574575474" in "Phone Number" in corporation details
    Then Click on Save button in Basic Info Page
    Then Wait for 10 seconds
    Then Show "Required" under "Date Established" at field
    Then Show "Required" under "Description" at field
  ...
  @Smoke @NewZealandLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country New Zealand for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #Then Enter "newzealand12" email in Email Address field for Italy
    ...
    Then Select "New Zealand" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of New Zealand"
    Then Select "New Zealand Dollar" in "Currency" css dropdown
    Then Enter value for Account Holder Name "New Zealand"
    #Then Enter value for Bank Routing Number "23634795651"
    And Wait for 2 seconds
    Then Enter value for Bank Account Number "1234567"
    And Wait for 2 seconds
    Then Enter value for Bank Number "8721342"
    And Wait for 2 seconds
    And Enter value for Bank Swift Code "FDGFDHQKIRA"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of New Zealand"
  ...
  @Smoke @NewZealandLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country New Zealand for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #Then Enter "newzealand12" email in Email Address field for Italy
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    ...
    Then Select "New Zealand" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
  ...
  @Regression @NewZealandLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually in the range of 6 to 18 digits. This field is mandatory." in add bank account page
    #And Verify "Bank Number" tooltip of "Bank Number (BSB number) associated with the bank and is usually 6 digits. This field is mandatory." in add bank account page
    ...
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is exactly 4 digits. Either provide your postal code or leave it empty if postal code is not available." in add bank account page
