Feature: Indonesia Localisation

   #IndonesiaLocalisation
    Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @IndonesiaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Indonesia with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Indonesia" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @IndonesiaLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Indonesia" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Indonesia" supplier registration
    Then Enter "TestCity" in "City" field after "Indonesia" supplier registration
    Then Enter "12345" in "Postal Code" field after "Indonesia" supplier registration
    Then Select "Bali" in "Province" dropdown
  ...
  @Smoke @IndonesiaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Indonesia and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Indonesia" is Pre populated with country
    ###Labels
    ...
    Then Show "NPWP Number/Tax Identification Number" label under "Tax Details"
    ...
    Then Show "NPWP Number/Tax Identification Number" input text field under "Tax Details"
    ...
    Then Verify "NPWP Number/Tax Identification Number" input text field enabled under "Tax Details"
    ...
    Then Show "NPWP Number/Tax Identification Number" tooltip " NPWP Number/Tax Identification Number as issued by Directorate General of Taxes and is usually 15 digits. This is an optional field. " under "Tax Details"
    Then Show "Tax Document" tooltip " Attach your Tax Document issue by issued by Directorate General of Taxes in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    ...
    #Then Show error message "Required" under "Certificate of Incorporation" field under "Tax Details"
    ...
    ###Business types
    Then Verify "Foreign-owned Limited Liability" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "Nominee Limited Liability" value from Business type dropdown
    ...
    #Then Verify "Indonesia" flag in Phone Number field
    #And Verify "Indonesia" flag in Fax Number field
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+62 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+62 323213123555"
    ...
    #####NPWP Number/Tax Identification Number - Input type
     Then Enter "@#$%&" in "NPWP Number/Tax Identification Number" field under "Tax Details"
    Then Verify no data is entered in "NPWP Number/Tax Identification Number" field under "Tax Details"
    Then Enter "      " in "NPWP Number/Tax Identification Number" field under "Tax Details"
    Then Verify no data is entered in "NPWP Number/Tax Identification Number" field under "Tax Details"
    Then Wait for 3 seconds
    ############When Enter Company Registration Number for Indonesia  under Tax Details
    Then Enter random number in "Company Registration Number" field under "Tax Details"
    Then Enter random number in "NPWP Number/Tax Identification Number" field under "Tax Details"
    ...
    Then Verify "Indonesia" is listed in "Country/Region" dropdown
    Then Select "Indonesia" in "Country/Region" dropdown
    ...
    # Flag
    #Then Verify "Morocco" flag in Primary Phone field
    #And Verify "Morocco" flag in Secondary Phone field
    ###Required Error
    ...
    Then Enter phone number "42324242342" in "Primary Phone" field
    Then Verify phone number "Primary Phone" is entered in accepted format "+62 42324242342"
    Then Enter phone number "42324242342" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+62 42324242342"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Enter "12345" in "PO Box Postal Code" field
    Then Enter "12345" in "Postal Code" field
    Then Enter "Morocco" in "City" field
    Then Select "Bali" in "Province" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @IndonesiaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Indonesia and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Enter phone number "42324242342" in "Primary Phone" field
    Then Verify phone number "Primary Phone" is entered in accepted format "+62 42324242342"
    Then Enter phone number "42324242344" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+62 42324242344"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    Then Enter 150 digit alpha numeric data in "Address Line 1" field
    ...
    Then Enter "12345" in "PO Box Postal Code" field
    Then Enter "12345" in "Postal Code" field
    Then Enter "Indonesia" in "City" field
    Then Select "Bali" in "Province" dropdown
    Then Click on "Save Contact" button
    Then Switch to the parent window
    #Then Close the modal
  ...
  @Smoke @IndonesiaLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Indonesia with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Verify no data is entered in "NPWP Number/Tax Identification Number" field under "Tax Details"
    Then Wait for 3 seconds
    ############When Enter VAT Registration Number for Srilanka under Tax Details
    Then Enter random number in "Company Registration Number" field under "Tax Details"
    Then Enter random number in "NPWP Number/Tax Identification Number" field under "Tax Details"
    #Then Enter random Tax Identification Number in "Tax Identification Number" field under "Tax Details"
    #Then Enter random Number in "VAT Registration Number" field under "Tax Details"
  ...
  @Smoke @IndonesiaLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Indonesia with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Verify no data is entered in "NPWP Number/Tax Identification Number" field under "Tax Details"
    Then Wait for 3 seconds
   ############When Enter VAT Registration Number for Sri Lanka  under Tax Details
    Then Enter random number in "Company Registration Number" field under "Tax Details"
    Then Enter random number in "NPWP Number/Tax Identification Number" field under "Tax Details"
    #Then Enter random Tax Identification Number in "Tax Identification Number" field under "Tax Details"
    #Then Enter random Number in "VAT Registration Number" field under "Tax Details"
  ...
  @Smoke @IndonesiaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Indonesia for existing supplier
    ...
    Then Select "Indonesia" in "Country/Region" dropdown
    Then Enter "Indonesia Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Indonesia"
    Then Select "Indonesian Rupiah (IDR)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Indonesia"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Indonesia"
  ...
  @Smoke @IndonesiaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Indonesia for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Indonesia" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Wait for 5 seconds
    Then Select "Bali" in "Province" dropdown section
    Then Enter "45676" in "Postal Code" field under "Factoring Company Address" section
    Then Enter "45675" in "PO Box" field under "Factoring Company Address" section
    Then Enter "45676" in "PO Box Postal Code" field under "Factoring Company Address" section
    Then Wait for 3 seconds
    Then Click "Save" button 6
    Then Wait for 3 seconds
    Then Click on Not now button
  ...
  @Regression @IndonesiaLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually in the range of 7 to 18 digits. This field is mandatory." in add bank account page
    #And Verify "Bank Key" tooltip of "Bank Account Code (Identifier) associated with the bank which is usually 6 digits. This is a mandatory field" in add bank account page
    #And Verify "Control Key" tooltip of "The Control Key is a 2 digit number. This field is mandatory" in add bank account page
    ...
    #And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 28 alphanumeric characters.Example:MA12345678901234567890123456.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    ...
    And Verify "Province" tooltip of "Select the appropriate province from the dropdown. This is a mandatory field." in add bank account page
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is exactly 5 digits. Either provide your postal code or leave it empty if postal code is not available." in add bank account page
    ...
    Then Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is exactly 5 digits. This field is optional." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Province" tooltip of "Select the appropriate province from the dropdown. This is a mandatory field." in add bank account Factoring Company Address section
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is exactly 5 digits. Either provide your postal code or leave it empty if postal code is not available." in add bank account Factoring Company Address section
    And Verify "PO Box" tooltip of "The Post Office Box of your company which is usually 0 to 12 alphanumeric characters. This field is optional." in add bank account Factoring Company Address section
    And Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is exactly 5 digits. This field is optional." in add bank account Factoring Company Address section
