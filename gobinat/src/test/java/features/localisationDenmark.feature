Feature: Denmark Localisation
  ...
  @Smoke @DenmarkLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Denmark with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Denmark from the dropdown
    Then Select "Denmark" in "Supplier Country of Registration" dropdown
  ...
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Click on Join Now Link in the "Denmark" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Denmark" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Denmark" supplier registration
    Then Enter "TestCity" in "City" field after "Denmark" supplier registration
    Then Enter "7673" in "Postal Code" field after "Denmark" supplier registration
    Then Select "West Jutland" in "Province" dropdown
    Then Enter "74546443" in "PO Box" field after "Denmark" supplier registration
    Then Enter "4000" in "PO Box Postal Code" field after "Denmark" supplier registration
    ...
    @Smoke @DenmarkLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Denmark and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Denmark" is Pre populated with country
    ###Labels
    ...
    Then Show "Business Registration Number" label under "Tax Details"
    ...
    Then Show "Business Registration Number" input text field under "Tax Details"
    ...
    Then Verify "Business Registration Number" input text field enabled under "Tax Details"
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Business Registration Number" tooltip " The Central Business Registration Number (CVR number) as issued by the Danish Business Register and is usually 8 digits in the format 12345678. This is an optional field. " under "Tax Details"
    Then Show "Business Registration Document" tooltip " Attach your Business Registration Document issued by the Danish Business Register in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    Then Show "Tax Identification Number" tooltip " Tax Identification Number,also known as CVR Number, as issued by SKAT which is the Danish Tax Agency of Denmark and is usually 8 digits in the format. Eg: 12345678. This is a mandatory field. " under "Tax Details"
    Then Show "Tax Registration Document" tooltip " Attach your company's Certificate of Tax Registration in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    Then Show "EU VAT Registration Number" tooltip " EU VAT Registration Number, as issued by SKAT which is the Danish Tax Agency of Denmark and is usually 10 alphanumeric characters and in the format. Eg: DK12345678. This is an optional field. " under "Tax Details"
    Then Show "EU VAT Registration Document" tooltip " Attach your company's Certificate of EU VAT Registration issued by the Danish Tax Agency in the below mentioned formats. This is an optional attachment " under "Tax Details"
    ...
    ###Business types
    Then Verify "Branch and Representative Office" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Danish General Partnership" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Danish Limited Partnership" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Danish Private Limited Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Danish Public Limited Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Danish Sole Proprietorship" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "Branch and Representative Office" value from Business type dropdown
    #Date calandar
    ...
    Then Verify "Denmark" flag in "Phone Number" field "dk"
    Then Verify "Denmark" flag in "Fax Number" field "dk"
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+45 323213123555"
    Then Enter phone number "3232131235" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+45 3232131235"
    ...
    Then Verify "Denmark" is listed in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+45 4234242423423"
    Then Enter phone number "4234242423423" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+45 4234242423423"
    ###Required Error
   ...
   @Smoke @DenmarklLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Denmark and with questionnaire
Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Denmark from teh dropdown
    Then Select "Denmark" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Enter "TestCity" in "City" field after "Denmark" supplier registration
    Then Select "West Jutland" in "Province" dropdown
    Then Enter "1234" in "Postal Code" field after "Denmark" supplier registration
    Then Enter "7454" in "PO Box" field after "Denmark" supplier registration
    Then Click "Next" button
    Then Wait for 3 seconds
    Then Select the UNSPSC codes on the Basic information page
    Then Click "Next" button
   ...
   #Radio buttons visibility
    ...
    #And Verify "Albania" flag in Fax Number field
    #And Verify Brazil flag in Fax Number field
    #Then Verify "Denmark" flag in "Phone Number" field "cm"
    #Then Verify "Denmark" flag in "Fax Number" field "cm"
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+45 323213123555"
    Then Enter phone number "3232131235" in "Fax Number" field
    ...
    Then Enter phone number "4234242423423" in "Primary Phone" field
    Then Verify phone number "Primary Phone" is entered in accepted format "+45 4234242423423"
    Then Enter phone number "6234242423423" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+45 6234242423423"
...
@Smoke @DenmarkLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Denmark with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
   ...
   #####TAX Registration Number - Input type
    ...
    @Smoke @DenmarkLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Denmark with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
   ...
   ###Required Error
    ...
    @Smoke @DenmarkLocalisation @Supplier @BankAccount @QuickSanity 
     Scenario: Add Company Account with valid data for Country Denmark for existing supplier
    ...
    Then Select "Denmark" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Denmark"
    Then Select "Danish Krone" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Danes"
    Then Select "Regular Bank Account" in "Banking Account Type" dropdown
    And Wait for 2 seconds
    Then Enter value for Bank Account Number "50101358944"
    And Wait for 2 seconds
    #And Enter value for Bank Key "0010"
    ...
    And Enter value for IBAN "DK3750100001358944"
    And Wait for 2 seconds
    ...
    And Wait for 5 seconds
    Then Enter value for Bank Branch Name "Bank of Denmark"
    ...
    @Smoke @DenmarkLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Denmark for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Enter value for Bank Account Number "50101358944"
    And Wait for 2 seconds
    And Enter value for Bank Key "0020"
    #When Enter the IBAN evidence for Albania
    And Enter value for Bank Swift Code "NDEAFIHMDAD"
    And Enter value for IBAN "DK3750100001358944"
    And Wait for 2 seconds
    Then Select "Bank statement" in "Account Evidence" dropdown
    And Wait for 5 seconds
    ...
    Then Select "Denmark" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    @Regression @DenmarkLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    #And Verify "Banking Account Type" tooltip of "Select the appropriate Banking Account type from the drop down" in add bank account page
    And Verify "Account Number" tooltip of "Account number of the Bank account which is the last 10 digits of the IBAN number. If, in case, the account number is less than 10 digits, fill it with preceding 0’s. This field is mandatory." in add bank account page
    And Verify "Bank Key" tooltip of "Bank Account Code (Identifier) associated with the bank and is usually 4 digits. This field is mandatory." in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 18 alphanumeric characters.Example:DK5000400440116243.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    ...
    And Verify "Province" tooltip of "Select the appropriate province from the dropdown. This is an optional field." in add bank account page
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is exactly 4 digits. This field is mandatory." in add bank account page
    ...
    Then Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is exactly 4 digits. This field is optional." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    @Smoke @DenmarkLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier with Denmark tax country registration process from maildrop
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
