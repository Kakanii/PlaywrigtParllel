Feature: Serbia Localisation
  ...
  @Smoke @SerbiaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Serbia with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Serbia" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @SerbiaLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Serbia from the dropdown
    Then Select "Serbia" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Serbia" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Serbia" supplier registration
    Then Enter "TestCity" in "City" field after "Serbia" supplier registration
    Then Enter "12345" in "Postal Code" field after "Serbia" supplier registration
    Then Select "Bor" in "Region" dropdown
  ...
  @Smoke @SerbiaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Serbia and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Serbia from teh dropdown
    Then Select "Serbia" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Serbia" is Pre populated with country
    ###Labels
    ...
    Then Show "Tax Identification Number (PIB)" label under "Tax Details"
    ...
    Then Show "Tax Identification Number (PIB)" input text field under "Tax Details"
    ...
    Then Verify "Tax Identification Number (PIB)" input text field enabled under "Tax Details"
    ...
    Then Show "Tax Identification Number (PIB)" tooltip " Tax Identification Number (PIB) as issued the Serbian Tax office and is usually 13 digits. This is a mandatory field. " under "Tax Details"
    Then Show "Tax Document" tooltip " Attach your Tax Document issued by the Serbian Tax office in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    ...
    Then Show error message "Required" under "Tax Identification Number (PIB)" field under "Tax Details"
    ...
    Then Verify "Branches of Foreign Companies" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "General Partnership" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Joint Stock Companies" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Private Limited Liability Companies" is listed in "Business Type" dropdown under "Tax Details"
    ...
    #Then Verify "Honduras" flag in Phone Number field
    #And Verify "Honduras" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+381 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+381 323213123555"
    ...
    Then Enter "      " in "Company Registration Number" field under "Tax Details"
    Then Verify no data is entered in "Company Registration Number" field under "Tax Details"
    #####Tax Identification Number (PIB) - Input type
    Then Enter "@#$%&" in "Tax Identification Number (PIB)" field under "Tax Details"
    Then Verify no data is entered in "Tax Identification Number (PIB)" field under "Tax Details"
    Then Enter "      " in "Tax Identification Number (PIB)" field under "Tax Details"
    Then Verify no data is entered in "Tax Identification Number (PIB)" field under "Tax Details"
    ...
    Then Enter random number in "Tax Identification Number (PIB)" field under "Tax Details"
    ...
    #Then Enter random EU VAT number "PL" in "EU VAT Registration Number"
     ###Document uploads
    Then Scroll to view "Tax Document" field
    ...
    Then Verify "Serbia" is listed in "Country/Region" dropdown
    Then Select "Serbia" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+381 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+381 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
  ...
  @Smoke @SerbiaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Serbia and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Enter "      " in "Tax Identification Number (PIB)" field under "Tax Details"
    Then Verify no data is entered in "Tax Identification Number (PIB)" field under "Tax Details"
    ############When Enter Tax Identification Number (PIB) for Serbia  under Tax Details
    #Then Enter data EU VAT Registration Number under Tax Details
    Then Enter random number in "Company Registration Number" field under "Tax Details"
    Then Enter random number in "Tax Identification Number (PIB)" field under "Tax Details"
    #Then Enter data VAT Registration Number under Tax Details
  ...
  @Smoke @SerbiaLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Serbia with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Verify "Senegal" flag in Phone Number field
    #And Verify "Senegal" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+381 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
  ...
  @Smoke @SerbiasLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Serbia with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @SerbiaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Serbia for existing supplier
    ...
    Then Select "Serbia" in "Country/Region" dropdown
    Then Enter "Serbia Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Serbia"
    Then Select "Serbian dinar (RSD)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Serbia"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Serbia"
  ...
  @Smoke @SerbiaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Serbia for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Serbia" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Bor" in "City" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Bor" in "Region" dropdown section
  ...
  @Regression @HondurasLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account Number of the Bank account which is the last 15 digits of the IBAN number. If, in case, the account number is less than 15 digits, fill it with preceding 0’s. This field is mandatory." in add bank account page
    And Verify "Bank Key" tooltip of "Bank Key associated with the bank and is usually 3 digits. This is the 5th to 7th digits of IBAN and the field is mandatory." in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 22 alphanumeric characters.Example:RS35260005601001611379.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Region" tooltip of "Select the appropriate region from the dropdown. This is a mandatory field." in add bank account Factoring Company Address section
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 5 digits. This field is mandatory." in add bank account Factoring Company Address section
