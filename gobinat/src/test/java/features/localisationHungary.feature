Feature: Hungary Localisation
  ...
  @Smoke @HungaryLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Hungary with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Hungary" in "Supplier Country of Registration" dropdown
  ...
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Hungary" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Hungary" supplier registration
    Then Enter "TestCity" in "City" field after "Hungary" supplier registration
    Then Enter "7673" in "Postal Code" field after "Hungary" supplier registration
    Then Select "Vas" in "Region" dropdown
    ...
    Then Logout from the system
     ...
     @Smoke @HungaryLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Hungary and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Hungary" is Pre populated with country
    ###Labels
    ...
    Then Show "Commercial Registration Document" label under "Tax Details"
    ...
    Then Show "Commercial Registration Document" button in basic information
    ...
    Then Verify Upload "Commercial Registration Document" button clickable in basic information
    ...
    Then Show "Commercial Registration Number" tooltip " Commercial Registration Number is usually 12 digits separated by hyphens. Examples: 01-10-041004, 05-06-015347. This field is optional. " under "Tax Details"
    Then Show "Commercial Registration Document" tooltip " Attach your company's Commercial Registration Document in the below mentioned formats. This field is optional. " under "Tax Details"
    Then Show "Tax Identification Number" tooltip " The domestic Tax ID in the format 13395612-2-41 (11 digits + 2 hyphens). This is a mandatory field. " under "Tax Details"
    Then Show "Tax Registration Document" tooltip " Attach your company's Tax Registration Document in the below mentioned formats. This field is mandatory. " under "Tax Details"
    ...
    Then Verify "Private Company Limited by Shares" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Public Company Limited by Shares" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+36 (323) 213 123555"
    Then Enter phone number "3232131235" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+36 (323) 213 1235"
    ...
    # Flag
    #Then Verify "Hungary" flag in Primary Phone field
    #And Verify "Hungary" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+36 (423) 424 242342"
    Then Enter phone number "423424242342" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+36 (423) 424 242342"
    ...
    Then Logout from the system
     ...
     @Smoke @HungaryLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Hungary and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
   ...
   Then Enter "7673" in "Postal Code" field after "Hungary" supplier registration
    ...
    Then Verify phone number "Fax Number" is entered in accepted format "+36 (323) 213 1236"
    #click on the calandar icon
    Then Scroll to the top of the page
    Then click on the calandar icon
    Then select date "1" from the date
   ...
   Then Enter "@#$%&" in "Tax Identification Number" field under "Tax Details"
    ...
    Then Verify phone number "Secondary Phone" is entered in accepted format "+36 (423) 424 242343"
    Then Verify "Branch" is listed in "Address Type" dropdown
    Then Select "Branch" in "Address Type" dropdown
    Then Verify "Hungary" is listed in "Country/Region" dropdown
    Then Select "Hungary" in "Country/Region" dropdown
  ...
  @Smoke @HungaryLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Hungary with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @HungaryLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Hungary with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @HungaryLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Hungary for existing supplier
  ...
  Scenario: Add Factory Company Account with valid data for Country Ireland for existing supplier
    ...
    Then Enter value for City " Tirana"
    Then Enter "1234" in "Postal Code" field
    Then Select "Zala" in "Region" dropdown
    ...
    Then Select "Hungary" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
