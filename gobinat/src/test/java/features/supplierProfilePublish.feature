Feature: Supplier Profile Publish
  ...
  @Smmoke @Supplier @SupplierProfilePublish @QuickSanity
  Scenario: Verify all the fields visibility and status in Supplier Profile Publish page
