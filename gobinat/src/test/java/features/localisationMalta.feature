Feature: Malta Localisation
  ...
  @Smoke @MaltaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Malta with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Malta from the dropdown
    Then Select "Malta" in "Supplier Country of Registration" dropdown
  ...
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Malta from teh dropdown
    Then Select "Malta" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Click on Join Now Link in the "Malta" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Malta" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Malta" supplier registration
    Then Enter "TestCity" in "City" field after "Malta" supplier registration
    Then Select "Central Region" in "Region" dropdown
    Then Enter "7454" in "PO Box" field after "Malta" supplier registration
    Then Enter "VLT 1118" in "Postal Code" field after "Malta" supplier registration
    ...
    @Smoke @MaltaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Malta and with out questionnaire
    #Open buyer page
   Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Malta" is Pre populated with country
    ###Labels
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Company Registration Number" tooltip "Company registration number which is usually 6 or 7 digits alphanumeric characters and is issued by the Malta Business Registry (MBR). This is optional field." under "Tax Details"
    Then Show "Company Registration Document" tooltip "Attach your Company’s registration Document issued by the Malta Business Registry (MBR) in the below mentioned formats. This is optional attachment." under "Tax Details"
    Then Show "VAT Registration Number" tooltip "VAT Registration Number issued by the Office of the Commisioner for Revenue which is usually MT+8 digits. This is Mandatory field." under "Tax Details"
    Then Show "VAT Registration Document" tooltip "Attach your company's Certificate of Tax Registration issued by the Office of the Commisioner for Revenue in the below mentioned formats.  This is mandatory attachment. " under "Tax Details"
    Then Show "EU VAT Registration Number" tooltip "EU VAT Registration Number issued by the Office of the Commisioner for Revenue which is usually MT+8 digits. This is optional field." under "Tax Details"
    Then Show "EU VAT Registration Document" tooltip "Attach your company's Certificate of Tax Registration issued by the Office of the Commisioner for Revenue in the below mentioned formats.  This is optional attachment." under "Tax Details"
    ...
    ###Business types
    Then Verify "EUROPEAN Economic Interest Grouping (EEIG)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "General Partnerships" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Holding Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Trading Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Other" is listed in "Business Type" dropdown under "Tax Details"
    Then Select "General Partnerships" value from Business type dropdown
    #Date calandar
    ...
    Then Verify "Malta" flag in "Phone Number" field "mt"
    Then Verify "Malta" flag in "Fax Number" field "mt"
    ###Phone number format
    Then Enter phone number "949 049 1531" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+356 949 049 1531"
    Then Enter phone number "949 049 1532" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+356 949 049 1532"
    ...
    Then Enter "MT87346571" in "VAT Registration Number" field under "Tax Details"
    #Then Enter "MT86515345" in "EU VAT Registration Number" field under "Tax Details"
    Then Enter "MT66315351" in "EU VAT Registration Number" field under "Tax Details" 
    ...
    Then Verify "Malta" is listed in "Country/Region" dropdown
    Then Select "Malta" in "Country/Region" dropdown
    ...
    Then Enter phone number "234 568 75645342" in "Primary Phone" field
    Then Verify phone number "Primary Phone" is entered in accepted format "+356 234 568 75645342"
    Then Enter phone number "234 568 75645343" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+356 234 568 75645343"
    ...
    Then Enter "VLT 1118" in "Postal Code" field
    Then Enter "123456789012" in "PO Box" field
    ...
    @Smoke @MaltaLocalisation @Localisation @Supplier @QuickSanity @QuickCheck 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Malta and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
   ...
   Then Show "Business Name" label in "Basic information page"
    ...
    Then Wait for 3 seconds
    Then Enter random company registration number in "Company Registration Number" field under "Tax Details"
    #Then Enter "MT77346583" in "VAT Registration Number" field under "Tax Details"
    Then Enter "M" followed by "T" and 8 numbers in "VAT Registration Number" field under "Tax Details"
    Then Enter "M" followed by "T" and 8 numbers in "EU VAT Registration Number" field under "Tax Details"
    #Then Enter "MT73515343" in "EU VAT Registration Number" field under "Tax Details" 
    #Then Verify data entered in "Tax Identification Number" field is "72222790" under "Tax Details"
    ###Document uploads
    Then Scroll to view "VAT Registration Document" field
    Then Click "Upload VAT Registration Document" button
   ...
   Then Show "First Name" tooltip "The First Name of the contact person, as it appears on official government documents, such as a passport. This is a required field. Max length: 35 characters."
    ...
    @Smoke @MaltaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Malta with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
   ...
   Then Verify "EUROPEAN Economic Interest Grouping (EEIG)" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Wait for 3 seconds
    Then Enter random company registration number in "Company Registration Number" field under "Tax Details"
    Then Enter "MT87543521" in "VAT Registration Number" field under "Tax Details"
    #Then Enter "MT86515345" in "EU VAT Registration Number" field under "Tax Details"
    Then Enter "MT66513321" in "EU VAT Registration Number" field under "Tax Details" 
    #Then Verify data entered in "Tax Identification Number" field is "72222790" under "Tax Details"
    ###Document uploads
     Then Scroll to view "VAT Registration Document" field
    Then Click "Upload VAT Registration Document" button
   ...
   Then Verify "Address Line 1" input text field enabled
    ...
    @Smoke @MaltaLocalisation @Localisation @Supplier @QuickSanity 
    Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Malta with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
   ...
   Then Enter number "1546457457" in "Phone Number" in corporation details
    ...
    Then Wait for 3 seconds
    Then Enter random company registration number in "Company Registration Number" field under "Tax Details"
    Then Enter "MT87546531" in "VAT Registration Number" field under "Tax Details"
    #Then Enter "MT86515345" in "EU VAT Registration Number" field under "Tax Details"
    Then Enter "MT66515331" in "EU VAT Registration Number" field under "Tax Details" 
    #Then Verify data entered in "Tax Identification Number" field is "72222790" under "Tax Details"
    ###Document uploads
    Then Scroll to view "VAT Registration Document" field
    Then Click "Upload VAT Registration Document" button
    ...
    @Smoke @MaltaLocalisation @Supplier @BankAccount @QuickSanity @QuickCheck
  Scenario: Add Company Account with valid data for Country Malta for existing supplier
    ...
    Then Select "Malta" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Malta"
    Then Select "Euro" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Maltaian"
    ...
    #Then Enter value for Bank Account Number "MT3456789098765432"
    And Wait for 2 seconds
    And Wait for 2 seconds
    Then Enter input data in "Bank Key" field
   #Then Enter "1234" in "Branch Code" field under "Bank Account Information"
    ...
    And Enter value for IBAN "MT84MALT011000012345MTLCAST001S"
    ...
    Then Enter value for Bank Branch Name "Bank of Malta"
    Then Enter value for Address "Hilton Garden Inn"
    Then Enter value for City "Tirana"
    Then Select "Central Region" in "Region" dropdown
    Then Enter value for Postal Code "VLT 1118"
    ...
    Then Logout from the system
     ...
     @Smoke @MaltaLocalisation @Localisation @Supplier @QuickSanity 
    Scenario: Add Factory Company Account with valid data for Country Malta for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
   ...
   #Then Enter "1234" in "Branch Code" field under "Bank Account Information"
    ...
    Then Select "Malta" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Select "Central Region" in "Region" dropdown
    Then Enter value for Factory Company Postal Code "VLT 1118"
    Then Wait for 3 seconds
    Then Click "Save" button 6
    #And Click on the save in Address verification
    Then Wait for 3 seconds
    ...
    @Regression @MaltaLocalisation @Supplier @BankAccount @QuickSanity 
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually 18 alphanumeric characters. This is a mandatory field" in add bank account page
    And Verify "Bank Key" tooltip of "Bank Account Code (Identifier) associated with the bank and is usually 5 digits. This field is mandatory." in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 31 alphanumeric characters.Example:MT84MALT011000012345MTLCAST001S.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    ...
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 8 alphanumeric characters. Eg: VLT 1118.This field is mandatory." in add bank account page
    ...
    Then Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually 8 alphanumeric characters. This field is optional." in add bank account page
