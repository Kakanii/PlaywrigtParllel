Feature: Australia Localisation

  #AustraliaLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @AustraliaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Australia with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Australia from teh dropdown
  ...
  @Smoke @AustraliaLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Australia" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Australia" supplier registration
    Then Enter "TestCity" in "City" field after "Australia" supplier registration
    Then Enter "7673" in "Postal Code" field after "Australia" supplier registration
  ...
  @Smoke @AustraliaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Australia and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Australia" is Pre populated with country
    ###Labels
    ...
    Then Show "Australian Company Number" label under "Tax Details"
    Then Show "Tax File number" label under "Tax Details"
    Then Show "Australian Business Number" label under "Tax Details"
    ...
    Then Show "Australian Company Number" input text field under "Tax Details"
    Then Show "Tax File number" input text field under "Tax Details"
    Then Show "Australian Business Number" input text field under "Tax Details"
    ...
    Then Verify "Australian Company Number" input text field enabled under "Tax Details"
    Then Verify "Tax File number" input text field enabled under "Tax Details"
    Then Verify "Australian Business Number" input text field enabled under "Tax Details"
    ...
    Then Verify "NO" radio button "4" is selected by default under "Additional Information"
    ...
    Then Show "ABN Tax Registration Document" button in basic information
    ...
    Then Verify Upload "ABN Tax Registration Document" button clickable in basic information
    ##Website checkbox
    ...
    Then Show "Australian Company Number" tooltip "Australian Company Number (ACN) for Company entities as issued by the Australian Securities and Investments Commission (ASIC). For non Company entities, it is Australian Registered Body Number (ARBN). This is mandatory field." under "Tax Details"
    Then Show "Tax File number" tooltip "Tax File number issued by the Australian Taxation Office for entities. It is usually 8 or 9 alphanumeric characters." under "Tax Details"
    Then Show "Australian Business Number" tooltip "Australian Business number issued by the Australian Business Register of Australian Tax Office. This is an optional field." under "Tax Details"
    Then Show "Certificate of Incorporation" tooltip "Attach your company's Certificate of Incorporation issued by the Australian Securities and Investments Commission (ASIC) in the below mentioned formats. This is an optional field." under "Tax Details"
    ...
    Then Show "ABN Tax Registration Document" tooltip " Attach your company's Certificate of ABN Tax Registration in the below mentioned formats. This is an optional field. " under "Tax Details"
    ...
    Then Show error message "Required" under "Australian Company Number" field under "Tax Details"
    ...
    ###Business types
    Then Verify "General partnership (GP)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Government Entity" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Incorporated Limited Partnership (ILP)" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Proprietary Limited Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Sole Trader" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Trust" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Unlimited Proprietary" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "General partnership (GP)" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    Then Verify "Australia" flag in Phone Number field
    And Verify "Australia" flag in Fax Number field
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+61 32 3213 123555"
    Then Enter phone number "3232131235" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+61 32 3213 1235"
    ...
    Then Enter "@#$%&" in "Australian Company Number" field under "Tax Details"
    Then Verify no data is entered in "Australian Company Number" field under "Tax Details"
    Then Enter "      " in "Australian Company Number" field under "Tax Details"
    Then Verify no data is entered in "Australian Company Number" field under "Tax Details"
    #####Employer Identification Number (EIN) - Input range
    Then Wait for 3 seconds
    ############When Enter Australian Company Number for Australia under Tax Details
    #Then Enter "999999929" in "Australian Company Number" field under "Tax Details"
    #Then Verify data entered in "Australian Company Number" field is "999999929" under "Tax Details"
    ...
    Then Verify "Australia" is listed in "Country/Region" dropdown
    ...
    Then Verify "Australian Capital Territory" is listed in "State or Territory" dropdown
    Then Select "Australian Capital Territory" in "State or Territory" dropdown
    ...
    # Flag
    Then Verify "Australia" flag in Primary Phone field
    And Verify "Australia" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+61 42 3424 2423423"
    Then Enter phone number "4234242423423" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+61 42 3424 2423423"
    ...
    Then Show error message "Required" for "Address Line 1" field
    Then Show error message "Required" for "City" field
    #Then Show error message "Required" for "PO Box Postal Code" field
    ...
    Then Enter "1234" in "PO Box Postal Code" field
    Then Enter "1234" in "Postal Code" field
    Then Enter "Australia" in "City" field
    Then Click on "Save Contact" button
    ...
    Then Select text "Australia" under "IBM Country & ISO Code" for Custom Fields
    Then Wait for 3 seconds
  ...
  @Smoke @AustraliaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Australia and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    #Then Enter "999999935" in "Australian Company Number" field under "Tax Details"
    #Then Verify data entered in "Australian Company Number" field is "999999935" under "Tax Details"
    Then Enter Australian Company Number under Tax Details
    ###Document uploads
    Then Scroll to view "Certificate of Incorporation" field
    Then Click "Upload Certificate of Incorporation" button
    ...
    Then Verify phone number "Secondary Phone" is entered in accepted format "+61 42 3424 2423424"
    Then Verify "Branch" is listed in "Address Type" dropdown
    Then Select "Branch" in "Address Type" dropdown
    ### Error Validation
    ###Address 1
  ...
  @Smoke @AustraliaLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Australia with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Verify "Australia" flag in Phone Number field
    And Verify "Australia" flag in Fax Number field
    #Then Verify "Australia" flag in "Phone Number" field "us"
    #Then Verify "Australia" flag in "Fax Number" field "us"
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+61 32 3213 123555"
    Then Enter phone number "3232131235" in "Fax Number" field
    ...
    #####Employer Identification Number (EIN) - Input range
    Then Wait for 3 seconds
    #Then Enter "999999953" in "Australian Company Number" field under "Tax Details"
    #Then Verify data entered in "Australian Company Number" field is "999999953" under "Tax Details"
    Then Enter Australian Company Number under Tax Details
    ###Document uploads
    Then Scroll to view "Certificate of Incorporation" field
    Then Click "Upload Certificate of Incorporation" button
  ...
  @Smoke @AustraliaLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Australia with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    #####Employer Identification Number (EIN) - Input range
    Then Wait for 3 seconds
    #Then Enter "999999964" in "Australian Company Number" field under "Tax Details"
    Then Enter Australian Company Number under Tax Details
    #Then Verify data entered in "Australian Company Number" field is "999999964" under "Tax Details"
    ###Document uploads
    Then Scroll to view "Certificate of Incorporation" field
    Then Click "Upload Certificate of Incorporation" button
    Then Upload "PDF" under "Upload Document"
  ...
  @Smoke @AustraliaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Australia for existing supplier
    ...
    Then Select "Australia" in "Country/Region" dropdown
    #Then Select "Austraila" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Australia"
    Then Select "Australian Dollar (AUD)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Australia"
   ...
   Then Enter input data in "SWIFT Code" field
    ...
    Then Enter value for Bank Branch Name "Bank of Australia"
  ...
  @Smoke @AustraliaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Australia for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Australia" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Select "Victoria" in "State or Territory" dropdown section
