Feature: Spain Localisation
  ...
  @Smoke @SpainLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Spain with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Spain" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @SpainLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Spain" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Spain" supplier registration
    Then Enter "TestCity" in "City" field after "Spain" supplier registration
    Then Enter "32432" in "Postal Code" field after "Spain" supplier registration
    Then Select "Albacete" in "Province" dropdown
  ...
  @Smoke @SpainLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Spain and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Spain" is Pre populated with country
    ###Labels
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Company Registration Number" tooltip "Company registration number issued by the Registro Mercantil, which is the companies registry in Spain. Field Length: 9 alphanumeric characters. This is an optional field." under "Tax Details"
    Then Show "Company Registration Document" tooltip "Attach your Company’s registration document issued by the Registro Mercantil, which is the companies registry in Spain, in the below mentioned formats. This is an optional field." under "Tax Details"
    Then Show "Tax Identification Number" tooltip "Tax/VAT Identification Number (CIF,NIF or NIE) which is 9 alphanumeric characters issued by the Agencia Tributaria (Spanish Tax Agency) office. This is a mandatory field." under "Tax Details"
    ...
    Then Show "EU VAT Registration Number" tooltip "EU VAT Registration Number as issued by the Agencia Tributaria (Spanish Tax Agency) office and is usually 11 alphanumeric characters in the format ESB12345678. This is optional field." under "Tax Details"
    Then Show "EU VAT Registration Document" tooltip "Attach your company's Certificate of EU VAT Registration in the below mentioned formats. This is an optional attachment." under "Tax Details"
    ...
    Then Verify "Co-ownership" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Jointly owned company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Limited Liability Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "New Enterprise Limited Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Sole Trader/Sole Proprietor" is listed in "Business Type" dropdown under "Tax Details"
    ...
    ####Flag
    Then Verify "Spain" flag Phone Number
    And Verify "Spain" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+34 123 456 7890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+34 123 456 7890"
    ...
    Then Wait for 3 seconds
    Then Enter data Company Registration Number under "Tax Details" field
    Then Enter data Tax Identification Number under "Tax Details" field
    Then Enter data in "EU VAT Registration Number" under "Tax Details" field
    ...
    Then Verify "Spain" is listed in "Country/Region" dropdown
    Then Select "Spain" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+34 123 456 7890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+34 123 456 7000"
    ###Required Error
    ...
    Then Verify data entered in "PO Box Postal Code" field is "34543"
    ...
    @Smoke @SpainLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Spain and with questionnaire
    Then Enter data in Email Address field
    ...
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    And Select "Cooperative" value from Business type dropdown
  ...
  @Smoke @SpainLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Spain and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @SpainLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Spain and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @SpainLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Spain for existing supplier
    When Enter Spain Supplier Email in Email Address field
    ...
    Then Select "Spain" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Spain"
    Then Select "Euro (EUR)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Spain"
    ...
    Then Enter value for Bank Branch Name "Bank of Spain"
  ...
  @Smoke @SpainLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Add Factoring Company Account with valid data for Country Spain for existing supplier
    When Enter Spain Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Spain" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Select "Albacete" in "Province" dropdown on Factoring Company Address
