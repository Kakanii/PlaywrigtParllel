Feature: Kazakhstan Localisation

  #KazakhstanLocalisation
    Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @KazakhstanLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Kazakhstan with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Kazakhstan" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @KazakhstanLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Kazakhstan from the dropdown
    Then Select "Kazakhstan" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Kazakhstan" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Kazakhstan" supplier registration
    Then Enter "TestCity" in "City" field after "Kazakhstan" supplier registration
    Then Enter "123456" in "Postal Code" field after "Kazakhstan" supplier registration
    Then Select "Akmola" in "Region" dropdown
  ...
  @Smoke @KazakhstanLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Kazakhstan and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Kazakhstan from teh dropdown
    Then Select "Kazakhstan" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Kazakhstan" is Pre populated with country
    ###Labels
    ...
    Then Show "Company Registration Number" tooltip " Business identification number which is the company registration number and it is issued by the Company Register in Ministry of Justice which is usually 12 digits. This is an optional field. " under "Tax Details"
    Then Show "Company Registration Document" tooltip " Attach your Company’s registration Document issued by the Company Register in Ministry of Justice  in the below mentioned formats. This is an optional attachment. <" under "Tax Details"
    Then Show "VAT Registration Number" tooltip " VAT Registration Number issued by the Kazak Tax Authority which is 12 digits. This is an optional field. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your company's Certificate of Tax Registration issued by the Kazak Tax Authority in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+7 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+7 323213123555"
    ...
    Then Verify "Kazakhstan" is listed in "Country/Region" dropdown
    Then Select "Kazakhstan" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+7 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+7 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Enter "123456" in "PO Box Postal Code" field
    Then Enter "123456" in "Postal Code" field
    Then Enter "Akmola" in "City" field
    Then Select "Akmola" in "Region" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @KazakhstanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Kazakhstan and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
   ...
   Then Enter number "323213123555" in "Phone Number" in corporation details
    ...
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Verify "Kazakhstan" flag in Phone Number field
    #And Verify "Kazakhstan" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+7 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
  ...
  @Smoke @KazakhstanLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Kazakhstan with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @KazakhstanLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Kazakhstan with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @KazakhstanLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Kazakhstan for existing supplier
    ...
    Then Select "Kazakhstan" in "Country/Region" dropdown
    Then Enter "Kazakhstan Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Kazakhstan"
    Then Select "Kazakhstani tenge (KZT)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Kazakhstan"
    And Wait for 2 seconds
    Then Enter input data in "Account Number" field
    Then Enter input data in "Bank Key (Identifier)" field
    ...
    Then Enter value for Bank Branch Name "Bank of Kazakhstan"
  ...
  @Smoke @KazakhstanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Kazakhstan for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Kazakhstan" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Akmola" in "City" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Akmola" in "Region" dropdown section
  ...
  @Regression @KazakhstanLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually minimum 4 to maximum 13 alphanumeric characters. This is a mandatory field." in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 20 alphanumeric characters.Example:KZ86125KZT5004100100.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    ...
    And Verify "Region" tooltip of "Name of the Region at which it is located. This is an optional field." in add bank account page
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 6 or 7 alphanumeric characters. This is a mandatory field." in add bank account page
    ...
    Then Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually 6 or 7 alphanumeric characters. This is an optional field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Region" tooltip of "Name of the Region at which it is located. This is an optional field." in add bank account Factoring Company Address section
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 6 or 7 alphanumeric characters. This is a mandatory field." in add bank account Factoring Company Address section
    ...
    And Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually 6 or 7 alphanumeric characters. This is an optional field." in add bank account Factoring Company Address section
