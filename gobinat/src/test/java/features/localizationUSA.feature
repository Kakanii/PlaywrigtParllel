Feature: USA Localisation

  #USALocalization
  
  Background: Login as USA supplier
  ...
  @Smoke @USALocalisation @Localisation @Supplier
   Scenario: Verify invite a Supplier whose tax country is USA with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Click "Invite Supplier" button
	...
	@Smoke @USALocalisation @Localisation @QuickSanity
  ...
  @Smoke @USALocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is USA and with out questionnaire
  	#Open buyer page
		Given Start the application
    When Click on Sign In button
    Then Close the hotjar window
  ...
  @Smoke @USALocalisation @Localisation @Supplier @TYSFunctionality @SanitySuiteCheck @SanityCheck
  ...
  @Smoke @USALocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is USA with out questionnaire and with Diversity 
  	Given Start the application
    When Click on Sign In button
    Then Close the hotjar window
    Then Enter data in Email Address field
  ...
  @Smoke @USALocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is USA with out questionnaire and with Small Business and Disadvantaged Zone Business(Optional)
  	Given Start the application
    When Click on Sign In button
    Then Close the hotjar window
    Then Enter data in Email Address field
    ...
    @Smoke @USALocalisation @Localisation @QuickSanity
  	Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is USA with out questionnaire and with Is your company designated as part of a Disadvantaged or Underutilized Zone as defined by the country of your registration?
  	Given Start the application
    When Click on Sign In button
    Then Close the hotjar window
    Then Enter data in Email Address field
    ...
    Then select "HUBZONE" under "disadvantagedZoneCategories" for Diversity Category
    Then Show tooltip "Indicate the diversity category you belong to. For more information on the categories," in "Category" in basic information
    Then Wait for 5 seconds
    #Then Upload "PDF" file "Upload file" for Diversity category
    ...
    @Smoke @USALocalisation @Localisation @QuickSanity
  	Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is USA with out questionnaire and with Additional Information
  	Given Start the application
    When Click on Sign In button
    Then Close the hotjar window
    Then Enter data in Email Address field
    ...
    Then Show "Stock Exchange" tooltip "The Stock Exchange where your Company is listed. This is a required field." in "Additional Information"
	  Then Show "Stock Exchange Symbol" tooltip "The stock symbol of your company, as it appears on your Company's commercial registration certificate." in "Additional Information"
		#select dropdown
		Then Select "Bahrain Stock Exchange" from the dropdown "Search and Select a Stock Exchange..." for Stock Exchange
    Then Wait for 5 seconds
    #Symbol
  ...
  @Smoke @USALocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add "Company Account" & "Factoring Company Account" with valid data for Country "USA"
    ...
    Then Click "Save" button 6
    Then Wait for 15 seconds
    And Click on Save button on factory Address Verification
    Then Wait for 3 seconds
    Then Click on Not now button
    Then Wait for 3 seconds
    #Then Select the Body the Bank Account
