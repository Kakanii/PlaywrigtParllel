Feature: Poland Localisation
  ...
  @Smoke @PolandLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Poland with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Poland" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @PolandLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Poland" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Poland" supplier registration
    Then Enter "TestCity" in "City" field after "Poland" supplier registration
    Then Enter "767374" in "Postal Code" field after "Poland" supplier registration
    Then Select "Lublin" in "Province/Region" dropdown
  ...
  @Smoke @PolandLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Poland and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Poland from teh dropdown
    Then Select "Poland" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Poland" is Pre populated with country
    ###Labels
    ...
    Then Show "EU VAT Registration Number" tooltip " EU VAT Registration Number as issued by the Poland Tax office and in the following format PL1234567890. This is a mandatory field. " under "Tax Details"
    Then Show "EU VAT Registration Document" tooltip " Attach your EU VAT Registration Document issued by the Poland Tax office in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    Then Show "VAT Registration Number" tooltip " VAT Registration Number, also known as NIP is issued by the Poland Tax office and in the following format 1234567890. This is an optional field. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your VAT Registration Document issued by the Poland Tax office in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    ...
    #Then Verify "Poland" flag in Phone Number field
    #And Verify "Poland" flag in Fax Number field
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+48 323213123555"
    Then Enter phone number "3232131235" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+48 3232131235"
    ...
    Then Wait for 3 seconds
    ############When Enter Tax Identification Number for Poland  under Tax Details
    ...
    Then Verify "Poland" is listed in "Country/Region" dropdown
    Then Select "Poland" in "Country/Region" dropdown
    ...
    # Flag
    #Then Verify "Poland" flag in Primary Phone field
    #And Verify "Poland" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+48 423424242342"
    Then Enter phone number "423424242342" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+48 423424242342"
    ...
    Then Verify data entered in "Postal Code" field is "12-345"
    ...
    Then Verify data entered in "PO Box Postal Code" field is "12-345"
    ...
    Then Enter "Poland" in "City" field
    Then Select "Lublin" in "Province/Region" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @PolandLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Poland  and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Verify phone number "Secondary Phone" is entered in accepted format "+48 423424242343"
    Then Verify "Branch" is listed in "Address Type" dropdown
    Then Select "Branch" in "Address Type" dropdown
    Then Verify "Poland" is listed in "Country/Region" dropdown
    Then Select "Poland" in "Country/Region" dropdown
  ...
  @Smoke @PolandLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Poland with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @PolandLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Poland with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @PolandLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Poland for existing supplier
    ...
    Then Select "Poland" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Poland"
    Then Select "Australian Dollar (AUD)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Poland"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Poland"
  ...
  @Smoke @PolandLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Poland for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Poland" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Select "Lublin" in "Province/Region" dropdown section
    ...
    Then Logout from the system
     ...
     @Regression @PolandLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is the last 16 digits of the IBAN number. This field is mandatory." in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 28 alphanumeric characters.Example:PL61109010140000071219812874.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    ...
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 2 digits+hyphen+3 digits (Eg: 12-345). This field is mandatory." in add bank account page
    ...
    Then Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually 2 digits+hyphen+3 digits (Eg: 12-345). This field is optional." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 2 digits+hyphen+3 digits (Eg: 12-345). This field is mandatory." in add bank account Factoring Company Address section
    ...
    And Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually 2 digits+hyphen+3 digits (Eg: 12-345). This field is optional." in add bank account Factoring Company Address section
