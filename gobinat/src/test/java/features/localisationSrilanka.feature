Feature: Srilanka Localisation

   #SrilankaLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @SrilankaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Srilanka with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Sri Lanka" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @SrilankaLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Sri Lanka" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Sri Lanka" supplier registration
    Then Enter "TestCity" in "City" field after "Sri Lanka" supplier registration
    Then Enter "12345" in "Postal Code" field after "Sri Lanka" supplier registration
    Then Select "Central" in "Province" dropdown
  ...
  @Smoke @SrilankaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Srilanka and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Sri Lanka" is Pre populated with country
    ###Labels
    ...
    #Then Show "Website" label in "Corporate Contact Details"
    ...
    Then Show "VAT Registration Number" tooltip " VAT Registration Number as issued by the Srilankan Tax Office and is usually 9 or 13 digits. This field is mandatory. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your VAT Registration Document as issued by the Srilankan Tax Office in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    ...
    Then Verify "Limited Liability Company for Duty Free Zones" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Sole Tradership" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Other" is listed in "Business Type" dropdown under "Tax Details"
    Then Select "Sole Tradership" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Scroll to view "Phone Number" field
    #Then Verify "Sri Lanka" flag in Phone Number field
    #And Verify "Sri Lanka" flag in Fax Number field
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+94 323213123555"
    Then Enter phone number "3232131235" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+94 3232131235"
    ...
    Then Verify "Sri Lanka" is listed in "Country/Region" dropdown
    Then Select "Sri Lanka" in "Country/Region" dropdown
    ...
    # Flag
    #Then Verify "Sri Lanka" flag in Primary Phone field
    #And Verify "Sri Lanka" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+94 42324242342"
    Then Enter phone number "42324242342" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+94 42324242342"
    Then Click on "Save Contact" button
    ...
    Then Enter "12345" in "PO Box Postal Code" field
    Then Enter "12345" in "Postal Code" field
    Then Enter "Srilanka" in "City" field
    Then Select "Central" in "Province" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @SrilankaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Srilanka  and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
   ...
   Then Enter phone number "323213123555" in "Phone Number" field
    ...
    Then Verify phone number "Secondary Phone" is entered in accepted format "+94 42324242344"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    Then Enter 150 digit alpha numeric data in "Address Line 1" field
  ...
  @Smoke @SrilankaLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Srilanka with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @SrilankaLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Srilanka with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
   ...
   ############When Enter VAT Registration Number for Sri Lanka  under Tax Details
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+94 323213123555"
    Then Enter phone number "3232131235" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+94 3232131235"
    Then Verify "Branch" is listed in "Address Type" dropdown
    Then Select "Branch" in "Address Type" dropdown
    Then Verify "Sri Lanka" is listed in "Country/Region" dropdown
    Then Select "Sri Lanka" in "Country/Region" dropdown
  ...
  @Smoke @SrilankaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Srilanka for existing supplier
    ...
    Then Select "Sri Lanka" in "Country/Region" dropdown
    Then Enter "Sri Lanka Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Sri Lanka"
    Then Select "Sri Lankan rupee (LKR)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Srilanka"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Srilanka"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City " Tirana"
    Then Select "North" in "Province" dropdown
  ...
  @Smoke @SrilankaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Srilanka for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Enter value for Bank Name "Bank of Sri Lanka"
    Then Select "Sri Lankan rupee (LKR)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Sri Lankan"
    And Wait for 2 seconds
    Then Enter value for Bank Account Number "1234567891234567123456"
    And Wait for 2 seconds
    ...
    Then Upload "PDF" document under Upload Document
    Then Click "Confirm" button
    Then Enter value for Bank Branch Name "Bank of Qatar"
    Then Enter value for Address "Rruga Frosina Plaku"
     Then Enter value for City " Tirana"
    Then Select "North" in "Province" dropdown
    Then Enter "12345" in "Postal Code" field
    ...
    Then Select "Sri Lanka" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Wait for 5 seconds
    Then Select "North" in "Province" dropdown section
  ...
  @Regression @SrilankaLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually in the range of 9 to 18 digits. This is a mandatory field" in add bank account page
    And Verify "Bank Key" tooltip of "Bank Account Code (Identifier) associated with the bank which is usually 7 digits (4 digits bank code + 3 digits branch code). If, in case, the branch code is less than 3 digits, fill it with preceding 0’s. This is a mandatory field" in add bank account page
    ...
    #And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 29 alphanumeric characters. Eg: QA58DOHB00001234567890ABCDEFG. This is an optional field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Province" tooltip of "Select the appropriate province from the dropdown. This is an optional field." in add bank account Factoring Company Address section
