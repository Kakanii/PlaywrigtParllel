Feature: CostaRica Localisation

  #CostaRicaLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @CostaRicaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Costa Rica with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select CostaRica from the dropdown
    Then Select "Costa Rica" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @CostaRicaLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Costa Rica" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Costa Rica" supplier registration
    Then Enter "TestCity" in "City" field after "Costa Rica" supplier registration
    Then Enter "4634-44" in "Postal Code" field after "Costa Rica" supplier registration
    Then Select "Alajuela" in "Province" dropdown
 ...
 @Smoke @CostaRicaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Costa Rica and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Costa Rica" is Pre populated with country
    ###Labels
    ...
    Then Show "VAT Registration Number" tooltip "VAT Registration Number as issued by the Costa Rica Tax Office and is usually 10 digits. This field is mandatory." under "Tax Details"
    Then Show "VAT Registration Document" tooltip "Attach your VAT Registration Document as issued by the Costa Rica Tax Office in the below mentioned formats. This is a mandatory attachment." under "Tax Details"
    ...
    Then Verify "The general partnership" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "The limited liability company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "The limited partnership" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "The stock corporation" is listed in "Business Type" dropdown under "Tax Details"
    ...
    ####Flag
    Then Verify "Costa Rica" flag Phone Number
    And Verify "Costa Rica" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+506 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+506 1234567890"
  ...
  #Then Enter "12345678901" in "D-U-N-S Number" field under "Tax Details"
    ...
    Then Verify "Costa Rica" is listed in "Country/Region" dropdown
    Then Select "Costa Rica" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+506 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+506 1234567000"
    ###Required Error
    ...
    Then Enter "@#$%" in "PO Box Postal Code" field
    Then Verify no data is entered in "PO Box Postal Code" field
    Then Enter "1234-56" in "PO Box Postal Code" field
    Then Enter "1234-56" in "Postal Code" field
    ...
    @Smoke @CostaRicaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Costa Rica and with questionnaire
    Then Enter data in Email Address field
 ...
 @Smoke @CostaRicaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Costa Rica and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @CostaRicaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Costa Rica and with out questionnaire with Additional Infromation
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @CostaricaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Costa Rica for existing supplier
    When Enter Costa Rica Supplier Email in Email Address field
    ...
    Then Select "Costa Rica" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Costa Rica"
    Then Select "Costa Rican Colon (CRC)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Costa Rica"
    ...
    Then Enter value for Bank Branch Name "Bank of Costa Rica"
  ...
  @Smoke @CostaricaLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Add Factoring Company Account with valid data for Country Costa Rica for existing supplier
    When Enter Costa Rica Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Costa Rica" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
