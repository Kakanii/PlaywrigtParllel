Feature: Bolivia Localisation
  ...
  @Smoke @BoliviaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Bolivia with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Bolivia from the dropdown
    Then Select "Bolivia" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @BoliviaLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Bolivia" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Bolivia" supplier registration
    Then Enter "TestCity" in "City" field after "Bolivia" supplier registration
    Then Enter "123456" in "Postal Code" field after "Bolivia" supplier registration
    Then Select "Beni" in "Department" dropdown
  ...
  @Smoke @BoliviaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Bolivia and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Bolivia" is Pre populated with country
    ###Labels
    ...
    Then Show "VAT Registration Number" tooltip "VAT Registration Number, also know as Numero de Identificacion Tributaria number or Tax Identification number as issued by the Bolivia Tax Office and is usually 7 to11 digits or 9 to13 alphanumeric characters. This field is mandatory." under "Tax Details"
    Then Show "VAT Registration Document" tooltip "Attach your VAT Registration Document as issued by the Bolivia Tax Office in the below mentioned formats. This is a mandatory attachment." under "Tax Details"
    ...
    ###Business types
    Then Verify "Accidental association or joint accounts" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Anonymous society" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Collective society" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Cooperative societies" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Limited partnership for shares" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Non profit Organization" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Simple limited partnership" is listed in "Business Type" dropdown under "Tax Details"
    ...
    ####Flag
    Then Verify "Bolivia" flag Phone Number
    And Verify "Bolivia" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+591 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+591 1234567890"
    ...
    Then Verify "Bolivia" is listed in "Country/Region" dropdown
    Then Select "Bolivia" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+591 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+591 1234567000"
    ###Required Error
    ...
    Then Enter "546546" in "Postal Code" field
...
@Smoke @BoliviaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Bolivia and with questionnaire
    Then Enter data in Email Address field
    ...
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    And Select "Government Entity" value from Business type dropdown
    And Enter number "1546457457545" in "Phone Number" in corporation details
    #Then Scroll to the top of the page
  ...
  @Smoke @BoliviaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Bolivia and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @BoliviaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Bolivia and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @BoliviaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Bolivia for existing supplier
    When Enter Bolivia Supplier Email in Email Address field
    ...
    Then Select "Bolivia" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Bolivia"
    Then Select "Bolivian Boliviano (BOB)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Bolivia"
    ...
    And Wait for 2 seconds
    And Enter value for Bank Key "123456789"
    ...
    Then Enter value for Bank Branch Name "Bank of Bolivia"
    ...
    Then Enter value for Postal Code "432664"
  ...
  @Smoke @BoliviaLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Add Factoring Company Account with valid data for Country Bolivia for existing supplier
    When Enter Bolivia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Bolivia" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Enter "434534" in "Postal Code" field under "Factoring Company Address" section
    Then Select "Beni" in "Department" dropdown on Factoring Company Address
