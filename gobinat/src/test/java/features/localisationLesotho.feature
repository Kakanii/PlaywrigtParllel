Feature: Lesotho Localisation
  ...
  @Smoke @LesothoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Lesotho with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Lesotho" in "Supplier Country of Registration" dropdown
  ...
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Lesotho from the dropdown
    Then Select "Lesotho" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Lesotho" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Lesotho" supplier registration
    Then Enter "TestCity" in "Place" field after "Lesotho" supplier registration
    Then Enter "123456" in "Postal Code" field after "Lesotho" supplier registration
    Then Select "Berea" in "District" dropdown
  ...
  @Smoke @LesothoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Lesotho and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Lesotho from teh dropdown
    Then Select "Lesotho" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Lesotho" is Pre populated with country
    ###Labels
    ...
    Then Show "Company Registration Number" tooltip " Company Registration Number which is  issued by office of the Registrar Companies (Registrar) at OBFC and is usually minimum 4 to maximum 20 alphanumeric characters . This is an optional field. " under "Tax Details"
    Then Show "Company Registration Document" tooltip " Attach your Certificate of Incorporation Document which is  issued by office of the Registrar Companies (Registrar) at OBFC. This is an optional attachment. " under "Tax Details"
    Then Show "Tax Identification Number" tooltip " Tax /VAT Registration Number issued by Lesotho Revenue Authority and is usually of 11 alphanumeric characters. This is a mandatory field. " under "Tax Details"
    Then Show "Tax Registration Document" tooltip " Attach your company's Certificate of Tax Registration issued by Ministry of Finance. This is a mandatory attachment. " under "Tax Details"
    ...
    ###Business types
    Then Verify "Business Trust" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Co-Operative" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "External Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Non-Profit Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Single Shareholding Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Sole Proprietorship" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Statutory Corporation" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Other" is listed in "Business Type" dropdown under "Tax Details"
    Then Select "Business Trust" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Scroll to view "Phone Number" field
    #Then Verify "Lesotho" flag in Phone Number field
    #And Verify "Lesotho" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+266 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+266 323213123555"
    ...
    Then Verify "Lesotho" is listed in "Country/Region" dropdown
    Then Select "Lesotho" in "Country/Region" dropdown
    Then Show "Place" Label
    Then Show "Place" input text field
    ...
    Then Verify "Place" input text field enabled
    ...
    # Flag
    #Then Verify "El Salvador" flag in Primary Phone field
    #And Verify "El Salvador" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+266 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+266 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Verify no data is entered in "PO Box Postal Code" field
    Then Enter "123" in "PO Box Postal Code" field
    Then Enter "124" in "Postal Code" field
    Then Enter "Berea" in "Place" field
    Then Select "Berea" in "District" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @LesothoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Lesotho and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @LesothoLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Lesotho with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @LesothoLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Lesotho with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @LesothoLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Lesotho for existing supplier
    ...
    Then Select "Lesotho" in "Country/Region" dropdown
    Then Enter "Lesotho Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Lesotho"
    Then Select "Lesotho loti (LSL)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Lesotho"
    And Wait for 2 seconds
    ...
    Then Enter value for City "Berea"
    Then Select "Berea" in "District" dropdown
    Then Enter value for Postal Code "275657765"
    Then Enter "123" in "PO Box" field
    Then Enter "123" in "PO Box Postal Code" field
  ...
  @Smoke @LesothoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Lesotho for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City "La Paz"
    Then Select "Berea" in "District" dropdown
    ...
    Then Select "Lesotho" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Berea" in "Place" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Berea" in "District" dropdown section
    Then Enter "456" in "Postal Code" field under "Factoring Company Address" section
    Then Enter "345" in "PO Box" field under "Factoring Company Address" section
    Then Enter "145" in "PO Box Postal Code" field under "Factoring Company Address" section
    Then Wait for 3 seconds
    Then Click "Save" button 6
    Then Wait for 3 seconds
    Then Click on Not now button
  ...
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually minimum 4 to maximum 35 digits. This is a mandatory field." in add bank account page
    And Verify "Bank Key" tooltip of "Bank Identification Number associated with the bank which is usually of 10 digits. This is a mandatory field." in add bank account page
    ...
    And Verify "Branch Code" tooltip of "Branch Code associated with the bank which is usualy of 6 digits. This is an optional field." in add bank account page
    ...
    And Verify "District" tooltip of "Name of the District at which it is located. This is a mandatory field." in add bank account page
    And Verify "Postal Code" tooltip of "The Postalcode of your company which usually of 3 digits. This is a mandatory field." in add bank account page
    And Verify "PO Box" tooltip of "The Post Office Box of your company which is usually 0 to 12 characters. This is an optional field." in add bank account page
    Then Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually of 3 digits. This is an optional field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Place" tooltip of "Name of the Place at which it is located. This is an optional field." in add bank account Factoring Company Address section
    And Verify "District" tooltip of "Name of the District at which it is located. This is a mandatory field." in add bank account Factoring Company Address section
    And Verify "Postal Code" tooltip of "The Postalcode of your company which usually of 3 digits. This is a mandatory field." in add bank account Factoring Company Address section
    And Verify "PO Box" tooltip of "The Post Office Box of your company which is usually 0 to 12 characters. This is an optional field." in add bank account Factoring Company Address section
    And Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually of 3 digits. This is an optional field." in add bank account Factoring Company Address section
