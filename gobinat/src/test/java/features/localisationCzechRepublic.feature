Feature: Czech Republic Localisation

  #CzechRepublicLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @CzechRepublicLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Czech Republic with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Czech Republic from the dropdown
    Then Select "Czech Republic" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @CzechRepublicLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Czech Republic" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Czech Republic" supplier registration
    Then Enter "TestCity" in "City" field after "Czech Republic" supplier registration
    Then Enter "43543" in "Postal Code" field after "Czech Republic" supplier registration
    Then Select "Central Bohemian" in "Region" dropdown
  ...
  @Smoke @CzechRepublicLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Czech Republic and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Czech Republic" is Pre populated with country
    ###Labels
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Company Registration Number" tooltip "Company identification number, also known as Identifikacne cislo, is issued by the Czech Statistical Office and is usually 8 digits. If, in case, the number is less than 8 digits, fill it with preceding 0’s.This is an optional field." under "Tax Details"
    Then Show "Certificate of Incorporation" tooltip "Attach your Company’s registration Document issued by the Czech Statistical Office in the below mentioned formats. This is optional attachment." under "Tax Details"
    Then Show "Tax Registration Number" tooltip "Danove identifikacni cislo also known as Vat or EU Vat registration Number and is issued by the Financni Sprava (Tax Office of Czech Republic). This is an optional field only for the suppliers whose annual revenue turnover is less than 1M CZK." under "Tax Details"
    Then Show "Tax Registration Document" tooltip "Attach your company's Certificate of Tax or Vat or EU Vat Registration issued by the Financni Sprava (Tax office of Czech Republic) in the below mentioned formats. This attachment is mandatory if the supplier has provided the Tax or Vat registration number." under "Tax Details"
    ...
    Then Verify "European Cooperative Society" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "European Economic Interest Grouping" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "European Joint Stock Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "General Commercial Partnership (Unlimited Partnership)" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "Co-operative" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    Then Verify "Czech Republic" flag Phone Number
    And Verify "Czech Republic" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+420 123 456 7890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+420 123 456 7890"
    ...
    Then Wait for 3 seconds
    Then Enter "5464565466" in "Company Registration Number" under "Tax Details" field
    Then Enter data in "Tax Registration Number" under "Tax Details"
    ...
    Then Verify "Czech Republic" is listed in "Country/Region" dropdown
    Then Select "Czech Republic" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+420 123 456 78"
    Then Enter phone number "12345600" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+420 123 456 00"
    ###Required Error
    ...
    Then Verify data entered in "Postal Code" field is "353 25"
    ...
    Then Verify data entered in "PO Box Postal Code" field is "345 43"
...
@Smoke @CzechRepublicLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Czech Republic and with questionnaire
    Then Enter data in Email Address field
    ...
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    And Select "Co-operative" value from Business type dropdown
    And Enter number "15464574577" in "Phone Number" in corporation details
    #Then Scroll to the top of the page
    And Enter number "1435346664" in "Fax Number" in corporation details
  ...
  @Smoke @CzechRepublicLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Czech Republic and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @CzechRepublicLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Czech Republic and with out questionnaire with Additional Infromation
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @CzechRepublicLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Czech Republic for existing supplier
    When Enter Czech Republic Supplier Email in Email Address field
    ...
    Then Select "Czech Republic" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Czech Republic"
    Then Select "Czech Koruna (CZK)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Czech Republic"
    ...
    Then Enter value for Bank Branch Name "Bank of Czech Republic"
  ...
  @Smoke @CzechRepublicLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Add Factoring Company Account with valid data for Country Czech Republic for existing supplier
    When Enter Czech Republic Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Czech Republic" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
