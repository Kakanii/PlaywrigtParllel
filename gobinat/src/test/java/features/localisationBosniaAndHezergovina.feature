Feature: Bosnia and Herzegovina Localisation

  #BosniaandHerzegovinaLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @BosniaandHerzegovinaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Bosnia and Herzegovina with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Bosnia and Herzegovina from the dropdown
    Then Select "Bosnia and Herzegovina" in "Supplier Country of Registration" dropdown
    ...
    @Smoke @BosniaandHerzegovinaLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
   ...
   #select Bosnia and Herzegovina from the dropdown
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Bosnia and Herzegovina" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Bosnia and Herzegovina" supplier registration
    Then Enter "TestCity" in "Locality" field after "Bosnia and Herzegovina" supplier registration
    Then Enter "87536" in "Postal Code" field after "Bosnia and Herzegovina" supplier registration
    ...
    @Smoke @BosniaandHerzegovinaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Bosnia and Herzegovina and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Bosnia and Herzegovina" is Pre populated with country
    ###Labels
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Company Registration Number" tooltip "Company Registration Number called as MBS issued by Court decision of registration into the court registry which is usually minimum 4 digits to 13 digits.Example: 1234567890123. This is an optional field." under "Tax Details"
    Then Show "Company Registration Document" tooltip "Attach your court decision of registration in the court registry in the below mentioned formats.This is an optional attachment." under "Tax Details"
    Then Show "Tax Registration Number" tooltip "Tax Registration Number called as PIB issued by Tax Bureau & Federal Bureau for Statistics and is usually 12 digits. This is a mandatory field." under "Tax Details"
    Then Show "Tax Registration Document" tooltip "Attach your Tax Registration Document as issued by Tax Bureau & Federal Bureau for Statistics in the below mentioned formats.This is a mandatory attachment." under "Tax Details"
    Then Show "VAT Registration Number" tooltip "VAT Registration Number called as PDV issued by the Indirect Taxation Authority of Bosnia and Herzegovina which can be usually from minimum 4 to maximum 20 characters. This is an optional field." under "Tax Details"
    Then Show "VAT Registration Document" tooltip "Attach your company's Certificate of VAT Registration in the below mentioned formats. This is an optional attachment." under "Tax Details"
    ...
    Then Verify "Unlimited Joint Liability Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    ####Flag
    Then Verify "Bosnia and Herzegovina" flag Phone Number
    And Verify "Bosnia and Herzegovina" flag Fax Number
    #Then Verify "Albania" flag in "Phone Number" field "us"
    #Then Verify "Albania" flag in "Fax Number" field "us"
    ###Phone number format
    Then Enter phone number "123456789" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+387 123456789"
    Then Enter phone number "123456789" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+387 123456789"
    ...
    Then Wait for 3 seconds
    Then Enter data on Company Registration Number in "Tax Details" field
    ...
    Then Verify "Bosnia and Herzegovina" is listed in "Country/Region" dropdown
    Then Select "Bosnia and Herzegovina" in "Country/Region" dropdown
    ...
    Then Enter phone number "123456789" in "Primary Phone" field
    Then Verify phone number "Primary Phone" is entered in accepted format "+387 123456789"
    Then Enter phone number "123456700" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+387 123456700"
    ###Required Error
    ...
    @Smoke @BosniaandHerzegovinaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Bosnia and Herzegovina and with questionnaire
    Then Enter data in Email Address field
    ...
    And Logout from the system
     ...
     @Smoke @BosniaandHerzegovinaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Bosnia and Herzegovina and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Logout from the system
     ...
     @Smoke @BosniaandHerzegovinaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Bosnia and Herzegovina and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    @Smoke @BosniaandHerzegovinaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Bosnia and Herzegovina for existing supplier
    ...
    Then Select "Bosnia and Herzegovina" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Bosnia and Herzegovina"
    Then Select "Bosnia and Herzegovina convertible mark (BAM)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Bosnia and Herzegovina"
    #Then Enter value for Bank Routing Number "23634795651"
    And Wait for 2 seconds
    #Then Enter value for Bank Account Number "5463543252525346"
    Then Enter input data in "Account Number" field
    And Wait for 2 seconds
    And Enter value for Bank Key "1234"
    And Enter value for Branch Code "123"
    And Enter value for National Check Digit "12"
    Then Enter "Testing" in Bank Desciption
    And Enter value for Bank Key "123"
    And Enter value for Branch Code "123"
    ...
    Then Enter value for Bank Branch Name "Bank of Bosnia and Herzegovina"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for Locality " Tirana"
    #Then Select "Finiq" in "Municipality" dropdown
    Then Enter value for Postal Code "32523"
    ...
    @Smoke @BosniaandHerzegovinaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Factoring Company Account with valid data for Country Bosnia and Herzegovina for existing supplier
    When Enter Bosnia and Herzegovina Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Bosnia and Herzegovina" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Tirana" in "Locality" field under "Factoring Company Address" section
    Then Enter "43543" in "Postal Code" field under "Factoring Company Address" section
