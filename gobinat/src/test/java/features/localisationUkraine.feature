Feature: Ukraine Localisation
  ...
  @Smoke @UkraineLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Ukraine with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Ukraine" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @UkraineLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Ukraine from the dropdown
    Then Select "Ukraine" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Ukraine" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Ukraine" supplier registration
    Then Enter "TestCity" in "City" field after "Ukraine" supplier registration
    Then Enter "12345678" in "Postal Code" field after "Ukraine" supplier registration
    Then Select "Sumy" in "Region" dropdown
  ...
  @Smoke @UkraineLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Ukraine and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Ukraine from teh dropdown
    Then Select "Ukraine" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Ukraine" is Pre populated with country
    ###Labels
    ...
    Then Show "Tax Number" label under "Tax Details"
    ...
    Then Show "Tax Number" input text field under "Tax Details"
    ...
    Then Verify "Tax Number" input text field enabled under "Tax Details"
    ...
    Then Show "Tax Number" tooltip " Tax Number, also known as EDRPOU or DRFO Number as issued the Ministry of Revenue of Ukraine and is usually in the following formats" under "Tax Details"
    Then Show "Tax Document" tooltip " Attach your Tax Document issued by Ministry of Revenue of Ukraine in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    ...
    Then Show error message "Required" under "Tax Number" field under "Tax Details"
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+380 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+380 323213123555"
    ...
    Then Enter "@#$%&" in "Tax Number" field under "Tax Details"
    Then Verify no data is entered in "Tax Number" field under "Tax Details"
    Then Enter "      " in "Tax Number" field under "Tax Details"
    Then Verify no data is entered in "Tax Number" field under "Tax Details"
    ...
    Then Enter random number in "Tax Number" field under "Tax Details"
    ...
    Then Verify "Ukraine" is listed in "Country/Region" dropdown
    Then Select "Ukraine" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+380 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+380 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
  ...
  @Smoke @UkraineLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Ukraine and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @UkraineLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Ukraine with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @UkraineLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Ukraine with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @UkraineLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Ukraine for existing supplier
    ...
    Then Select "Ukraine" in "Country/Region" dropdown
    Then Enter "Ukraine Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Ukraine"
    Then Select "Ukrainian hryvnia (UAH)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Ukraine"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of El Ukraine"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City "Lviv"
    Then Select "Lviv" in "Region" dropdown
  ...
  @Smoke @UkraineLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Ukraine for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Ukraine" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Wait for 5 seconds
    Then Select "Lviv" in "Region" dropdown section
  ...
  @Regression @UkraineLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account Number of the Bank account which is the last 19 digits of the IBAN number. If, in case, the account number is less than 19 digits, fill it with preceding 0’s. This field is mandatory." in add bank account page
    And Verify "Bank Key" tooltip of "Bank Key associated with the bank and is usually 6 digits. This field is mandatory." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "City" tooltip of "The name of the city, as mentioned in your Company's commercial registration certificate." in add bank account Factoring Company Address section
