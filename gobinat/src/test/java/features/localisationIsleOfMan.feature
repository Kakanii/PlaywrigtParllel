Feature: Isle of Man Localisation

  #IsleofManLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @IsleofManLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Isle of Man with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select IsleofMan from the dropdown
    Then Select "Isle of Man" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @IsleofManLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Isle of Man" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Isle of Man" supplier registration
    Then Enter "TestCity" in "Town" field after "Isle of Man" supplier registration
    Then Enter "IM5 465" in "Postal Code" field after "Isle of Man" supplier registration
    Then Select "Douglas" in "State" dropdown
  ...
  @Smoke @IsleofManLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Isle of Man and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
   ...
   #invite without questionare
    ...
    Then Verify Tax Country "Isle of Man" is Pre populated with country
    ###Labels
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Company Registration Number" tooltip "Declare your Company Registration Number issued by the Companies Registry in Isle of Man which usually consists of minimum 6 to maximum 8 numeric digit.  This is a mandatory field." under "Tax Details"
    Then Show "Company Registration Document" tooltip "Attach your Company Registration Document issued by the Companies Registry in Isle of Man in the below mentioned formats.This is mandatory attachment." under "Tax Details"
    Then Show "Tax Identification Number" tooltip "Declare your Tax Identification Number issued by Isle of Man Income Tax Division. Your Tax Identification Number is a 10-digit alphanumeric number that begins with a letter and is followed by six numbers and a two-digit suffix. The suffix is optional. For example, a valid Tax Identification Number is C123456-78 or C123456.. This is an optional field." under "Tax Details"
    Then Show "Tax Registration Document" tooltip "Attach your Tax Registration Certificate issued by the Isle of Man Income Tax Division in the below mentioned formats.This is an optional attachment." under "Tax Details"
    #Then Show "VAT Identification Number" tooltip "Declare your VAT identification number issued by the Isle of Man Treasury's Customs and Excise Division. Your VAT identification number is a 9-digit number that begins with the country code ("IM" for the Isle of Man), followed by six digits assigned sequentially to each company, and ending with a check digit. For example, a valid VAT identification number is IM1234567. This is an optional field." under "Tax Details"
    Then Show "VAT Registration Document" tooltip "Attach your VAT Registration Certificate issued by the Isle of Man Treasury's Customs and Excise Division in the below mentioned formats.This is an optional attachment." under "Tax Details"
    ...
    ####Flag
    Then Verify "Isle of Man" flag Phone Number
    And Verify "Isle of Man" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+44 (123) 456-7890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+44 (123) 456-7890"
    ...
    Then Wait for 3 seconds
    Then Enter data on Company Registration Number under "Tax Details" field
    Then Enter data VAT Identification Number "Tax Details" field
    Then Enter data for Tax Identification Number "Tax Details" field
    ...
    Then Verify "Isle of Man" is listed in "Country/Region" dropdown
    Then Select "Isle of Man" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+44 (123) 456-7890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+44 (123) 456-7000"
    ###Required Error
    ...
    #### Zip code
    Then Enter "IM5 635" in "Postal Code" field
    Then Verify data entered in "Postal Code" field is "IM5 635"
    ...
    Then Select "Douglas" in "State" dropdown
    ###PO Box Zip Code
    Then Enter "IM3 636" in "Po Box Postal Code" field
    Then Verify data entered in "Po Box Postal Code" field is "IM3 636"
    ...
    @Smoke @IsleofManLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Isle of Man and with questionnaire
    Then Enter data in Email Address field
    ...
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    And Select "Partnership" value from Business type dropdown
    And Enter number "1546457457547" in "Phone Number" in corporation details
    #Then Scroll to the top of the page
    And Enter number "143534664565" in "Fax Number" in corporation details
  ...
  @Smoke @IsleofManLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Isle of Man and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
 ...
 @Smoke @IsleofManLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Isle of Man and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @IsleofManLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Isle of Man for existing supplier
    When Enter Isle of Man Supplier Email in Email Address field
    ...
    Then Select "Isle of Man" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Isle of Man"
    Then Select "Manx pound (GBP)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Isle of Man"
    #Then Enter value for Bank Routing Number "23634795651"
    And Wait for 2 seconds
    #Then Enter value for Bank Account Number "12345678"
    Then Enter input data in "Account Number" field
    And Wait for 2 seconds
    And Enter value for Bank Key "34"
    ...
    Then Enter value for Bank Branch Name "Bank of Isle of Man"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Select "Douglas" in "State" dropdown
    Then Enter value for Town " Tirana"
    #Then Select "Finiq" in "Municipality" dropdown
    Then Enter value for Postal Code "IM4 364"
  ...
  @Smoke @IsleofManLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Add Factoring Company Account with valid data for Country Isle of Man for existing supplier
    When Enter Isle of Man Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Isle of Man" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Tirana" in "Town" field under "Factoring Company Address" section
    Then Enter "IM6 546" in "Postal Code" field under "Factoring Company Address" section
    Then Select "Castletown" in "State" dropdown under Factoring Company Address
