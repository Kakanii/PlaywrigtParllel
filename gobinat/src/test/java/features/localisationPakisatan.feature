Feature: Pakistan Localisation

  #PakistanLocalisation
    Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @PakistanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Pakistan with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Pakistan" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @PakistanLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Pakistan from the dropdown
    Then Select "Pakistan" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Pakistan" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Pakistan" supplier registration
    Then Enter "TestCity" in "City" field after "Pakistan" supplier registration
    Then Enter "12345" in "Postal Code" field after "Pakistan" supplier registration
    Then Select "Sind" in "Province" dropdown
  ...
  @Smoke @PakistanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Pakistan and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Pakistan from teh dropdown
    Then Select "Pakistan" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Enter "TestAddress2" in "Address Line 2" field after "Pakistan" supplier registration
    Then Enter "TestCity" in "City" field after "Pakistan" supplier registration
    Then Enter "123456" in "Postal Code" field after "Pakistan" supplier registration
    Then Select "Sind" in "Province" dropdown
    Then Click "Next" button
    Then Wait for 3 seconds
    Then Select the UNSPSC codes on the Basic information page
    ...
    Then Verify Tax Country "Pakistan" is Pre populated with country
    ###Labels
    ...
    Then Show "Tax Registration Number" tooltip " Tax Registration Number, also known as NTN/CNIC issued by the Pakistan Tax Office which is usually 8 or 13 digits. This field is mandatory. " under "Tax Details"
    Then Show "Tax Registration Document" tooltip " Attach your Tax Registration Document as issued by the Pakistan Tax Office in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    ...
    Then Verify "Private Limited" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Public Limited" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+92 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+92 323213123555"
    ...
    Then Verify "Pakistan" is listed in "Country/Region" dropdown
    Then Select "Pakistan" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+92 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+92 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
  ...
  @Smoke @PakistanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Pakistan and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @PakistanLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Pakistan with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @PakistanLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Pakistan with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @PakistanLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Pakistan for existing supplier
    ...
    Then Select "Pakistan" in "Country/Region" dropdown
    Then Enter "Pakistan Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Pakistan"
    Then Select "Pakistani rupee (PKR)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Pakistan"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Pakistan"
  ...
  Scenario: Add Factory Company Account with valid data for Country Pakistan for existing supplier
    ...
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City "Sind"
    Then Select "Sind" in "Province" dropdown
    ...
    Then Select "Pakistan" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Wait for 5 seconds
    Then Select "Sind" in "Province" dropdown section
  ...
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually in the range of 8 to18 digits. This is the last 12 digits of IBAN. This is a mandatory field" in add bank account page
    And Verify "Bank Key" tooltip of "Bank Account Code (Identifier) associated with the bank which is usually 4 alphanumeric characters. This is the 5th to 8th digits of IBAN number and the field is optional." in add bank account page
