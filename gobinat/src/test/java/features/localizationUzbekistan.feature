Feature: Uzbekistan Localisation

   #UzbekistanLocalisation
    Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @UzbekistanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Uzbekistan with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Uzbekistan" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @UzbekistanLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Uzbekistan from the dropdown
    Then Select "Uzbekistan" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Uzbekistan" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Uzbekistan" supplier registration
    Then Enter "TestCity" in "City" field after "Uzbekistan" supplier registration
    Then Enter "123456" in "Postal Code" field after "Uzbekistan" supplier registration
    Then Select "Tashkent" in "Region" dropdown
  ...
  @Smoke @UzbekistanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Uzbekistan and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Uzbekistan from teh dropdown
    Then Select "Uzbekistan" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Uzbekistan" is Pre populated with country
    ###Labels
    ...
    Then Show "Company Registration Number" tooltip " Business identification number issued by the Business register Department which is usually 4 to 20 alphanumeric characters. This is an optional field. " under "Tax Details"
    Then Show "Company Registration Document" tooltip " Attach your Company’s registration Document issued by the Registrar Generals Department in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    Then Show "VAT Registration Number" tooltip " VAT Registration Number issued by the Uzbekistan Tax Authority which is usually 9 alphanumeric characters. This is an optional field. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your company's Certificate of Tax Registration issued by the Uzbekistan Tax Authority in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+998 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+998 323213123555"
    ...
    Then Verify "Uzbekistan" is listed in "Country/Region" dropdown
    Then Select "Uzbekistan" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+998 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+998 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Enter "Tashkent" in "City" field
    Then Select "Tashkent" in "Region" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @UzbekistanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Uzbekistan and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @UzbekistanLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Uzbekistan with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Enter "TestAddress2" in "Address Line 2" field after "Uzbekistan" supplier registration
    Then Enter "TestCity" in "City" field after "Uzbekistan" supplier registration
    Then Enter "123457" in "Postal Code" field after "Uzbekistan" supplier registration
    Then Select "Tashkent" in "Region" dropdown
    Then Click "Next" button
    Then Wait for 3 seconds
    Then Select the UNSPSC codes on the Basic information page
  ...
  @Smoke @UzbekistanLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Uzbekistan with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Verify "Slovakia" flag in Phone Number field
    #And Verify "Slovakia" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+998 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
  ...
  @Smoke @UzbekistanLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Uzbekistan for existing supplier
    ...
    Then Select "Uzbekistan" in "Country/Region" dropdown
    Then Enter "Uzbekistan Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Uzbekistan"
    Then Select "Uzbekistani som (UZS)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Uzbekistan"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Uzbekistan"
  ...
  @Smoke @UzbekistanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Uzbekistan for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Uzbekistan" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Tashkent" in "City" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Tashkent" in "Region" dropdown section
  ...
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually minimum 4 to maximum 20 alphanumeric characters. This is a mandatory field." in add bank account page
    And Verify "Bank Key (Identifier)" tooltip of "Bank Account Code (Identifier) associated with the bank which is known as UZRN/Uzbekistan MFO Code which is usually 5 digits. This is a mandatory field." in add bank account page
    ...
    And Verify "Region" tooltip of "Name the Region at which it is located. This is an optional field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Region" tooltip of "Name the Region at which it is located. This is an optional field." in add bank account Factoring Company Address section
