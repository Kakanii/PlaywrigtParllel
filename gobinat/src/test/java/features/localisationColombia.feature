Feature: Colombia Localisation

  #ColombiaLocalisation
  Background: Login as Colombia supplier
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @ColombiaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Colombia with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
  ...
  @Smoke @colombiaLocalisation @Localisation @Supplier
  Scenario: Add basic info labels and tooltips, error validation, documents upload
    Then Enter "colombia12" email in Email Address field for Italy
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    Then Wait for 10 seconds
    ...
    Then Verify Tax Country "Colombia" is Pre populated with country
    ###Labels
    ...
    Then Show "Company Registration Number" tooltip "Company registration number as issued by the Colombia Chamber of Commerce and is usually in the range of 3 to 15 alphanumeric characters.This is an optional field." under "Tax Details"
    Then Show "Certificate of Incorporation" tooltip "Attach your Company’s registration document issued by the Chamber of Commerce in the below mentioned formats.This is optional attachment." under "Tax Details"
    Then Show "Tax Identification Number" tooltip "Tax Identification Number, also known as Número de Identificación Tributaria, is issued by the Directorate of National Taxes and Customs of Colombia and is usually 13 digits. Eg: 999.999.999-9. In Colombia, the Tax Identification Number is also known as VAT Registration Number.This is a mandatory field." under "Tax Details"
    Then Show "Tax Registration Document" tooltip "Attach your company's Certificate of Tax Registration issued by the Directorate of National Taxes and Customs of Colombia, in the below mentioned formats.This is mandatory attachment." under "Tax Details"
    #Then Show "Tax Identification Number" tooltip "VAT Registration Number issued by the Mauritius Tax Office and is usually 8 digits. This field is mandatory." under "Tax Details"
    #Then Show "Tax Registration Document" tooltip "Attach your VAT Registration Document issued by the Mauritius Tax Office in the below mentioned formats. This is a mandatory attachment." under "Tax Details"
    ...
    # Bussiness Type
    Then Verify "Corporation (Sociedad Anónima)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "General partnership (Sociedad Colectiva)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Government Entity" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Limited liability company (Sociedad de Responsabilidad ..." is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Limited partnership (Sociedad en Comandita Simple y por..." is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Non-Profit Organization" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Simplified stock company (Sociedad por Acciones Simplif..." is listed in "Business Type" dropdown under "Tax Details"
    ...
    # Flag
    Then Verify "Colombia" flag in "Phone Number" field "co"
    Then Verify "Colombia" flag in "Fax Number" field "co"
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+57 9876543210"
    Then Enter phone number "9876543210" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+57 9876543210"
    #Date calandar
    ...
    ##Error validation
    Then Enter "1A2B3C4D5E6F7G8" in "Company Registration Number" field under "Tax Details"
    Then Verify no error message is displayed under "Company Registration Number" field under "Tax Details"
    ...
    Then Enter "1234567890123456" in "Company Registration Number" field under "Tax Details"
    #Then Verify data entered in "Company Registration Number" field is "123456789012345" under "Tax Details"
    Then Verify no error message is displayed under "Company Registration Number" field under "Tax Details"
    ...
    Then Verify no data is entered in "Company Registration Number" field under "Tax Details"
    Then Verify no error message is displayed under "Company Registration Number" field under "Tax Details"
    Then Enter "123.456.789" in "Tax Identification Number" field under "Tax Details"
    Then Wait for 3 seconds
    Then Show error message "Invalid Tax Identification Number" under "Tax Identification Number" field under "Tax Details"
    Then Enter "123.456.789-12" in "Tax Identification Number" field under "Tax Details"
    Then Verify data entered in "Tax Identification Number" field is "123.456.789-1" under "Tax Details"
  ...
  Scenario: Verify Bank Account page for Colombia supplier
    Then Enter "colombia123" email in Email Address field for Italy
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Verify "Colombia" is listed in "Country/Region" dropdown
    ...
    Then Show "Department/Region" Label
    ...
    ###Tooltip
    And Verify "Bank Key" tooltip of "Bank Account Code (Identifier), also known as Codigo de compensacion internacional which is associated with the bank and is usually 3 digits.This field is mandatory." in add bank account page
    And Verify "Account Number" tooltip of "Account number of the Bank account, also known as Cuenta Number which is usually in the range of 6 to 18 digits.This field is mandatory." in add bank account page
    And Verify "Control Key" tooltip of "The Bank Control Key is a 2-digit number (01 for checking account (cuenta corriente) and 02 for saving account (cuenta ahorros)). This field is mandatory" in add bank account page
    ...
    And Verify "Department/Region" tooltip of "Name of the Department/Region at which it is located. This is a mandatory field." in add bank account page
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 6 digits. Eg: 110311. Either provide your postal code or leave it empty if postal code is not available." in add bank account page
    ...
    And Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually 6 digits. This field is optional." in add bank account page
    Then Click "Save" button 6
    #### Flag
    Then Verify "Colombia" flag in "Bank Contact Number" field "co"
    ##Phone Number
    Then Enter phone number "9876543210" in "Bank Contact Number" field
    Then Verify phone number "Bank Contact Number" is entered in accepted format "+57 9876543210"
    ##Required Fields
    Then Click "Save" button 6
    ...
    Then Show error message "Required" under "Department/Region" field under "Bank Address" section
  ...
  @Smoke @colombiaLocalisation @Localisation @Supplier @CDCI
  Scenario: Add "Factoring Company Account" with valid data for Country "colombia"
    ...
    Then Enter value for Bank Contact Name "bankingcontact"
    Then Enter value for Bank Contact Number "9886543210"
    Then Select "Amazonas" in the "factoringCompanyState" dropdown
  ...
  @Smoke @ColombiaLocalisation @Localisation @Publish @Supplier @CDCI
  ...
  @Smoke @ColombiaLocalisation @Localisation @Onboard @Supplier @CDCI
  Scenario: Verify Onboard Colombia supplier without questionnaires with diversty, addl info
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
