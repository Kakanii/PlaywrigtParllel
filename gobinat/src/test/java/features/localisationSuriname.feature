Feature: Suriname Localisation

  #SurinameLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @SurinameLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Suriname with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Suriname from the dropdown
    Then Select "Suriname" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @SurinameLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Suriname" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Suriname" supplier registration
    Then Enter "TestCity" in "City" field after "Suriname" supplier registration
    Then Enter "234253" in "Postal Code" field after "Suriname" supplier registration
    Then Select "Coronie" in "District" dropdown
  ...
  @Smoke @SurinameLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Suriname and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Suriname" is Pre populated with country
    ###Labels
    ...
    Then Show "VAT Registration Number" tooltip "VAT Registration Number, also known as Turnover Tax number (TOT) and is usually 8 alphanumeric characters and in the format SR123456. This is a mandatory field." under "Tax Details"
    ...
    ####Flag
    Then Verify "Suriname" flag Phone Number
    And Verify "Suriname" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+597 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+597 1234567890"
    ...
    Then Verify "Suriname" is listed in "Country/Region" dropdown
    Then Select "Suriname" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+597 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+597 1234567000"
    ###Required Error
    ...
    Then Select "Brokopondo" in "District" dropdown
    ###PO Box Zip Code
    ...
    Then Enter "@#$%" in "PO Box Postal Code" field
    Then Verify no data is entered in "PO Box Postal Code" field
    Then Enter "123845" in "PO Box Postal Code" field
    Then Enter "546560" in "Postal Code" field
    ...
    @Smoke @SurinameLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Suriname and with questionnaire
    Then Enter data in Email Address field
    ...
    And Enter number "1547457547455" in "Phone Number" in corporation details
    #Then Scroll to the top of the page
  ...
  @Smoke @SurinameLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Suriname and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @SurinameLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Suriname and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @SurinameLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Suriname for existing supplier
    ...
    Then Select "Suriname" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Suriname"
    Then Select "Surinamese Dollar (SRD)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Suriname"
    ...
    And Wait for 2 seconds
    And Enter value for Bank Key "12345678"
    ...
    Then Enter value for Bank Branch Name "Bank of Suriname"
  ...
  @Smoke @SurinameLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Factoring Company Account with valid data for Country Suriname for existing supplier
    When Enter Suriname Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Suriname" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Select "Brokopondo" in "District" dropdown on Factoring Company Address
