Feature: Egypt Localisation
  ...
  Scenario: I am able to search Exhibits Supplier on Connected Supplier page
    When Enter EmailAdress in Email Address field "rfwx7pfsnpvtltd@maildrop.cc"
    ...
    And Click on the radio button "YES" under "Are you a Diversity Supplier?"
    #Diversity category
    ...
    Then Wait for 5 seconds
    Then Verify "Disability: IN" is displyed under Diversity Category
    Then Verify "OTHER" is displyed under Diversity Category
    #Then Verify "Self Certified" is displyed under Diversity Category
    When Select "Disability: IN" from the Certifiers dropdown
    Then Wait for 3 seconds
    Then Logout from the system

  @Smoke @EgyptLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Egypt with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
  ...
  @Smoke @EgyptLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Eygpt and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @EgyptLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Egypt with out questionnaire and with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @EgyptLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Egypt with out questionnaire and with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @EgyptLocalisation @Supplier @BankAccount @QuickSanity @QuickCheck
  Scenario: Add Company Account with valid data for Country Egypt for existing supplier
    ...
    Then Enter value for Bank Name "Bank of Egypt"
    Then Select "Egyptian pound" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Egyptian"
    And Wait for 2 seconds
    When Enter Egypt Bank Code
    And Wait for 3 seconds
    And Enter Egypt Bank Account Number
    And Wait for 3 seconds
    And Enter Egypt Bank Swift Code
    And Wait for 3 seconds
    And Enter Egypt Bank IBAN
    And Wait for 3 seconds
    And Enter Egypt Bank IBAN Details
    And Wait for 3 seconds
    Then Select "Bank statement" in "Account Evidence" dropdown
    Then Click "Upload" button
    Then Upload "PDF" document under Upload Document
    Then Click "Confirm" button
    Then Enter value for Bank Branch Name "Bank of Egypt"
    Then Enter value for Address "Hilton Garden Inn"
    Then Enter value for District "Rana"
    Then Enter value for City " Tirana"
    Then Select "Giza" in "Region" dropdown
  ...
  Scenario: Add Factory Company Account with valid data for Country Egypt for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Egypt" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Enter "Cairo" in "City" field under "Factoring Company Address" section
    Then Enter "Cairo" in "District" field under "Factoring Company Address" section
    Then Wait for 9 seconds
    Then Select "Cairo" in "Region" dropdown under "Factoring Company Address" section
    Then Enter value for Factory Company Postal Code "6312"
    Then Wait for 3 seconds
    When Enter Factoring Company Contact Name for Egypt
    And Enter Factoring Company Contact Number for Egypt
    And Enter Factoring Company Email Address for Egypt
    Then Wait for 3 seconds
    Then Click "Save" button 6
    #And Click on the save in Address verification
    Then Wait for 3 seconds
  ...
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is minimum 4 to maximum 20 digits. This is a mandatory field." in add bank account page
    And Verify "Bank Code" tooltip of "Bank Identification Number associated with the bank and is usually 4 digits which is 5th,6th,7th,8th digits in IBAN. This is a mandatory field." in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 29 alphanumeric characters. Example: EG800002000156789012345180002.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    ...
    And Verify "Region" tooltip of "Select the appropriate region usually called as Governorate from the dropdown. This is a mandatory field." in add bank account page
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually of 4 or 5 digits. This is a mandatory field." in add bank account page
    ...
    Then Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually of 4 or 5 digits. This is an optional field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Region" tooltip of "Select the appropriate region usually called as Governorate from the dropdown. This is a mandatory field." in add bank account Factoring Company Address section
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually of 4 or 5 digits. This is a mandatory field." in add bank account Factoring Company Address section
    ...
    And Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually of 4 or 5 digits. This is an optional field." in add bank account Factoring Company Address section
