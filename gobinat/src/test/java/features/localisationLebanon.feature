Feature: Lebanon Localisation
  ...
  @Smoke @LebanonLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Lebanon with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Lebanon" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @LesothoLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Lebanon from the dropdown
    Then Select "Lebanon" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Click on Join Now Link in the "Lesotho" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Lebanon" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Lebanon" supplier registration
    Then Enter "TestCity" in "City" field after "Lebanon" supplier registration
    Then Enter "12345678" in "Postal Code" field after "Lebanon" supplier registration
    Then Select "South" in "Governorate" dropdown
  ...
  @Smoke @LebanonLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Lebanon and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Lebanon from teh dropdown
    Then Select "Lebanon" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    #maildrop
    Then Click on the email with subject "Trust Your Supplier" from maildrop
    Then Click on Join Now Link in the "El Salvador" supplier Email from maildrop
    Then Wait for 3 seconds
    Then Switch to "new TYS" tab
    #Verify Company page on registration
    #Vrify lables are displayed as expected
    ...
    Then Verify Tax Country "Lebanon" is Pre populated with country
    ###Labels
    ...
    Then Show "Company Registration Number" tooltip " Company Registration Number issued by the Lebanese Ministry of Justice which is usually minimum 4 to maxmimum 8 numeric digit. This is an optional field. " under "Tax Details"
    Then Show "Company Registration Document" tooltip " Attach your Company’s Registration Document issued by the Lebanese Ministry of Justice in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    Then Show "Tax Identification Number" tooltip " Tax Identification Number issued by the Ministry of Finance in Lebanon which is usually minimum 4 to maximum 20 digits.  This is a mandatory field " under "Tax Details"
    Then Show "Tax Registration Document" tooltip " Attach your company's Certificate of Tax Registration issued by the Ministry of Finance in Lebanon in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    Then Show "VAT Registration Number" tooltip " VAT Registration Number issued by the Ministry of Finance in Lebanon which is usually of 8 aplhanumeric characters. The VAT number format is Tax identification number (TIN), followed by the VAT number, for example, 1473-601. This is an optional field. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your company's Certificate of Vat Registration issued by the Ministry of Finance in Lebanon in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    ...
    ###Business types
    Then Verify "Commercial Representation" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Foreign Enterprise(Branch or Representative office)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Holding Companies" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Joint Stock Company(Société Anonyme Libanaise)-SAL" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Limited Liability Company(Société à Responsabilité Limi..." is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Offshore Companies" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Partnership (general or limited)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Other" is listed in "Business Type" dropdown under "Tax Details"
    Then Select "Commercial Representation" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Scroll to view "Phone Number" field
    #Then Verify "Lebanon" flag in Phone Number field
    #And Verify "Lebanon" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+961 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+961 323213123555"
    ...
    Then Verify "Lebanon" is listed in "Country/Region" dropdown
    Then Select "Lebanon" in "Country/Region" dropdown
    ...
    # Flag
    #Then Verify "Lebanon" flag in Primary Phone field
    #And Verify "Lebanon" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+961 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+961 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Verify data entered in "Postal Code" field is "123"
    ...
    Then Verify data entered in "PO Box Postal Code" field is "123"
    ...
    Then Enter "12443234" in "Postal Code" field
    Then Enter "North" in "City" field
    Then Select "North" in "Governorate" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @LebanonLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Lebanon and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    #maildrop
    Then Click on the email with subject "Trust Your Supplier" from maildrop
    Then Click on Join Now Link in the "Lebanon" supplier Email from maildrop
    Then Wait for 3 seconds
    Then Switch to "new TYS" tab
    #Enter data
    Then Enter timestamp in "Legal Business Name" field "Legal Business"
  ...
  @Smoke @LebanonLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Lebanon with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @LebanonLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Lebanon with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @LebanonLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Lebanon for existing supplier
    ...
    Then Select "Lebanon" in "Country/Region" dropdown
    Then Enter "Lebanon Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Lebanon"
    Then Select "Lebanese pound (LBP)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Lebanon"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of El Lesotho"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City "North"
    Then Select "North" in "Governorate" dropdown
    Then Enter value for Postal Code "275657765"
    Then Enter "1232" in "PO Box" field
    Then Enter "1232" in "PO Box Postal Code" field
  ...
  @Smoke @LebanonLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Lebanon for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Lebanon" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "North" in "City" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "North" in "Governorate" dropdown section
    Then Enter "4565" in "Postal Code" field under "Factoring Company Address" section
    Then Enter "3457" in "PO Box" field under "Factoring Company Address" section
    Then Enter "1456" in "PO Box Postal Code" field under "Factoring Company Address" section
    Then Wait for 3 seconds
    Then Click "Save" button 6
    Then Wait for 3 seconds
    Then Click on Not now button
  ...
  @Regression @LebanonLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually of 20 digits but can be variable. Please indicate the leading zero if applicable. This is a mandatory field." in add bank account page
    And Verify "Bank Key" tooltip of "Bank Account Code (Identifier) associated with the bank and it is 4 alphanumeric characters which is 5th,6th,7th digits in IBAN. This is an optional field" in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 28 alphanumeric. Example LB62099900000001001901229114. This is an optional field." in add bank account page
    ...
    And Verify "Postal Code" tooltip of "The Postalcode of your company which usually of 4 digits or 8 digits. This is a mandatory field." in add bank account page
    ...
    Then Verify "PO Box Postal Code" tooltip of "The Postal code of PO Box address which is usually of 4 or 8 digits. This is an optional field." in add bank account page
  ...
  @Regression @LesothoLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Postal Code" tooltip of "The Postalcode of your company which usually of 4 digits or 8 digits. This is a mandatory field." in add bank account Factoring Company Address section
    ...
    And Verify "PO Box Postal Code" tooltip of "The Postal code of PO Box address which is usually of 4 or 8 digits. This is an optional field." in add bank account Factoring Company Address section
