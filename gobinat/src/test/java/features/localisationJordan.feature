Feature: Jordan Localisation
  ...
  @Smoke @JordankLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Jordan with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Jordan from the dropdown
    Then Select "Jordan" in "Supplier Country of Registration" dropdown
    ...
    @Smoke @JordanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Jordan from teh dropdown
    Then Select "Jordan" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Click on Join Now Link in the "Jordan" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Jordan" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Jordam" supplier registration
    Then Enter "TestCity" in "City" field after "" supplier registration
    Then Enter "76733" in "Postal Code" field after "Jordan" supplier registration
    Then Select "Zarqa" in "Governorate" dropdown
    Then Enter "74546443" in "PO Box" field after "Jordan" supplier registration
    Then Enter "40001" in "PO Box Postal Code" field after "Jordan" supplier registration
    ...
    @Smoke @JordanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Jordan and with out questionnaire
    #Open buyer page
   Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Wait for 10 seconds
    Then Enter "TestAddress1" in "Address Line 1" field after "Jordan" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Jordan" supplier registration
    Then Enter "TestCity" in "City" field after "Jordan" supplier registration
    Then Enter "76733" in "Postal Code" field after "Jordan" supplier registration
    Then Select "Zarqa" in "Governorate" dropdown
    Then Enter "74546443" in "PO Box" field after "Jordan" supplier registration
    Then Enter "40001" in "PO Box Postal Code" field after "Jordan" supplier registration
    ...
    Then Verify Tax Country "Jordan" is Pre populated with country
    ###Labels
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Company Registration Number" tooltip " Business identification number issued by the Companies Registry of the Ministry of Trade and Industry which is usually 4 to 20 alphanumeric characters. This is an optional field. " under "Tax Details"
    Then Show "Company Registration Document" tooltip "Attach your Company’s Certificate of Registry issued by Companies Registry of the Ministry of Trade and Industry in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    Then Show "Tax Identification Number" tooltip "EIN/GST number issued by Income and Sales Tax Department (ISTD) and is usually of 7 digits. This is a mandatory field. " under "Tax Details"
    Then Show "Tax Registration Document" tooltip " Attach the EIN/GST registration document in the mentioned formats. This is an mandatory attachment." under "Tax Details"
    ...
    Then Verify "Limited Liability – One Person" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Limited Partnership" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Limited Partnership in Shares" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Public Shareholding" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Public Shareholding – One Person" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Jordan" flag in "Phone Number" field "jo"
    Then Verify "Jordan" flag in "Fax Number" field "jo"
    ###Phone number format
    Then Enter phone number "1546457457" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+962 1546457457"
    Then Enter phone number "1546457467" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+962 1546457467"
    ...
    Then Verify "Jordan" is listed in "Country/Region" dropdown
    Then Select "Jordan" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+962 4234242423423"
    Then Enter phone number "4234242423433" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+962 4234242423433"
    ###Required Error
    ...
    Then Show error message "Required" for "Governorate" field
    ### Error Validation
    ###Address 1
    ...
    Then Enter "Amman" in "Governorate" field
    ...
    Then Logout from the system
     ...
     @Smoke @JordanLocalisation @Localisation @Supplier @QuickSanity @QuickCheck 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Jordan and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
 ...
 Then Enter "     " in "City" field
    ...
    @Smoke @JordanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Jordan with out questionnaire and with Diversity
   ...
   Then Show "First Name" tooltip " The First Name of the contact person, as it appears on official government documents, such as a passport. This is a required field. Max length: 35 characters. "
    ...
    @Smoke @JordanLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Jordan with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
   ...
   Then Enter 150 digit alpha numeric data in "Address Line 1" field
    ...
    @Smoke @JordanLocalisation @Supplier @BankAccount @QuickSanity @QuickCheck 
  Scenario: Add Company Account with valid data for Country Jordan for existing supplier
    ...
    Then Select "Jordan" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Jordan"
    Then Select "Jordanian dinar (JOD)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Jordanian"
    #Then Enter value for Bank Routing Number "23634795651"
    And Wait for 2 seconds
    Then Enter value for Bank Account Number "123456789012345678"
    And Wait for 2 seconds
   ...
   #Then Enter "1234" in "Branch Code" field under "Bank Account Information"
    ...
    And Enter value for IBAN "JO94CBJO0010000000000131000302"
    ...
    Then Enter value for Bank Branch Name "Bank of Jordan"
    Then Enter value for Address "Hilton Garden Inn"
    Then Enter value for City "Tirana"
    Then Select "Amman" in "Governorate" dropdown
    ...
    @Smoke @JordabLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Jordan for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
   ...
   #Then Enter "1234" in "Branch Code" field under "Bank Account Information"
    ...
    Then Select "Jordan" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    @Regression @JordanLocalisation @Supplier @BankAccount @QuickSanity 
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually of 18 digits but can be variable. This is a mandatory field." in add bank account page
    And Verify "Bank Key" tooltip of "Bank Identification Number associated with the bank and is usually 4 alphanumeric characters which is 5th,6th,7th,8th digits in IBAN. This is an optional field." in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 30 alphanumeric characters.Example: JO94CBJO0010000000000131000302. This is an optional field." in add bank account page
    ...
    And Verify "Governorate" tooltip of "Name of the Governorate at which it is located. This is a mandatory field." in add bank account page
    ...
    And Verify "PO Box" tooltip of "The Post Office Box of your company which is usually 0 to 12 characters and called as Apartado Postal. This is an optional field." in add bank account page
