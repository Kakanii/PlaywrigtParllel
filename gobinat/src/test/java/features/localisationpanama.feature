Feature: Panama Localisation
  ...
  @Smoke @PanamaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Panama with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Panama" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @PanamaLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Panama from the dropdown
    Then Select "Panama" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Click on Join Now Link in the "Panama" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Panama" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Panama" supplier registration
    Then Enter "TestCity" in "Locality" field after "Panama" supplier registration
    Then Enter "123456" in "Postal Code" field after "Panama" supplier registration
    Then Select "Colon" in "Province" dropdown
  ...
  @Smoke @PanamaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Panama and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Panama from teh dropdown
    Then Select "Panama" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Panama" is Pre populated with country
    ###Labels
    ...
    Then Show "Company Registration Number" tooltip " Business Registration Number which is 13 digits and it is issued by the Public Registry, Section of Mercantile Office. This is an Optional field. " under "Tax Details"
    Then Show "Company Registration Document" tooltip " Attach your Business Registration Document issued by the Public Registry, Section of Mercantile Office in the below mentioned formats. This is an Optional attachment. " under "Tax Details"
    Then Show "Tax Identification Number" tooltip " Tax or VAT Identification Number usually known as RUC(Registry of Contributor) or ITBMS which is 13 digits and it is issued by Ministry of Finance. This is a Mandatory field. " under "Tax Details"
    Then Show "Tax Registration Document" tooltip " Attach your company's Certificate of Tax Registration or VAT Registration issued by the Main directorate of Income in the below mentioned formats. This is a Mandatory attachment. " under "Tax Details"
    ...
    ###Business types
    Then Verify "Civil Partnership" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Private Interest Foundation" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "Civil Partnership" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Scroll to view "Phone Number" field
    #Then Verify "Panama" flag in Phone Number field
    #And Verify "Panama" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+507 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+507 323213123555"
    ...
    Then Verify "Panama" is listed in "Country/Region" dropdown
    Then Select "Panama" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+507 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+507 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Enter "Colon" in "Locality" field
    Then Select "Colon" in "Province" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @PanamaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Panama and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @PanamaLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Panama with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Enter "TestAddress2" in "Address Line 2" field after "Panama" supplier registration
    Then Enter "TestCity" in "Locality" field after "Panama" supplier registration
    Then Enter "123457" in "Postal Code" field after "Panama" supplier registration
    Then Select "Colon" in "Province" dropdown
    Then Click "Next" button
    Then Wait for 3 seconds
    Then Select the UNSPSC codes on the Basic information page
  ...
  @Smoke @PanamaLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Panama with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @PanamaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Panama for existing supplier
    ...
    Then Select "Panama" in "Country/Region" dropdown
    Then Enter "Panama Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Panama"
    Then Select "Panamanian balboa (USD)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Panama"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Panama"
  ...
  @Smoke @PanamaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Panama for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Panama" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    #Then Enter "Colon" in "Locality" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Colon" in "Province" dropdown section
  ...
  @Regression @PanamaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Bank Key" tooltip of "Bank Identification Number associated with the bank, which is usually of 9 digits. This is a mandatory field." in add bank account page
    ...
    And Verify "Postal Code" tooltip of "The Postalcode of your company which usually of 4 digits. This is a mandatory field." in add bank account page
    And Verify "PO Box" tooltip of "The Post Office Box of your company which is usually 0 to 12 alphanumeric characters and called as Apartado. This is an optional field." in add bank account page
    Then Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually of 4 digits. This is an optional field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Locality" tooltip of "Name of the Locality at which it is located. This is an optional field." in add bank account page
    And Verify "Province" tooltip of "Name of the province or provincial level indigenous region at which it is located. This is an optional field." in add bank account page
    And Verify "Postal Code" tooltip of "The Postalcode of your company which usually of 4 digits. This is a mandatory field." in add bank account page    
    And Verify "PO Box" tooltip of "The Post Office Box of your company which is usually 0 to 12 alphanumeric characters and called as Apartado. This is an optional field." in add bank account page
    Then Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually of 4 digits. This is an optional field." in add bank account page
    ...
    And Verify "Province" tooltip of "Name of the province or provincial level indigenous region at which it is located. This is an optional field." in add bank account Factoring Company Address section
    And Verify "Postal Code" tooltip of "The Postalcode of your company which usually of 4 digits. This is a mandatory field." in add bank account Factoring Company Address section
    And Verify "PO Box" tooltip of "The Post Office Box of your company which is usually 0 to 12 alphanumeric characters and called as Apartado. This is an optional field." in add bank account Factoring Company Address section
    And Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually of 4 digits. This is an optional field." in add bank account Factoring Company Address section
