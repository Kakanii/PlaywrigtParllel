Feature: Guatemala Localisation

  #GuatemalaLocalisation
    Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @GuatemalaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Guatemala with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Guatemala" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @GuatemalaLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Guatemala from the dropdown
    Then Select "Guatemala" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Guatemala" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Guatemala" supplier registration
    Then Enter "TestCity" in "City" field after "Guatemala" supplier registration
    Then Enter "12345" in "Postal Code" field after "Guatemala" supplier registration
    Then Select "Jalapa" in "Department" dropdown
  ...
  @Smoke @GuatemalaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Guatemala and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Guatemala" is Pre populated with country
    ###Labels
    ...
    Then Show "VAT Registration Number" tooltip " The VAT registration number as issued by the Guatemala Tax Office which is usually in the range of 2 to 8 alphanumeric characters. This field is mandatory. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your VAT Registration Document issued by the Guatemala Tax Office in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    ...
    ###Business types
    Then Verify "Branch (Sucursal)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Government Entity" is listed in "Business Type" dropdown under "Tax Details"
    #Then Verify "Limited Liability Company (Sociedad de Responsabilidad Limitada)" is listed in "Business Type" dropdown under "Tax Details"
    Then Select "Non Profit Organization" value from Business type dropdown
    Then Verify "Public Limited Company (Sociedad Anónima)" is listed in "Business Type" dropdown under "Tax Details"
    ...
    #Then Verify "Guatemala" flag in Phone Number field
    #And Verify "Guatemala" flag in Fax Number field
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+502 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+502 323213123555"
    ...
    Then Verify no data is entered in "Company Registration Number" field under "Tax Details"
    #Then Wait for 3 seconds
    ############When Enter VAT Registration Number for Guatemala  under Tax Details
    ...
    Then Enter "C" followed by "" and 7 alphanumeric characters in "VAT Registration Number" field under "Tax Details"
    ...
    Then Verify "Guatemala" is listed in "Country/Region" dropdown
    Then Select "Guatemala" in "Country/Region" dropdown
    ...
    Then Show "Department" Label
    Then Show "Department" Dropdown
    ...
    Then Verify "Department" dropdown enabled
    ...
    # Flag
    #Then Verify "Guatemala" flag in Primary Phone field
    #And Verify "Guatemala" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+502 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+502 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Enter "12345" in "PO Box Postal Code" field
    Then Enter "12345" in "Postal Code" field
    Then Enter "Guatemala" in "City" field
    Then Select "Jalapa" in "Department" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @GuatemalaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Guatemala and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Guatemala from teh dropdown
    Then Select "Guatemala" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
  ...
  @Smoke @GuatemalaLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Guatemala with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @GuatemalaLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Guatemala with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @GuatemalaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Guatemala for existing supplier
    ...
    Then Select "Guatemala" in "Country/Region" dropdown
    Then Enter "Guatemala Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Guatemala"
    Then Select "Guatemalan quetzal (GTQ)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Guatemala"
    And Wait for 2 seconds
    Then Enter value for Bank Account Number "2299630862"
    And Enter value for Bank Key "22996"
    #Then Enter value for Control Key filed
    #Then Enter "12332" data in "Control key" field
    Then Enter value for Bank Account Number "2299630862121"
    And Enter value for Bank Key "22996"
    ...
    Then Select "Jalapa" in "Department" dropdown
    Then Enter value for Postal Code "27566"
    Then Enter "12345" in "PO Box" field
    Then Enter "12345" in "PO Box Postal Code" field
  ...
  Scenario: Add Factory Company Account with valid data for Country Azerbaijan for existing supplier
    ...
    And Enter value for Bank Key "2299"
    And Wait for 2 seconds
    And Enter value for Bank Swift Code "FDGFDHQK"
    #And Enter value for IBAN "KW4636353745865838373712345678"
    Then Enter value for Bank Account Number "1234567890123"
    ...
    Then Select "Guatemala" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Wait for 5 seconds
    Then Select "Jalapa" in "Department" dropdown section
    Then Enter "45678" in "Postal Code" field under "Factoring Company Address" section
    Then Enter "34567" in "PO Box" field under "Factoring Company Address" section
    Then Enter "14567" in "PO Box Postal Code" field under "Factoring Company Address" section
    Then Wait for 3 seconds
    Then Click "Save" button 6
    Then Wait for 3 seconds
    Then Click on Not now button
  ...
  @Regression @GuatemalaLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually in the range 10 to 20 digits. This is a mandatory field" in add bank account page
    And Verify "Bank Key" tooltip of "Bank Account Code (Identifier) associated with the bank which is usually 4 alphanumeric characters. This is a mandatory field." in add bank account page
    ...
    And Verify "Department" tooltip of "Select the appropriate department from the dropdown. This is an optional field." in add bank account page
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 5 digits. This is a mandatory field." in add bank account page
    ...
    Then Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually 5 digits. This is an optional field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Department" tooltip of "Select the appropriate department from the dropdown. This is an optional field." in add bank account Factoring Company Address section
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 5 digits. This is a mandatory field." in add bank account Factoring Company Address section
    ...
    And Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually 5 digits. This is an optional field." in add bank account Factoring Company Address section
