Feature: Greece Localisation
  ...
  @Smoke @GreeceLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Greece with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Greece from the dropdown
    Then Select "Greece" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @GreeceLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Greece" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Greece" supplier registration
    Then Enter "TestCity" in "City" field after "Greece" supplier registration
    Then Enter "12345" in "Postal Code" field after "Greece" supplier registration
    Then Select "Agia" in "Province" dropdown
   ...
   @Smoke @GreeceLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Greece and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
   ...
   #invite without questionare
    ...
    Then Verify Tax Country "Greece" is Pre populated with country
    ###Labels
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Business Identification Number" tooltip "The registry (Γ.Ε.ΜΗ.) number as per the General Electronic Commercial Registry and is usually 12 digits in the format 113047541111. If, in case, the Business ID number is less than 12 digits, fill it with preceding 0’s. Eg. 004657238957. This is an optional field." under "Tax Details"
    Then Show "Business Incorporation Document" tooltip "Attach your company's Certificate of Incorporation as verified by the Greek General Electronic Commercial Registry in the below mentioned formats. This is an optional field." under "Tax Details"
    Then Show "VAT Identification Number" tooltip "The Greek VAT Identification number is usually 11 alphanumeric characters in the format EL123456789 (EL + 9 digits).This is a mandatory field." under "Tax Details"
    Then Show "VAT Registration Document" tooltip "Attach your company's VAT Registration certificate in the below mentioned formats.This is a mandatory field." under "Tax Details"
    Then Show "EU VAT Identification Number" tooltip "The EU VAT Identification number is usually 11 alphanumeric characters in the format EL675432189 (EL + 9 digits).This is an optional field." under "Tax Details"
    Then Show "EU VAT Registration Document" tooltip "Attach your company's EU VAT Registration Document in the below mentioned formats.This is optional." under "Tax Details"
    ...
    Then Verify "Private Capital Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Societe Anonyme" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Other" is listed in "Business Type" dropdown under "Tax Details"
    Then Select "Societe Anonyme" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    Then Verify "Greece" flag Phone Number
    And Verify "Greece" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+30 12 3 456 7890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+30 12 3 456 7890"
    ...
    Then Wait for 3 seconds
    #Then Enter data on Business Identification Number in "Tax Details" field
    ...
    Then Verify "Greece" is listed in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+30 12 3 456 7890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+30 12 3 456 7000"
    ###Required Error
    ...
    #### Zip code
    Then Enter "35355" in "Postal Code" field
    Then Verify data entered in "Postal Code" field is "35355"
    ...
    ###PO Box Zip Code
    Then Enter "34545" in "PO Box Postal Code" field
    Then Verify data entered in "PO Box Postal Code" field is "34545"
    ...
    Then Enter "54655" in "Postal Code" field
    ...
    @Smoke @GreeceLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Greece and with questionnaire
    Then Enter data in Email Address field
    ...
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    And Select "Societe Anonyme" value from Business type dropdown
 ...
 @Smoke @GreeceLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Greece and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
 ...
 @Smoke @GreeceLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Greece and with out questionnaire with Additional Infromation
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @GreeceLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Greece for existing supplier
    When Enter Greece Supplier Email in Email Address field
    ...
    Then Select "Greece" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Greece"
    Then Select "Euro (EUR)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Greece"
    ...
    And Wait for 2 seconds
    And Enter value for Bank Key "1234567"
    ...
    Then Enter value for Bank Branch Name "Bank of Greece"
    ...
    Then Enter value for Postal Code "43236"
  ...
  @Smoke @GreeceLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Add Factoring Company Account with valid data for Country Greece for existing supplier
    When Enter Greece Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Greece" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Enter "43454" in "Postal Code" field under "Factoring Company Address" section
    Then Select "Agia" in "Province" dropdown on Factoring Company Address
