Feature: Ghana Localisation
  ...
  @Smoke @GhanaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Ghana with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Ghana from the dropdown
  ...
  @Smoke @GhanaLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Ghana" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Ghana" supplier registration
    Then Enter "TestCity" in "City" field after "Ghana" supplier registration
    Then Enter "46345" in "Postal Code" field after "Ghana" supplier registration
    Then Select "Ashanti" in "Region" dropdown
  ...
  @Smoke @GhanaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Ghana and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Ghana" is Pre populated with country
    ###Labels
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Company Registration Number" tooltip "Company registration number issued by the Registrar Generals Department which is usually 11 alphanumeric characters. This is optional field." under "Tax Details"
    Then Show "Company Registration Document" tooltip "Attach your Company’s registration Document issued by the Registrar Generals Department in the below mentioned formats.This is optional attachment." under "Tax Details"
    Then Show "Tax Registration Number" tooltip "Tax identification Number issued by the Ghana Revenue Authority which usually starts with C and it is 11 alphanumeric characters. This is Mandatory field." under "Tax Details"
    Then Show "Tax Registration Document" tooltip "Attach your company's Certificate of Tax Registration issued by the Ghana Revenue Authority in the below mentioned formats.This is Mandatory attachment." under "Tax Details"
    ...
    Then Select "Unlimited Liability Company" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    Then Verify "Ghana" flag Phone Number
    And Verify "Ghana" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+233 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+233 1234567890"
    ...
    Then Verify "Ghana" is listed in "Country/Region" dropdown
    Then Select "Ghana" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+233 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+233 1234567000"
    ###Required Error
    ...
    Then Select "Oti" in "Region" dropdown
    ###PO Box Zip Code
    ...
    Then Enter "@#$%" in "PO Box Postal Code" field
    #Then Verify no data is entered in "PO Box Postal Code" field
    Then Enter "12354" in "PO Box Postal Code" field
    Then Enter "12354" in "Postal Code" field
    ...
    Then Logout from the system
     ...
     @Smoke @GhanaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Ghana and with questionnaire
    Then Enter data in Email Address field
    ...
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    And Select "Unlimited Liability Company" value from Business type dropdown
  ...
  @Smoke @GhanaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Ghana and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @GhanaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Ghana and with out questionnaire with Additional Infromation
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @GhanaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Ghana for existing supplier
    When Enter Ghana Supplier Email in Email Address field
    ...
    Then Select "Ghana" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Ghana"
    Then Select "Ghanaian cedi (GHS)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Ghana"
    ...
    Then Enter value for Bank Branch Name "Bank of Ghana"
  ...
  @Smoke @GhanaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Factoring Company Account with valid data for Country Ghana for existing supplier
    When Enter Ghana Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Ghana" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
