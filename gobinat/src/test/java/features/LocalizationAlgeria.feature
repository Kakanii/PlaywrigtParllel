Feature: Algeria Localisation
  ...
  @Smoke @AlgeriaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Algeria with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Algeria from the dropdown
    Then Select "Algeria" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @AlgeriaLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Algeria" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Algeria" supplier registration
    #Then Enter "TestCity" in "City" field after "Algeria" supplier registration
    Then Enter "12345" in "Postal Code" field after "Algeria" supplier registration
    Then Select "Adrar" in "Province" dropdown
  ...
  @Smoke @MoldovaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Algeria and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Algeria" is Pre populated with country
    ###Labels
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Company Registration Number" tooltip "Company Registration Number which is issued by the Commercial Registry and it is minimum 4 to maximum 20  alphanumeric characters. This is an optional field." under "Tax Details"
    Then Show "Company Registration Document" tooltip "Attach your Company Registration Certificate issued by the Commercial Registry in the below mentioned formats. This is an optional attachment." under "Tax Details"
    Then Show "Tax Identification Number" tooltip "Tax or VAT Registration Number usually called as NIF(Numéro d’Identification Fiscal) issued by Tax Administration Algeria and it is minimum 15 to maximum 20 alphanumeric characters. This is a mandatory field." under "Tax Details"
    Then Show "Tax Registration Document" tooltip "Attach your company's Certificate of Existence issued by the Tax Administration Algeria in the below mentioned formats. This is a mandatory attachment." under "Tax Details"
    ...
    Then Verify "Joint Stock Company(SPA)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Limited Liability Company(SARL)" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "Partnership Limited by Shares" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    Then Verify "Algeria" flag Phone Number
    And Verify "Algeria" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+213 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+213 1234567890"
    ...
    Then Verify "Algeria" is listed in "Country/Region" dropdown
    Then Select "Algeria" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+213 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+213 1234567000"
    ###Required Error
    ...
    #### Zip code
    Then Enter "94654" in "Postal Code" field
    Then Verify data entered in "Postal Code" field is "94654"
    ...
    Then Select "Adrar" in "Province" dropdown
    ###PO Box Zip Code
    Then Enter "64650" in "PO Box Postal Code" field
    Then Verify data entered in "PO Box Postal Code" field is "64650"
    ...
    Then Enter "@#$%" in "PO Box Postal Code" field
    Then Verify no data is entered in "PO Box Postal Code" field
    Then Enter "94654" in "PO Box Postal Code" field
    Then Enter "94650" in "Postal Code" field
    ...
    @Smoke @AlgeriaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Algeria and with questionnaire
    Then Enter data in Email Address field
    ...
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    And Select "Partnership Limited by Shares" value from Business type dropdown
  ...
  @Smoke @MoldovaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Algeria and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @MoldovaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Algeria and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @AlgeriaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Algeria for existing supplier
    ...
    Then Select "Algeria" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Algeria"
    Then Select "Algerian Dinar (DZD)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Algeria"
    ...
    Then Enter value for Bank Branch Name "Bank of Algeria"
    ...
    Then Enter value for Postal Code "85646"
  ...
  @Smoke @AlgeriaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Factoring Company Account with valid data for Country Algeria for existing supplier
    When Enter Algeria Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Algeria" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Enter "75646" in "Postal Code" field under "Factoring Company Address" section
    Then Select "Adrar" in "Province" dropdown on Factoring Company Address
