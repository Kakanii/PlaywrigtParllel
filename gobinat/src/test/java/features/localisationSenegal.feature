Feature: Senegal Localisation
  ...
  @Smoke @SenegalLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Senegal with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Senegal" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @SenegalLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Senegal from the dropdown
    Then Select "Senegal" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Senegal" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Senegal" supplier registration
    Then Enter "TestCity" in "City" field after "Senegal" supplier registration
    Then Enter "12345" in "Postal Code" field after "Senegal" supplier registration
    Then Select "Dakar" in "Region" dropdown
  ...
  @Smoke @SenegalLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Senegal and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Senegal" is Pre populated with country
    ###Labels
    ...
    Then Show "VAT Registration Number" tooltip " VAT Registration Number as issued by the Senegal Tax Office and is usually 9 to 16 alphanumeric characters including hyphen and space. This is a mandatory field. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your VAT Registration Document as issued by the Senegal Tax Office in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    ...
    ###Business types
    Then Verify "Economic Interest Grouping (GIE)" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+221 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+221 323213123555"
    ...
    Then Verify "Senegal" is listed in "Country/Region" dropdown
    Then Select "Senegal" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+221 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+221 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
  ...
  @Smoke @SenegalLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Senegal and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @SenegalLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Senegal with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @SenegalLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Senegal with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Enter "12345" in "PO Box Postal Code" field
    Then Enter "12345" in "Postal Code" field
    Then Enter "Dakar" in "City" field
    Then Select "Dakar" in "Region" dropdown
    Then Click on "Save Contact" button
    Then Switch to the parent window
    #Then Close the modal
  ...
  @Smoke @SenegalLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Senegal for existing supplier
    ...
    Then Enter value for Bank Name "Bank of Senegal"
    Then Select "Paraguayan guaraní (PYG)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Senegal"
    And Wait for 2 seconds
  ...
  @Smoke @SenegalLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Senegal for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City "Dakar"
    Then Select "Dakar" in "Region" dropdown
    Then Enter "12345" in "Postal Code" field
    Then Enter "12345" in "PO Box" field
    Then Enter "12345" in "PO Box Postal Code" field
    ...
    Then Select "Senegal" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Wait for 5 seconds
    Then Select "Dakar" in "Region" dropdown section
  ...
  @Regression @SenegalLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Please provide your bank account/compte in this field which is usually 24 alphanumeric characters. This is a mandatory field." in add bank account page
    And Verify "Bank Key" tooltip of "Please provide the bank identification number in this field which is the first 10 digits of your bank account/ compte, starts with SN (e.g. 'SN10012345'). This is a mandatory field." in add bank account page
