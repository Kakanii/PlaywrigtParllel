Feature: Peru Localisation
  ...
  @Smoke @PeruLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Peru with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Peru" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @PeruLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Peru" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Peru" supplier registration
    Then Enter "TestCity" in "City" field after "Peru" supplier registration
    Then Enter "12345" in "Postal Code" field after "Peru" supplier registration
    Then Select "Ica" in "Region" dropdown
  ...
  @Smoke @PeruLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Peru and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Peru" is Pre populated with country
    ###Labels
    ...
    Then Show "VAT Registration Number" tooltip " VAT Registration Number as issued by the Peru Tax office and is usually 11 digits. This is an optional field. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your VAT Registration Document issued by the Peru Tax office in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    ...
    Then Verify "Closely Held Corporations (S.A.C.)" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Joint Stock Companies (S.A.)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Joint Venture" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Limited Liability Companies (S.R.L.)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Non Profit Organization" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Publicly Held Corporations (S.A.A.)" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+51 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+51 323213123555"
    ...
    #Then Enter "L" followed by "T" and 9 numbers in "EU VAT Registration Number" field under "Tax Details"
    ...
    Then Verify "Peru" is listed in "Country/Region" dropdown
    Then Select "Peru" in "Country/Region" dropdown
    ...
    # Flag
    #Then Verify "Peru" flag in Primary Phone field
    #And Verify "Peru" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+51 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+51 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
  ...
  @Smoke @PeruLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Peru and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @PeruLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Peru with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Verify "Lithuania" flag in Phone Number field
    #And Verify "Lithuania" flag in Fax Number field
    ###Phone number format
   Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+51 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
  ...
  @Smoke @PeruLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Peru with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @PeruLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Peru for existing supplier
    ...
    Then Select "Peru" in "Country/Region" dropdown
    Then Enter "Peru Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Peru"
    Then Select "Peruvian Sol (PEN)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Peru"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Peru"
  ...
  @Smoke @LithuaniaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Lithuania for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Peru" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Wait for 5 seconds
    Then Select "Ica" in "County/Region" dropdown section
  ...
  @Regression @LithuaniaLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually in the range of 8 to 20 digits. This field is mandatory." in add bank account page
