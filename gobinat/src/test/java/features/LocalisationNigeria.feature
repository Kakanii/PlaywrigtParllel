Feature: Nigeria Localisation
  ...
  @Smoke @NigeriaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Nigeria with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Nigeria" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @NigeriaLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Click on Join Now Link in the "Nigeria" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Nigeria" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Nigeria" supplier registration
    Then Enter "TestCity" in "City" field after "Nigeria" supplier registration
    Then Enter "123456" in "Postal Code" field after "Nigeria" supplier registration
    Then Select "Imo" in "State" dropdown
  ...
  @Smoke @NigeriaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Nigeria and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Nigeria from teh dropdown
    Then Select "Nigeria" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Nigeria" is Pre populated with country
    ###Labels
    ...
    Then Show "Company Registration Number" tooltip " Company registration number issued by the Corporate affairs commission which is usually 14 digits. This is an optional field. " under "Tax Details"
    Then Show "Company Registration Document" tooltip " Attach your Company’s registration Document issued by the Corporate affairs commission in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    Then Show "VAT Registration Number" tooltip " VAT Registration Number issued by the Nigeria Tax Authority which is 12 digits with hyphen. Eg: 01012345-0001. This is an optional field. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your company's Certificate of Vat Registration issued by the Nigeria Tax Authority in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    ...
    Then Verify "Company Limited by Shares" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "Company Limited by Guarantee" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Scroll to view "Phone Number" field
    #Then Verify "Nigeria" flag in Phone Number field
    #And Verify "Nigeria" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+234 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+234 323213123555"
    ...
    Then Verify "Nigeria" is listed in "Country/Region" dropdown
    Then Select "Nigeria" in "Country/Region" dropdown
    ...
    # Flag
    #Then Verify "Nigeria" flag in Primary Phone field
    #And Verify "Nigeria" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+234 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+234 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Enter "Edo" in "City" field
    Then Select "Edo" in "State" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @NigeriaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Nigeria and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    #maildrop
    Then Click on the email with subject "Trust Your Supplier" from maildrop
    Then Click on Join Now Link in the "Uzbekistan" supplier Email from maildrop
    Then Wait for 3 seconds
    Then Switch to "new TYS" tab
    #Enter data
    Then Enter timestamp in "Legal Business Name" field "Legal Business"
   ...
   ############When Enter Tax Registration Number for Mozambique  under Tax Details
    ...
    Then Enter "@#$%" in "PO Box Postal Code" field
    Then Verify no data is entered in "PO Box Postal Code" field
    Then Enter "123451" in "PO Box Postal Code" field
    Then Enter "123452" in "Postal Code" field
    Then Enter "Edo" in "City" field
    Then Select "Edo" in "State" dropdown
    Then Click on "Save Contact" button
    Then Switch to the parent window
  ...
  @Smoke @NigeriaLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Nigeria with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Enter "TestAddress2" in "Address Line 2" field after "Nigeria" supplier registration
    Then Enter "TestCity" in "City" field after "Nigeria" supplier registration
    Then Enter "123457" in "Postal Code" field after "Nigeria" supplier registration
    Then Select "Imo" in "State" dropdown
    Then Click "Next" button
    Then Wait for 3 seconds
    Then Select the UNSPSC codes on the Basic information page
    ...
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Verify "Uzbekistan" flag in Phone Number field
    #And Verify "Uzbekistan" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+234 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
   ...
   #### Postal Code
    ...
    Then Verify no data is entered in "PO Box Postal Code" field
    Then Enter "123456" in "PO Box Postal Code" field
    Then Enter "123458" in "Postal Code" field
    Then Enter "Edo" in "City" field
    Then Select "Edo" in "State" dropdown
    Then Click on "Save Contact" button
    Then Switch to the parent window
  ...
  @Smoke @NigeriaLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Nigeria with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @NigeriaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Nigeria for existing supplier
    ...
    Then Select "Nigeria" in "Country/Region" dropdown
    Then Enter "Nigeria Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Nigeria"
    Then Select "Nigerian naira (NGN)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Nigeria"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Nigeria"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City "Imo"
    Then Select "Imo" in "State" dropdown
  ...
  @Smoke @NigeriaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Nigeria for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City " Tashkent"
    Then Select "Imo" in "State" dropdown
    ...
    Then Select "Nigeria" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Imo" in "City" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Imo" in "State" dropdown section
  ...
  @Regression @UzbekistanLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Bank Key (Identifier)" tooltip of "Bank Account Code (Identifier) associated with the bank and it is 9 digits which is also known as sort code. This is a mandatory field." in add bank account page
    ...
    And Verify "State" tooltip of "Name the state at which it is located. This is an optional field." in add bank account page
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 6 digits. This is a mandatory field." in add bank account page
    ...
    Then Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually 6 digits. This is an optional field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Address Line 2" tooltip of "Continue Street name, House/Building, Neighbourhood or Block number. Max Length: 100 characters. This is an optional field." in add bank account Factoring Company Address section
    ...
    And Verify "State" tooltip of "Name the state at which it is located. This is an optional field." in add bank account Factoring Company Address section
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 6 digits. This is a mandatory field." in add bank account Factoring Company Address section
    ...
    And Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually 6 digits. This is an optional field." in add bank account Factoring Company Address section
