Feature: Uruguay Localisation
  ...
  @Smoke @UruguayLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Uruguay with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Uruguay" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @UruguayLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Uruguay from the dropdown
    Then Select "Uruguay" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Click on Join Now Link in the "Uruguay" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Uruguay" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Uruguay" supplier registration
    Then Enter "TestCity" in "City" field after "Uruguay" supplier registration
    Then Enter "12345678" in "Postal Code" field after "Uruguay" supplier registration
    Then Select "Salto" in "Department/Region" dropdown
  ...
  @Smoke @UruguayLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Uruguay and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Uruguay from teh dropdown
    Then Select "Uruguay" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    #maildrop
    Then Click on the email with subject "Trust Your Supplier" from maildrop
    Then Click on Join Now Link in the "Ukraine" supplier Email from maildrop
    Then Wait for 3 seconds
    Then Switch to "new TYS" tab
    #Verify Company page on registration
    #Vrify lables are displayed as expected
    ...
    Then Verify Tax Country "Uruguay" is Pre populated with country
    ###Labels
    ...
    Then Show "VAT Registration Number" tooltip " VAT Registration Number, also known as Registro Unico Tributario number as issued by the Uruguay Tax Office and is usually12 digits. This field is mandatory. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your VAT Registration Document as issued by the Uruguay Tax Office in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+598 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+598 323213123555"
    ...
    Then Verify "Uruguay" is listed in "Country/Region" dropdown
    Then Select "Uruguay" in "Country/Region" dropdown
    ...
    Then Show "Department/Region" Dropdown
    ...
    Then Verify "Department/Region" dropdown enabled
    ...
    # Flag
    #Then Verify "Uruguay" flag in Primary Phone field
    #And Verify "Uruguay" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+598 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+598 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Show error message "Required" for "Department/Region" field
    Then Enter "1234" in "PO Box" field
    Then Enter 79 digit alpha numeric data in "Address Line 1" field
    ...
    Then Enter "12443" in "Postal Code" field
    Then Enter "Rocha" in "City" field
    Then Select "Rocha" in "Department/Region" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @UruguayLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Uruguay and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @UruguayLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Uruguay with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @UruguayLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Uruguay with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @UruguayLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Uruguay for existing supplier
    ...
    Then Select "Uruguay" in "Country/Region" dropdown
    Then Enter "Uruguay Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Uruguay"
    Then Select "Uruguayan Peso (UYU)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Uruguay"
    And Wait for 2 seconds
    ...
    Then Enter "12321" in "PO Box Postal Code" field
  ...
  @Smoke @UruguayLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Uruguay for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Enter "1234" in "PO Box" field
    Then Enter "12342" in "PO Box Postal Code" field
    Then Enter value for Bank Contact Name "bankingcontact"
    Then Enter value for Bank Contact Number "9886543210"
    # Then Wait for 3 seconds
    Then Wait for 3 seconds
    Then Enter "IT People Corp" in "Factoring Company Name" field under "Factoring Company Info" section
    Then Select "Uruguay" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Rocha" in "City" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Rocha" in "Department/Region" dropdown section
    Then Enter "45651" in "Postal Code" field under "Factoring Company Address" section
    Then Enter "3457" in "PO Box" field under "Factoring Company Address" section
    Then Enter "14561" in "PO Box Postal Code" field under "Factoring Company Address" section
    Then Wait for 3 seconds
    Then Click "Save" button 6
    Then Wait for 3 seconds
    Then Click on Not now button
  ...
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually in the range of 4 to 18 digits. This is a mandatory field" in add bank account page
    And Verify "Bank Key" tooltip of "Bank Account Code (Identifier) associated with the bank which is usually 3 digits. This is a mandatory field" in add bank account page
    ...
    And Verify "Department/Region" tooltip of "Select the appropriate department/region from the dropdown. This is a mandatory field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Department/Region" tooltip of "Select the appropriate department/region from the dropdown. This is a mandatory field." in add bank account Factoring Company Address section
