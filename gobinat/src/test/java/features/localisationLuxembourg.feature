Feature: Luxembourg Localisation

  #LuxembourgLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @LuxembourgLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Luxembourg with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Luxembourg from the dropdown
    Then Select "Luxembourg" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @LuxembourgLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
   ...
   #select Luxembourg from the dropdown
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Luxembourg" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Luxembourg" supplier registration
    Then Enter "TestCity" in "City" field after "Luxembourg" supplier registration
    Then Enter "L-4353" in "Postal Code" field after "Luxembourg" supplier registration
    Then Select "Capellen" in "Canton" dropdown
  ...
  @Smoke @LuxembourgLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Luxembourg and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Luxembourg" is Pre populated with country
    ###Labels
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Company Registration Number" tooltip "Company registration number issued by the Luxembourg Trade and Companies Register, which is companies registry in Luxembourg. This is in the range of 3 to 15 alphanumeric characters and is an optional field." under "Tax Details"
    Then Show "Certificate of Incorporation" tooltip "Attach your Company’s Registration Document issued by the Luxembourg Trade and Companies Register in the below mentioned formats. This is an optional attachment." under "Tax Details"
    Then Show "Tax Identification Number" tooltip "Tax Identification Number, also known as National Identifier (for entities), is issued by the Luxembourg Tax office. This is usually 11 digits and is a mandatory field." under "Tax Details"
    ...
    Then Show "VAT Registration Number" tooltip "VAT registration Number as issued by the Luxembourg Tax Office and in the format LU12345678. This is an optional field." under "Tax Details"
    ...
    Then Show "EU VAT Registration Number" tooltip "EU VAT registration Number as issued by the Luxembourg Tax Office and in the format LU12345678. This is an optional field." under "Tax Details"
    ...
    ###Required Fields
    Then Enter number "6918765432" in "Phone Number" in corporation details
    ...
    ###Business types
    Then Verify "Branch or Subsidiaries" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Company limited by shares(SCA)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Cooperative society (CS)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Cooperative society functioning as a SA (COOPSA)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "General Partnership (SNC)" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Limited liability company (GmbH)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Limited partnership (SCS)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Non-Profit Organization" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Private Limited liability company (SARL)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Public Limited liability company (SA)" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "Branch or Subsidiaries" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    Then Verify "Luxembourg" flag Phone Number
    And Verify "Luxembourg" flag Fax Number
    #Then Verify "Albania" flag in "Phone Number" field "us"
    #Then Verify "Albania" flag in "Fax Number" field "us"
    ###Phone number format
    Then Enter phone number "12345678" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+352 611 234 5678"
    Then Enter phone number "12345678" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+352 611 234 5678"
    ...
    Then Wait for 3 seconds
    Then Enter "5464565466" in "Company Registration Number" under "Tax Details"
    Then Enter "33526925435" in "Tax Identification Number" under "Tax Details"
    Then Enter data in VAT Registration Number field under "Tax Details"
    Then Enter data in EU VAT Registration Number field under "Tax Details"
    ...
    Then Verify "Luxembourg" is listed in "Country/Region" dropdown
    Then Select "Luxembourg" in "Country/Region" dropdown
    ...
    Then Show "Canton" Label
    Then Show "Canton" Dropdown
    ...
    Then Verify "Canton" dropdown enabled
    ...
    Then Enter phone number "12345678" in "Primary Phone" field
    Then Verify phone number "Primary Phone" is entered in accepted format "+352 611 234 5678"
    Then Enter phone number "12345000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+352 611 234 5000"
    ###Required Error
    ...
    #Then Show error message "Required" for "Canton" field
    ...
    Then Enter "@#$%" in "PO Box Postal Code" field
    Then Verify no data is entered in "PO Box Postal Code" field
    Then Enter "L-6767" in "PO Box Postal Code" field
    ...
    @Smoke @LuxembourgLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Luxembourg and with questionnaire
    Then Enter data in Email Address field
    ...
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    And Select "Branch or Subsidiaries" value from Business type dropdown
  ...
  @Smoke @LuxembourgLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Luxembourg and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @LuxembourgLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Luxembourg for existing supplier
    When Enter Luxembourg Supplier Email in Email Address field
    ...
    Then Select "Luxembourg" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Luxembourg"
    Then Select "Euro (EUR)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Luxembourg"
    #Then Enter value for Bank Routing Number "23634795651"
    And Wait for 2 seconds
    #Then Enter value for Bank Account Number "5463543252525"
    Then Enter input data in "Account Number" field
    And Wait for 2 seconds
    And Enter value for Bank Key "1456728"
    ...
    Then Enter value for Bank Branch Name "Bank of Luxembourg"
    ...
    Then Enter value for Postal Code "L-5456"
  ...
  @Smoke @LuxembourgLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Add Factoring Company Account with valid data for Country Luxembourg for existing supplier
    When Enter Luxembourg Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Luxembourg" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Enter "L-5657" in "Postal Code" field under "Factoring Company Address" section
