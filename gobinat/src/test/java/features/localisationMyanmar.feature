Feature: Myanmar Localisation
  ...
  @Smoke @MyanmarLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is Myanmar with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select Myanmar from the dropdown
    Then Select "Myanmar" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @MyanmarLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Myanmar" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Myanmar" supplier registration
    Then Enter "TestCity" in "City" field after "Myanmar" supplier registration
    Then Enter "12345" in "Postal Code" field after "Myanmar" supplier registration
    Then Select "Bago" in "District" dropdown
 ...
 @Smoke @MyanmarLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Myanmar and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Myanmar" is Pre populated with country
    ###Labels
    ...
    Then Show "VAT Registration Number" tooltip "VAT Registration Number, also know as Taxpayer Identification Number (TIN) as issued by IRD and is usually in the range of 9 to 13 digits. This field is mandatory." under "Tax Details"
    Then Show "VAT Registration Document" tooltip "Attach your VAT Registration Document as issued by IRD in the below mentioned formats. This is a mandatory attachment." under "Tax Details"
    ...
    ###Business types
    Then Verify "Branch Registered Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Government Entity" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Joint Venture Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Representative Office Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    ####Flag
    Then Verify "Myanmar" flag Phone Number
    And Verify "Myanmar" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+95 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+95 1234567890"
    ...
    Then Wait for 3 seconds
    Then Enter data VAT Registration Number under Tax Details field for Myanmar country
    ###Document uploads
    ...
    Then Verify "Myanmar" is listed in "Country/Region" dropdown
    Then Select "Myanmar" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+95 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+95 1234567000"
    ###Required Error
    ...
    @Smoke @MyanmarLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Myanmar and with questionnaire
    Then Enter data in Email Address field
  ...
  @Smoke @MyanmarLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Myanmar and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @MyanmarLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Myanmar and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @MyanmarLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Myanmar for existing supplier
    When Enter Myanmar Supplier Email in Email Address field
    ...
    Then Select "Myanmar" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Myanmar"
    Then Select "Burmese Kyat (MMK)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Myanmar"
    ...
    Then Enter value for Bank Branch Name "Bank of Myanmar"
  ...
  @Smoke @MyanmarLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Factoring Company Account with valid data for Country Myanmar for existing supplier
    When Enter Myanmar Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Myanmar" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Select "Bago" in "District" dropdown on Factoring Company Address
