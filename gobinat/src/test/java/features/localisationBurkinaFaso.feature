Feature: Burkina Faso Localisation

   #BurkinaFasoLocalisation
    Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @BurkinaFasoLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is BurkinaFaso with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Burkina Faso" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @BurkinaFasoLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Burkina Faso" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Burkina Faso" supplier registration
    Then Enter "TestCity" in "City" field after "Burkina Faso" supplier registration
    Then Enter "12345" in "Postal Code" field after "Burkina Faso" supplier registration
  ...
  @Smoke @BurkinaFasoLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is BurkinaFaso and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Burkina Faso" is Pre populated with country
    ###Labels
    ...
    Then Show error message "Required" under "Taxpayer Number (IFU)" field under "Tax Details"
    ...
    #Then Verify "Burkina Faso" flag in Phone Number field
    #And Verify "Burkina Faso" flag in Fax Number field
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+226 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+226 323213123555"
    ...
    Then Verify "Burkina Faso" is listed in "Country/Region" dropdown
    ...
    # Flag
    #Then Verify "Burkina Faso" flag in Primary Phone field
    #And Verify "Burkina Faso" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+226 323213123555"
    Then Enter phone number "323213123555" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+226 323213123555"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Enter "1234" in "PO Box Postal Code" field
    Then Enter "1234" in "Postal Code" field
    Then Enter "Burkina Faso" in "City" field
    Then Select "Bale" in "Province/Region" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @BurkinaFasoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is BurkinaFaso and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Verify phone number "Secondary Phone" is entered in accepted format "+226 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    Then Enter 150 digit alpha numeric data in "Address Line 1" field
  ...
  @Smoke @BurkinaFasoLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is BurkinaFaso with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @BurkinaFasoLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is BurkinaFaso with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @BurkinaFasoLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country BurkinaFaso for existing supplier
    ...
    Then Select "Burkina Faso" in "Country/Region" dropdown
    Then Enter "Burkina Faso Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Burkina Faso"
    Then Select "Burmese Kyat (MMK)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Burkina Faso"
    And Wait for 2 seconds
    Then Enter input data in "Account Number" field
    Then Enter input data in "Bank Key" field
    And Enter value for Bank Key "BF12345677"
    ...
    Then Enter value for Bank Branch Name "Bank of Burkina Faso"
  ...
  @Smoke @BurkinaFasoLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country BurkinaFaso for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
   ...
   And Enter value for Bank Key "BF12345677"
    ...
    Then Select "Burkina Faso" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Wait for 5 seconds
    Then Select "Bale" in "Province/Region" dropdown section
    ...
    Then Enter "4567" in "PO Box Postal Code" field under "Factoring Company Address" section
    Then Wait for 3 seconds
    Then Click "Save" button 6
    Then Wait for 3 seconds
    Then Click on Not now button
  ...
  @Regression @BurkinaFasoLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account Number of the Bank account which is usually in the range of 10 to 14 digits. This field is mandatory." in add bank account page
    And Verify "Bank Key" tooltip of "Bank Key associated with the bank and is usually 10 digits ('BF' + 8 digits numeric).This field is mandatory." in add bank account page
    And Verify "Control key" tooltip of "The Bank Control Key is a 2-digit number. This field is mandatory." in add bank account page
    ...
    And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 28 alphanumeric characters.Example:BF42BF0840101300463574000390.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    ...
    And Verify "Province/Region" tooltip of "Select the appropriate provinces/region from the dropdown. This is an optional field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Province/Region" tooltip of "Select the appropriate provinces/region from the dropdown. This is an optional field." in add bank account Factoring Company Address section
