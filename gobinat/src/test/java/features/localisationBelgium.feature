Feature: Belgium Localisation
  ...
  @Smoke @BelgiumLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Belgium with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Belgium" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @BelgiumLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Click on Join Now Link in the "Belgium" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Belgium" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Belgium" supplier registration
    Then Enter "TestCity" in "City" field after "Belgium" supplier registration
    Then Enter "7673" in "Postal Code" field after "Belgium" supplier registration
    Then Select "Limburg" in "Province" dropdown
  ...
  @Smoke @BelgiumLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Belgium and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Belgium" is Pre populated with country
    ###Labels
    ...
    Then Show "Company Registration Number" tooltip " Company Enterprise number issued by the Belgium Business Register of Belgium Chamber of Commerce and is usually 10 alphanumeric characters. This is an optional field. " under "Tax Details"
    Then Show "Company Registration Document" tooltip "  Attach your Company registration document as issued by the Belgium Company Registry in the below mentioned format’s. This is an optional field. " under "Tax Details"
    Then Show "Tax Identification Number" tooltip " Tax Identification Number which is known as Numero D Enterprise as issued by the General administration of Taxes. It is usually 10-digit number. " under "Tax Details"
    ...
    Then Show "VAT Registration Number" tooltip " VAT registration Number issued by the General Administration of Taxes in the format BE0123456789. This is an optional field. " under "Tax Details"
    ...
    Then Show "EU VAT Registration Number" tooltip " EU VAT registration Number issued by the General Administration of Taxes in the format BE0123456789. This is an optional field. " under "Tax Details"
    ...
    ###Business types
    Then Verify "A Limited Liability Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Cooperative Companies with Limited Liability" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Cooperative Companies with Unlimited Liability" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "One-person Private Limited Company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Ordinary Limited Partnership" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+32 32 32 13 123555"
    Then Enter phone number "3232131235" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+32 32 32 13 1235"
    ...
    #Then Verify "Austrian Capital Territory" is listed in "State or Territory" dropdown
    #Then Select "Austrian Capital Territory" in "State or Territory" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+32 42 34 24 242342"
    Then Enter phone number "423424242000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+32 42 34 24 242000"
    ...
    Then Enter "1234" in "PO Box Postal Code" field
    Then Enter "1234" in "Postal Code" field
    Then Enter "Belgium" in "City" field
    Then Select "Limburg" in "Province" dropdown
    Then Click on "Save Contact" button
    ...
    Then Select text "Belgium" under "IBM Country & ISO Code" for Custom Fields
    Then Wait for 3 seconds
  ...
  @Smoke @BelgiumLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Belgium and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @BelgiumLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Belgium with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @BelgiumLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Belgium with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @BelgiumLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Belgium for existing supplier
    ...
    Then Select "Belgium" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Belgium"
    Then Select "Australian Dollar (AUD)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Belgium"
    ...
    Then Enter "34" in "Control Key" field
    ...
    Then Enter value for Bank Branch Name "Bank of Belgium"
  ...
  @Smoke @BelgiumLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Belgium for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Belgium" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
