Feature: Paraguay Localisation
  ...
  @Smoke @ParaguayLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Paraguay with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Paraguay" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @ParaguayLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Paraguay" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Paraguay" supplier registration
    Then Enter "TestCity" in "City" field after "Paraguay" supplier registration
    Then Enter "12345" in "Postal Code" field after "Paraguay" supplier registration
    Then Select "Central" in "Province/Region" dropdown
  ...
  @Smoke @ParaguayLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Paraguay and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Paraguay" is Pre populated with country
    ###Labels
    ...
    Then Show "VAT Registration Number" tooltip " VAT Registration Number, also known as Registro Unico de Contribuyentes as issued by the Paraguay Tax Office and is usually in the range of 8 to 10 alphanumeric characters including hyphen. This is a mandatory field. <" under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your VAT Registration Document as issued by the Paraguay Tax Office in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    ...
    ###Business types
    Then Verify "Corporation (Corp.)" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Limited Liability Partnership (L.L.P.)" is listed in "Business Type" dropdown under "Tax Details"
    ...
    #Then Verify "Cyprus" flag in Phone Number field
    #And Verify "Cyprus" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+595 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+595 323213123555"
    ...
    #Then Enter random EU VAT number "PL" in "EU VAT Registration Number"
     ###Document uploads
    Then Scroll to view "VAT Registration Document" field
    ...
    Then Verify "Paraguay" is listed in "Country/Region" dropdown
    Then Select "Paraguay" in "Country/Region" dropdown
    ...
    Then Show "Province/Region" Label
    Then Show "Province/Region" Dropdown
    ...
    Then Verify "Province/Region" dropdown enabled
    ...
    # Flag
    #Then Verify "Paraguay" flag in Primary Phone field
    #And Verify "Paraguay" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+595 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+595 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Enter "1234" in "PO Box Postal Code" field
    Then Enter "1234" in "Postal Code" field
    Then Enter "Central" in "City" field
    Then Select "Central" in "Province/Region" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @ParaguayLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Paraguay and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Paraguay from teh dropdown
    Then Select "Paraguay" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Verify "Paraguay" flag in Phone Number field
    #And Verify "Paraguay" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+595 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
  ...
  @Smoke @ParaguayLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Paraguay with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Enter "TestAddress2" in "Address Line 2" field after "Paraguay" supplier registration
    Then Enter "TestCity" in "City" field after "Paraguay" supplier registration
    Then Enter "1234" in "Postal Code" field after "Paraguay" supplier registration
    Then Select "Central" in "Province/Region" dropdown
    Then Click "Next" button
    Then Wait for 3 seconds
    Then Select the UNSPSC codes on the Basic information page
  ...
  @Smoke @ParaguayLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Paraguay with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Verify "Peru" flag in Phone Number field
    #And Verify "Peru" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+595 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
  ...
  @Smoke @ParaguayLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Paraguay for existing supplier
    ...
    Then Select "Paraguay" in "Country/Region" dropdown
    Then Enter "Paraguay Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Paraguay"
    Then Select "Paraguayan guaraní (PYG)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Paraguay"
    And Wait for 2 seconds
    ...
    #And Enter value for Bank Key "229964567"
    ...
    Then Enter value for Bank Branch Name "Bank of Paraguay"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City " Ica"
    Then Select "Central" in "Province/Region" dropdown
    Then Enter value for Postal Code "27565"
    Then Enter "1234" in "PO Box" field
    Then Enter "1234" in "PO Box Postal Code" field
  ...
  @Smoke @ParaguayLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Paraguay for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Enter value for Bank Name "Bank of Paraguay"
    Then Select "Paraguayan guaraní (PYG)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Central"
    And Wait for 2 seconds
    Then Enter input data in "Account Number" field
    #Then Enter input data in "Bank Key" field
    #Then Enter "12332" data in "Control key" field
    ...
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City " Central"
    Then Select "Central" in "Province/Region" dropdown
    Then Enter "12345" in "Postal Code" field
    Then Enter "12345" in "PO Box" field
    ...
    Then Select "Paraguay" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Ica" in "City" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Central" in "Province/Region" dropdown section
    Then Enter "45678" in "Postal Code" field under "Factoring Company Address" section
    Then Enter "34564" in "PO Box" field under "Factoring Company Address" section
    Then Enter "14562" in "PO Box Postal Code" field under "Factoring Company Address" section
    Then Wait for 3 seconds
    Then Click "Save" button 6
    Then Wait for 3 seconds
    Then Click on Not now button
  ...
  @Regression @ParaguayLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually in the range of 6 to 18 digits. This is a mandatory field" in add bank account page
    #And Verify "Bank Key" tooltip of "Bank Account Code (Identifier) associated with the bank and is usually 3 digits. This field is mandatory." in add bank account page
    ...
    And Verify "SWIFT Code" tooltip of "Swift code of the Bank which is usually 8 or 11 alphanumeric characters. This is a mandatory field." in add bank account page
    #And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 20 alphanumeric characters.Example:LT121000011101001000.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
    ...
    And Verify "Province/Region" tooltip of "Select the appropriate province/region from the dropdown. This is an optional field." in add bank account page
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 4 digits. Either provide your postal code or leave it empty if postal code is not available." in add bank account page
    ...
    Then Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually 4 digits. This is an optional field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Province/Region" tooltip of "Select the appropriate province/region from the dropdown. This is an optional field." in add bank account Factoring Company Address section
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 4 digits. Either provide your postal code or leave it empty if postal code is not available." in add bank account Factoring Company Address section
    ...
    And Verify "PO Box Postal Code" tooltip of "The PO Box Postal Code of your company which is usually 4 digits. This is an optional field." in add bank account Factoring Company Address section
