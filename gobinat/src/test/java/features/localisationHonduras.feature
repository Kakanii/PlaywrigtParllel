Feature: Honduras Localisation

  #HondurasLocalisation
    Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @HondurasLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Honduras with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Honduras" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @HondurasLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Honduras from the dropdown
    Then Select "Honduras" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Honduras" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Honduras" supplier registration
    Then Enter "TestCity" in "City" field after "Honduras" supplier registration
    Then Enter "12345" in "Postal Code" field after "Honduras" supplier registration
    Then Select "Yoro" in "Department" dropdown
  ...
  @Smoke @HondurasLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Honduras and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Senegal from teh dropdown
    Then Select "Honduras" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Honduras" is Pre populated with country
    ###Labels
    ...
    Then Show "VAT Registration Number" tooltip " VAT Registration Number is usually 14 digits. This field is mandatory. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your VAT Registration Document in the below mentioned formats. This is a mandatory attachment." under "Tax Details"
    ...
    Then Verify "Limited liability company(Sociedad de Responsabilidad L..." is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+504 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+504 323213123555"
    ...
    Then Verify "Honduras" is listed in "Country/Region" dropdown
    Then Select "Honduras" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+504 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+504 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
  ...
  @Smoke @HondurasLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Honduras and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Honduras from teh dropdown
    Then Select "Honduras" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
  ...
  @Smoke @HondurasLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Honduras with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @HondurasLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Honduras with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @HondurasLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Honduras for existing supplier
    ...
    Then Select "Honduras" in "Country/Region" dropdown
    Then Enter "Senegal Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Honduras"
    Then Select "Honduran lempira (HNL)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Honduras"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Honduras"
  ...
  @Smoke @HondurasLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Add Factory Company Account with valid data for Country Honduras for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Honduras" in "Country/Region" dropdown
    Then Enter "Honduras Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Honduras"
    Then Select "Honduran lempira (HNL)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Honduras"
    And Wait for 2 seconds
    ...
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City "Valle"
    Then Select "Yoro" in "Department" dropdown
    Then Enter "12345" in "Postal Code" field
    Then Enter "12345" in "PO Box" field
    Then Enter "12345" in "PO Box Postal Code" field
    ...
    Then Select "Honduras" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Dakar" in "City" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Yoro" in "Department" dropdown section
  ...
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually in the range of 6 to 20 digits. This is a mandatory field" in add bank account page
    ...
    #And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 28 alphanumeric characters.Example:SN08SN0100152000048500003035.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
