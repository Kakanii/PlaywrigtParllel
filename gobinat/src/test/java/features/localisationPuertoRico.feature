Feature: PuertoRico Localisation

  #PuertoRicoLocalisation
    Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @PuertoRicoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is PuertoRico with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
  ...
  @Smoke @PuertoRicoLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Select "Camuy" in "Municipality" dropdown
  ...
  @Smoke @PuertoRicoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Puerto Rico and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Puerto Rico" is Pre populated with country
    ###Labels
    ...
    Then Show "Tax Identification Number" tooltip " Tax Identification Number is usually 11 digits. This is a mandatory field. " under "Tax Details"
    Then Show "Tax Registration Document" tooltip " Attach your Tax Registration Document in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+1 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+1 323213123555"
    ...
    Then Verify "Puerto Rico" is listed in "Country/Region" dropdown
    Then Select "Puerto Rico" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+1 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+1 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Enter "Cidra" in "City" field
    Then Select "Cidra" in "Municipality" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @PuertoRicoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Puerto Rico and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @PuertoRicoLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Puerto Rico with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @PuertoRicoLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Puerto Rico with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @PuertoRicoLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Puerto Rico for existing supplier
    ...
    Then Select "Puerto Rico" in "Country/Region" dropdown
    Then Enter "Puerto Rico Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Puerto Rico"
    Then Select "US Dollar (USD)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Puerto Rico"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Puerto Rico"
  ...
  @Smoke @PuertoRicoLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Puerto Rico for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Puerto Rico" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Wait for 5 seconds
    Then Select "Camuy" in "Municipality" dropdown section
  ...
  @Regression @PuertoRicoLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually in the range 8 to 18 digits. This is a mandatory field" in add bank account page
    And Verify "Bank Key" tooltip of "Bank Account Code (Identifier) associated with the bank, also known as ABA/Forwarding Number which is usually 9 digits. This is a mandatory field." in add bank account page
    ...
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 5 digits (Eg: 12345) or 10 digits with hyphen (Eg: 12345-1234). This is a mandatory field." in add bank account page
    ...
    Then Verify "PO Box Postal Code" tooltip of "The Postal Code of your company which is usually 5 digits (Eg: 12345) or 10 digits with hyphen (Eg: 12345-1234). This is an optional field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Postal Code" tooltip of "The Postal Code of your company which is usually 5 digits (Eg: 12345) or 10 digits with hyphen (Eg: 12345-1234). This is a mandatory field." in add bank account Factoring Company Address section
    ...
    And Verify "PO Box Postal Code" tooltip of "The Postal Code of your company which is usually 5 digits (Eg: 12345) or 10 digits with hyphen (Eg: 12345-1234). This is an optional field." in add bank account Factoring Company Address section
