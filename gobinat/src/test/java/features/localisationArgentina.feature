Feature: Argentina Localisation

  #ArgentinaLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @ArgentinaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Argentina with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
  ...
  @Smoke @ArgentinaLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Argentina" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Argentina" supplier registration
    Then Enter "TestCity" in "City" field after "Argentina" supplier registration
    Then Enter "4634" in "Postal Code" field after "Argentina" supplier registration
    Then Select "Catamarca" in "Region" dropdown
  ...
  @Smoke @ArgentinaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Argentina and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "Argentina" is Pre populated with country
    ###Labels
    ...
    Then Show "CUIT/Tax Number" label under "Tax Details"
    ...
    Then Show "CUIT/Tax Number" input text field under "Tax Details"
    ...
    Then Verify "CUIT/Tax Number" input text field enabled under "Tax Details"
    ...
    Then Show "CUIT/Tax Number" tooltip "The CUIT/Tax Number, also known as Numero de registro unico de contribuyentes as issued by the Argentina Tax office and is usually 11 digits. This is an optional field." under "Tax Details"
    Then Show "VAT Registration Document" tooltip "Attach your VAT Registration Document issued by the Argentina Tax office in the below mentioned formats. This is an optional attachment." under "Tax Details"
    ...
    ####Flag
    Then Verify "Argentina" flag Phone Number
    And Verify "Argentina" flag Fax Number
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+54 1234567890"
    Then Enter phone number "1234567890" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+54 1234567890"
    ...
    Then Enter data CUIT/Tax Number "Tax Details" field
    ...
    Then Verify "Argentina" is listed in "Country/Region" dropdown
    Then Select "Argentina" in "Country/Region" dropdown
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+54 1234567890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+54 1234567000"
    ###Required Error
...
@Smoke @ArgentinaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Argentina and with questionnaire
    Then Enter data in Email Address field
  ...
  @Smoke @ArgentinaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Argentina and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
   ...
   @Smoke @ArgentinaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Argentina and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
  ...
  @Smoke @ArgentinaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Argentina for existing supplier
    When Enter Argentina Supplier Email in Email Address field
    ...
    Then Select "Argentina" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of Argentina"
    Then Select "Argentine Peso (ARS)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Argentina"
    #Then Enter value for Bank Routing Number "23634795651"
    And Wait for 2 seconds
    Then Enter input data in "Account Number" field
    And Wait for 2 seconds
    And Enter value for Bank Key "3453453"
    ...
    Then Enter value for Bank Branch Name "Bank of Argentina"
    ...
    Then Enter value for Postal Code "5464"
  ...
  @Smoke @ArgentinaLocalisation @Supplier @BankAccount @QuickSanity
  Scenario: Add Factoring Company Account with valid data for Country Argentina for existing supplier
    When Enter Argentina Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Argentina" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Select "Catamarca" in "Region" dropdown under Factoring Company Address
