Feature: South Africa Localisation

  #SouthAfricaLocalisation
  Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @SouthAfricaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify invite a Supplier whose tax country is South Africa with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    #select South Africa from the dropdown
    Then Select "South Africa" in "Supplier Country of Registration" dropdown
    ...
    @Smoke @SouthAfricaLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "South Africa" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "South Africa" supplier registration
    Then Enter "TestCity" in "City" field after "South Africa" supplier registration
    Then Enter "4634" in "Postal Code" field after "South Africa" supplier registration
    Then Select "Eastern Cape" in "Province" dropdown
    ...
    @Smoke @SouthAfricaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is South Africa and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    Then Verify Tax Country "South Africa" is Pre populated with country
    ###Labels
    ...
    #Then Show "Tax Identification Number" input text field in "Basic Information"
    ...
    Then Wait for 3 seconds
    ###tooltips
    Then Show "Tax Identification Number" tooltip "Tax Identification Number issued by the South African Revenue Service which is 10 digits starting with 9" under "Tax Details"
    Then Show "Tax Registration Document" tooltip "Attach your company's Certificate of Tax Registration issued by the South African Revenue Service in the below mentioned formats" under "Tax Details"	
    Then Show "Company Registration Number" tooltip "Company Registration Number (CRN) as issued by the Companies and Intellectual Property Commission (CIPC) in the format YYYY/NNNNNN/NN. It is mandatory only for the companies/entities registered under CIPC. This is an optional field." under "Tax Details"
    Then Show "Certificate of Incorporation" tooltip "Attach your company's Certificate of Incorporation issued by the Companies and Intellectual Property Commission (CIPC) in the below mentioned formats. This is an optional field." under "Tax Details"
    Then Show "VAT Registration Number" tooltip "VAT registration number issued by the South African Revenue Service which comprises of 10 digits and starts with the number 4. This is an optional field." under "Tax Details"
    Then Show "VAT Registration Document" tooltip "Attach your company's Certificate of VAT Registration issued by the South Africa Revenue Service. This is an optional field." under "Tax Details"
    ...
    ###Business types
    Then Verify "Article 21" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Close corporation" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "External company" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "External company under section 21a" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Incorporated Company (INC)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Limited by guarantee" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Primary cooperative" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Tertiary cooperative" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Unlimited" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Verify "Secondary cooperative" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "State owned company (soc ltd)" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Statutory body" is listed in "Business Type" dropdown under "Tax Details"
    Then Verify "Other" is listed in "Business Type" dropdown under "Tax Details"
    Then Select "Unlimited" value from Business type dropdown
    #Date calandar
    Then Show date calander in "Date Established" label
    ####Flag
    Then Verify "South Africa" flag Phone Number
    And Verify "South Africa" flag Fax Number
    ...
    #Then Verify phone number "Phone Number" is entered in accepted format "+27 (134) 567-890"
    Then Enter phone number "1234567890" in "Fax Number" field
    #Then Verify phone number "Fax Number" is entered in accepted format "+27 (134) 567-890"
    ...
    #Then Enter data VAT Registration Number "Tax Details" field
    ...
    Then Verify "South Africa" is listed in "Country/Region" dropdown
    Then Select "South Africa" in "Country/Region" dropdown
    ...
    #Then Verify phone number "Primary Phone" is entered in accepted format "+27 (134) 567-890"
    Then Enter phone number "1234567000" in "Secondary Phone" field
    #Then Verify phone number "Secondary Phone" is entered in accepted format "+27 (134) 567-000"
    ###Required Error
    ...
    #### Zip code
    Then Enter "3532" in "Postal Code" field
    Then Verify data entered in "Postal Code" field is "3532"
    ...
    Then Select "Free State" in "Province" dropdown
    ###PO Box Zip Code
    Then Enter "3454" in "PO Box Postal Code" field
    Then Verify data entered in "PO Box Postal Code" field is "3454"
    ...
    @Smoke @SouthAfricaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is South Africa and with questionnaire
    Then Enter data in Email Address field
    ...
    Then Upload "PDF" under "Upload Document"
    Then Click on the Confirm button.
    And Select "Unlimited" value from Business type dropdown
    And Enter number "1546457547455" in "Phone Number" in corporation details
    #Then Scroll to the top of the page
    And Enter number "1435645645645" in "Fax Number" in corporation details
    ...
    @Smoke @SouthAfricaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is South Africa and with out questionnaire with Diversity
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    @Smoke @SouthAfricaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is South Africa and with out questionnaire with Additional Information
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    @Smoke @SouthAfricaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country South Africa for existing supplier
    ...
    Then Select "South Africa" in "Country/Region" dropdown
    Then Enter value for Bank Name "Bank of South Africa"
    Then Select "South African RAND (ZAR)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "South Africa"
    ...
    And Wait for 2 seconds
    And Enter value for Bank Key "123456"
    ...
    Then Enter value for Bank Branch Name "Bank of South Africa"
    ...
    Then Enter value for Postal Code "1237"
    ...
    @Smoke @SouthAfricaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Factoring Company Account with valid data for Country South Africa for existing supplier
    When Enter South Africa Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "South Africa" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Enter "1238" in "Postal Code" field under "Factoring Company Address" section
