Feature: Tanzania Localisation

  #TanzaniaLocalisation
    Background: Start the application
    Given Open the login page
    When Wait 10 seconds
    Then Close the hotjar window

  @Smoke @TanzaniaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify invite a Supplier whose tax country is Tanzania with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Tanzania" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @TanzaniaLocalisation @Localisation @QuickSanity 
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Tanzania from the dropdown
    Then Select "Tanzania" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Click on Join Now Link in the "Pakistan" supplier Email from maildrop
    Then Wait for 3 seconds
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Tanzania" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Tanzania" supplier registration
    Then Enter "TestCity" in "City" field after "Tanzania" supplier registration
    Then Enter "12345" in "PO Box" field after "Tanzania" supplier registration
    Then Select "Arusha Region" in "Region" dropdown
  ...
  @Smoke @TanzaniaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Tanzania and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Tanzania from teh dropdown
    Then Select "Tanzania" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    #maildrop
    Then Click on the email with subject "Trust Your Supplier" from maildrop
    Then Click on Join Now Link in the "Tanzania" supplier Email from maildrop
    Then Wait for 3 seconds
    Then Switch to "new TYS" tab
    #Verify Company page on registration
    #Vrify lables are displayed as expected
    ...
    Then Verify Tax Country "Tanzania" is Pre populated with country
    ###Labels
    ...
    Then Show "Company Registration Number" tooltip " Company registration number which is usually minimum 4 to maximum 20 alphanumeric characters and is issued by the Business Registration and Licensing Agency (BRELA).This is optional field. " under "Tax Details"
    Then Show "Company Registration Document" tooltip " Attach your Company’s registration Document issued by the Business Registration and Licensing Agency (BRELA) in the below mentioned formats.This is optional attachment. " under "Tax Details"
    Then Show "Tax Registration Number" tooltip " Taxpayer Identification Number which is usually 9 alphanumeric characters and is issued by the Tanzania Revenue Authority. This is Mandatory field. " under "Tax Details"
    Then Show "Tax Registration Document" tooltip " Attach your company's Certificate of Tax Registration issued by the Tanzania Revenue Authority in below mentioned formats.This is mandatory attachment. " under "Tax Details"
    Then Show "VAT Registration Number" tooltip " VAT Registration Number issued by the Tanzania Revenue Authority. This is optional field. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your company's Certificate of VAT Registration issued by the Tanzania Revenue Authority in the below mentioned formats.This is optional attachment. " under "Tax Details"
    ...
    ###Business types
    Then Verify "Branch of a Foreign Company" is listed in "Business Type" dropdown under "Tax Details"
    ...
    Then Select "Representative Office" value from Business type dropdown
    #Date calandar
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+255 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+255 323213123555"
    ...
    Then Verify "Tanzania" is listed in "Country/Region" dropdown
    Then Select "Tanzania" in "Country/Region" dropdown
    ...
    # Flag
    #Then Verify "Mozambique" flag in Primary Phone field
    #And Verify "Mozambique" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+255 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+255 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Enter "Arusha Region" in "City" field
    Then Select "Arusha Region" in "Region" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @TanzaniaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Tanzania and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Verify "Tanzania" flag in Phone Number field
    #And Verify "Tanzania" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+255 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
  ...
  @Smoke @TanzaniaLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Tanzania with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Show date calander in "Date Established" label
    ####Flag
    #Then Verify "Pakistan" flag in Phone Number field
    #And Verify "Pakistan" flag in Fax Number field
    ###Phone number format
    Then Enter phone number "323213123555" in "Phone Number" field
    Then Verify phone number "Phone Number" is entered in accepted format "+255 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
  ...
  @Smoke @TanzaniaLocalisation @Localisation @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Tanzania with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @TanzaniaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Tanzania for existing supplier
    ...
    Then Select "Tanzania" in "Country/Region" dropdown
    Then Enter "Tanzania Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Tanzania"
    Then Select "Tanzanian shilling (TZS)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Tanzania"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Tanzania"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City " Arusha Region"
    Then Select "Arusha Region" in "Region" dropdown
    #Then Enter value for Postal Code "275657"
  ...
  @Smoke @TanzaniaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Add Factory Company Account with valid data for Country Pakistan for existing supplier
    When Enter Nokia Supplier Email in Email Address field
    #When Enter Supplier Email in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Nokia Password field
    ...
    Then Select "Tanzania" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    Then Enter "Street 1" in "Address Line 1" field under "Factoring Company Address" section
    Then Enter "Tete" in "City" field under "Factoring Company Address" section
    Then Wait for 5 seconds
    Then Select "Arusha Region" in "Region" dropdown section
    #Then Enter "456789" in "Postal Code" field under "Factoring Company Address" section
    Then Enter "345648" in "PO Box" field under "Factoring Company Address" section
    #Then Enter "145624" in "PO Box Postal Code" field under "Factoring Company Address" section
    Then Wait for 3 seconds
    Then Click "Save" button 6
    Then Wait for 3 seconds
    Then Click on Not now button
  ...
  @Regression @PakistanLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is minimum 4 to maximum 18 alphanumeric characters. This field is mandatory." in add bank account page
    And Verify "Bank Key" tooltip of "Bank Account Code (Identifier) associated with the bank and is usually 6 digits. This field is mandatory." in add bank account page
    ...
    #And Verify "IBAN" tooltip of "International Bank Account Number associated with the bank which is usually 24 alphanumeric characters.Example:PK1215202001026284066023.It is preferred that both IBAN and SWIFT Code are provided." in add bank account page
  ...
  @Regression @MozambiqueLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "Region" tooltip of "Select the appropriate region from the dropdown. This is an optional field." in add bank account Factoring Company Address section
