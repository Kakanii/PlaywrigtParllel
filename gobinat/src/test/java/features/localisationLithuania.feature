Feature: Lithuania Localisation

  #LithuaniaLocalisation
  ...
  Scenario: Verify invite a Supplier whose tax country is Lithuania with out questionnaire and verify invited supplier listed in contacted suppliers with pending invites status
    #Open buyer page
    ...
    Then Select "Lithuania" in "Supplier Country of Registration" dropdown
  ...
  @Smoke @LithuaniaLocalisation @Localisation @QuickSanity
  Scenario: Verify maildrop registration link and verify the supplier registration process from maildrop
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Lithuania from the dropdown
    Then Select "Lithuania" in "Supplier Country of Registration" dropdown
    #maildrop
    ...
    Then Enter "TestAddress1" in "Address Line 1" field after "Lithuania" supplier registration
    Then Enter "TestAddress2" in "Address Line 2" field after "Lithuania" supplier registration
    Then Enter "TestCity" in "City" field after "Lithuania" supplier registration
    Then Enter "12345" in "Postal Code" field after "Lithuania" supplier registration
  ...
  @Smoke @LithuaniaLocalisation @Localisation @Supplier @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Lithuania and with out questionnaire
    #Open buyer page
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    ...
    And Click on the enter
    Then Click on the IgnoreAndProceed button
    #select Lithuania from teh dropdown
    Then Select "Lithuania" in "Supplier Country of Registration" dropdown
    #Then Enter Contact Email Address on Invite Supplier window
    #Then Enter Confirm Contact Email Address on Invite Supplier window
    #maildrop
    ...
    Then Verify Tax Country "Lithuania" is Pre populated with country
    ###Labels
    ...
    Then Show "VAT Registration Number" tooltip " VAT Registration Number as issued by the Lithuania Tax office and in the following formats 123456789 or 123456789012. This is an optional field. " under "Tax Details"
    Then Show "VAT Registration Document" tooltip " Attach your VAT Registration Document issued by the Lithuania Tax office in the below mentioned formats. This is an optional attachment. " under "Tax Details"
    Then Show "EU VAT Registration Number" tooltip " EU VAT Registration Number as issued by the Lithuania Tax office and in the following formats 1) LT123456789 or LT123456789012. This is a mandatory field. " under "Tax Details"
    Then Show "EU VAT Registration Document" tooltip " Attach your EU VAT Registration Document issued by the Lithuania Tax office in the below mentioned formats. This is a mandatory attachment. " under "Tax Details"
    ...
    Then Verify phone number "Phone Number" is entered in accepted format "+370 323213123555"
    Then Enter phone number "323213123555" in "Fax Number" field
    Then Verify phone number "Fax Number" is entered in accepted format "+370 323213123555"
    ...
    Then Verify "Lithuania" is listed in "Country/Region" dropdown
    ...
    Then Verify "County/Region" dropdown enabled
    ...
    # Flag
    #Then Verify "Lithuania" flag in Primary Phone field
    #And Verify "Lithuania" flag in Secondary Phone field
    ###Required Error
    ...
    Then Verify phone number "Primary Phone" is entered in accepted format "+370 323213123555"
    Then Enter phone number "323213123556" in "Secondary Phone" field
    Then Verify phone number "Secondary Phone" is entered in accepted format "+370 323213123556"
    Then Click on "Save Contact" button
    ### Error Validation
    ###Address 1
    ...
    Then Show error message "Required" for "County/Region" field
    ...
    Then Enter "12345" in "PO Box Postal Code" field
    Then Enter "12345" in "Postal Code" field
    Then Enter "Kaunas" in "City" field
    Then Select "Kaunas" in "County/Region" dropdown
    Then Click on "Save Contact" button
  ...
  @Smoke @LithuaniaLocalisation @Localisation @Supplier @QuickSanity 
  Scenario: Verify As a Buyer, I should be able to Onboard a Supplier whose Tax Country is Lithuania and with questionnaire
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
    ...
    Then Verify no data is entered in "EU VAT Registration Number" field under "Tax Details"
    #Then Wait for 3 seconds
    ############When Enter EU VAT Registration Number for Lithuania  under Tax Details
    #Then Enter data EU VAT Registration Number under Tax Details
    #Then Enter random number in "Company Registration Number" field under "Tax Details"
    #Then Enter data VAT Registration Number under Tax Details
    #Then Enter 8 numbers followed by "L" in "VAT Registration Number" field under "Tax Details"
  ...
  @Smoke @LithuaniaLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Lithuania with out questionnaire and with Diversity
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @LithuaniaLocalisation @Localisation @QuickSanity
  Scenario: Verify As a Buyer, I should be able to Publish a Supplier whose Tax Country is Lithuania with out questionnaire and with Additional Information
    Then Enter data in Email Address field
    Then Click on Continue button on Login page
    Then Enter data in Password field
    Then Click on Sign In button on Login
  ...
  @Smoke @LithuaniaLocalisation @Supplier @BankAccount @QuickSanity 
  Scenario: Add Company Account with valid data for Country Lithuania for existing supplier
    ...
    Then Select "Lithuania" in "Country/Region" dropdown
    Then Enter "Lithuania Bank" in "Bank Account Label" field
    Then Enter value for Bank Name "Bank of Lithuania"
    Then Select "Euro (EUR)" in "Currency" css dropdown
    Then Enter value for Account Holder Name "Lithuania"
    And Wait for 2 seconds
    ...
    Then Enter value for Bank Branch Name "Bank of Lithuania"
    Then Enter value for Address "Rruga Frosina Plaku"
    Then Enter value for City " Tirana"
    Then Select "Utena" in "County/Region" dropdown
  ...
  Scenario: Add Factory Company Account with valid data for Country Lithuania for existing supplier
    ...
    Then Select "Lithuania" in "Country/Region" dropdown under Factoring Company Address
    Then Wait for 3 seconds
    ...
    Then Wait for 5 seconds
    Then Select "Utena" in "County/Region" dropdown section
  ...
  Scenario: Verify all the Tooltips in Bank account Company account page.
    ...
    And Verify "Account Number" tooltip of "Account number of the Bank account which is usually 11 digits. This is the 10th to 20th digits of IBAN and the field is mandatory." in add bank account page
    ...
    And Verify "County/Region" tooltip of "Select the appropriate county/region from the dropdown. This is a mandatory field." in add bank account page
  ...
  Scenario: Verify all the Tooltips in Factoring Company Bank Account
    ...
    And Verify "County/Region" tooltip of "Select the appropriate county/region from the dropdown. This is a mandatory field." in add bank account Factoring Company Address section
