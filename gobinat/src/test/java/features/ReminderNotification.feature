Feature: Reminder Notifications
  ...
  @Regression @SLYN-32681 @SupplierNotification
  Scenario: Verify As a BuyerA  able to invite a Supplier X and register It Sucessfully
  ...
  @Regression @SLYN-32681 @SupplierNotification
  Scenario: Verify As a Buyer able to Onboard  Supplier X
	Then Enter data in Email Address field
	Then Click on Continue button on Login page
	Then Enter data in Password field
	Then Click on Sign In button on Login
  ...
  @Regression @SLYN-32681 @SupplierNotification
  Scenario: Verify As aUser (admin )Able to view Inapp  notifications While supplier is Onboarded
	Then Enter data in Email Address field
	Then Click on Continue button on Login page
	Then Enter data in Password field
	Then Click on Sign In button on Login
	...
	Then Show "Nokia has on-boarded you" in notifications
	Then Logout from the system
